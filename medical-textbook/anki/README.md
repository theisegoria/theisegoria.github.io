...
The current draft covers 20 paired objectives in module 01-1 and 10 in module 01-2. No claim of whole-module or curriculum completeness is made. The coverage ledger inventories all 244 modules, including the 242 with zero cards. Next: finish chapter 1 objectives and continue in chapter order, with extra attention to clinical physiology, pathology and verbal anatomy. Downloadable TSV drafts are available now; package/import QA remains pending.
