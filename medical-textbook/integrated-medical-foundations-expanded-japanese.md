...
細胞外液には、血管内の血漿と、組織の細胞を取り囲む間質液が含まれる。この二つの区画を隔てるのは毛細血管壁であり、細胞外液と細胞内液を隔てるのは細胞膜である。それぞれの障壁では透過性が異なる。全身の多くの毛細血管では、水や小さな溶質は比較的容易に移動するが、血漿タンパク質の移動はより強く制限される。細胞外液の主な陽イオンはナトリウム、細胞内液の主な陽イオンはカリウムである。この分布は、完全に不透過な壁によるものではなく、絶えず働く輸送機構によって維持されている。

濃度と総量は区別しなければならない。濃度は量を体積で割った値なので、溶質の量、水の量、あるいは両方が変わることで変化する。溶質が同じ割合で失われずに水が失われると、残った体液は濃縮され、水が加わると希釈される。したがって、濃度の測定値だけでは、区画の大きさや体内に存在する物質の総量は分からない。この区別は、膜輸送の理解を、後に学ぶ体液平衡の推論へ結び付ける。どの区画を測定しているのか、その境界を何が通過するのか、観察しているのは濃度、体積、総量のどれなのかを確認する。
...
ギャップ結合は、隣接する細胞の細胞質を直接連結し、イオンや小分子の通過を可能にします。これは、心筋や一部の平滑筋を含め、電気的または代謝的な協調が必要な場所で重要です。密着結合は上皮細胞間の移動を制限し、異なる区画を保ちます。固定結合は機械的ストレスを分散します。
...
再灌流は虚血組織を救うために必要ですが、酸化物質生成、カルシウム異常、内皮活性化、炎症を通じて傷害を追加することがあります。これは血流再開に反対する理由ではありません。閉塞血管や低流量状態を是正した後も、処置の迅速性、統制された蘇生、体温、電解質、微小循環の状態が回復を左右する理由を説明するものです。
...
絶対不応期はナトリウムチャネルの不活性化を反映する。不活性化したチャネルは、刺激が強くても直ちには再び開かない。相対不応期には一部のナトリウムチャネルが回復しているが、カリウムコンダクタンスの増加が続くため、次の活動電位は生じにくい。この段階では、より強い入力によって活動電位が生じることがある。したがって不応期は、細胞のエネルギーをすべて使い果たしたために生じる休止ではなく、チャネルの分子状態が時間とともに変化する現象である。

伝導は、活動している領域からの電流が隣接する膜を脱分極させ、さらに電位依存性チャネルを開いて信号を再生することで起こる。イオンが一つの塊として軸索の全長を移動するわけではない。有髄軸索では、電流が絶縁性の髄鞘の下を広がり、次々と続くランビエ絞輪で活動電位が再生される。つまり信号は、興奮可能な部位で繰り返し作り直される。この伝導と、その開始に関わる段階電位は区別する必要がある。段階電位の大きさは入力に応じて変わるが、活動電位は閾値に達すると再生される。この一連の過程を理解すれば、受容体の活性化、局所での入力統合、長距離の情報伝達を、同じ電気現象とみなすことなく結び付けられる。
...
デオキシリボ核酸（deoxyribonucleic acid, DNA）は、ヌクレオチド配列に情報を保存している。遺伝子には、コード情報と、その遺伝子がどこで、いつ、どの程度強く発現するかを決定する調節領域が含まれる。転写によりリボ核酸（ribonucleic acid, RNA）が産生される。メッセンジャーRNAは加工され、核外へ輸送され、リボソームによって翻訳される。トランスファーRNAはコドンとアミノ酸を対応させ、一方、リボソームRNAはペプチド結合形成に寄与する。
...
機能喪失は、遺伝子産物の活性または量を低下させる。一方の正常な対立遺伝子から十分な量の産物が供給されれば潜性の遺伝形式を示すことが多いが、必ずそうなるわけではない。ハプロ不全では、残った産物の量では正常な機能を維持できないため、一方の対立遺伝子の機能が失われるだけで顕性の表現型が生じ得る。ドミナントネガティブ効果はこれとは異なり、変化したタンパク質が正常なタンパク質の働きを妨げる。例えば、各サブユニットが正常に働く必要のある複合体へ、正常なタンパク質と異常なタンパク質がともに組み込まれる場合である。

機能獲得は、活性を高めたり、不適切な状況で活性を生じさせたり、新しい性質を与えたりする。このため、同じ遺伝子でも、バリアントが産物の働きをどのように変えるかによって異なる疾患と関連し得る。家系図は遺伝形式を示すが、それだけでは分子機序を特定できない。遺伝子型と疾患を結び付けるには、機能する産物が不足しているのか、異常な産物が相互作用する分子を妨げているのか、それとも過剰な活性や新しい活性があるのかを考える。この問いによって、一見似た顕性の遺伝形式を区別でき、同じ遺伝子のすべてのバリアントが同じ結果をもたらすという誤解を避けられる。
...
補体は、血中を循環するタンパク質の切断を通じて複数の異なる作用を生む。C3転換酵素は補体成分C3を切断し、C3aを放出するとともにC3bを生じさせる。標的表面に結合したC3bとその分解産物は、食細胞が補体受容体を介して標的を認識するのを助ける。これがオプソニン化であり、標識が付くだけで標的が殺されるのではなく、取り込まれやすくなることを意味する。C5転換酵素は、強い炎症作用と走化作用を持つC5a、および終末複合体の形成を開始するC5bを生じさせる。その後、C6、C7、C8、C9が膜侵襲複合体の形成に関与し、感受性のある膜を傷害する。

生体防御を考える際には、これらの結果を区別する必要がある。食細胞を呼び寄せること、標的を認識しやすくすること、膜に孔を開けることは、それぞれ異なる働きである。ある微生物が一つの作用に抵抗しても、別の作用には弱い場合がある。したがって、補体が活性化したからといって、すべての微生物が直接溶菌されるわけではない。補体の防御作用の多くは、ほかの免疫機構との協力に依存する。
...
線形の一コンパートメントモデルに従い、静脈内投与による利用率が完全である架空の薬物を考える。目標濃度が1リットルあたり2ミリグラム、分布容積が20リットルなら、体内に必要な薬物量は40ミリグラムとなる。クリアランスが1時間あたり3リットルなら、この濃度を維持するには1時間あたり6ミリグラムを補う必要がある。濃度に容積を掛けると量になり、濃度にクリアランスを掛けると単位時間あたりの量になる。両者は異なる問いに答えるため、必要な単位も異なる。

分布容積が変わらずクリアランスだけが半減すると、このモデルの負荷量は40ミリグラムのままだが、維持のための流入量は1時間あたり3ミリグラムへ減る。バイオアベイラビリティが2分の1の経口製剤では、線形の薬物動態と不変のクリアランスを仮定すると、全身循環へ入れる量の2倍を投与する必要がある。これは概念を理解するための計算であり、実在の薬物の投与法ではない。分布相、吸収、活性代謝産物、臓器機能の変化、安全な投与速度によって、実際の投与設計はより複雑になる。
...
肺から左房へ戻った血液が、充満期に僧帽弁を通って左室へ入り、駆出期に大動脈弁から出ていく経路を思い描く。僧帽弁が十分に閉じなければ、心室収縮によって血液の一部は大動脈へ前進するだけでなく、左房へ逆流する。このとき収縮期に減少した左室容積には、前方への血流と逆流の両方が含まれる。したがって、有効な前方拍出量が低下していても、計算された駆出率は良好に見えることがある。

左房は肺静脈からの流入に加えて、この逆流量も受け入れなければならない。急性の重症逆流では、まだ適応していない左房の圧が大きく上昇し、その影響が上流の肺循環へ伝わり得る。つまり、主な異常が肺自体になくても、弁の病変から呼吸困難が生じる。一方、慢性逆流では左房の拡大とコンプライアンスの増加により、圧が著しく上がる前に、より多くの血液を受け入れられ、症状の出現が遅れることがある。この経路を言葉でたどると、弁の位置を、上流のうっ血と前方循環の障害へ結び付けられる。また、駆出率だけでなく、心腔の大きさ、負荷条件、逆流量も重要である理由が分かる。
...
腎臓は動脈から血液を受け取るが、同時に静脈から送り出さなければならない。下流の静脈圧が上がると、動脈圧が変わらなくても、臓器を通る圧較差が同じに保たれるとは限らない。静脈圧の上昇は、間質への水分蓄積も促し得る。したがって、血圧計で測る動脈圧は、臓器機能に関わる循環の一部分しか表していない。

非代償性心不全の観察研究では、高い中心静脈圧と腎機能悪化との関連が認められている。ただし、この関連だけでは、すべての患者でうっ血が唯一の原因だと証明することはできない。低心拍出、血管抵抗の変化、薬剤、腎臓自体の疾患が併存することもある。それでも、血液が十分に入れないために機能が低下しているのか、十分に出られないためなのか、それとも両方が障害されているのか、という臨床的な問いを立てる助けになる。

頸静脈圧の上昇、末梢浮腫、腎機能の変化を合わせて解釈すると、うっ血という仮説を支持し得るが、いずれも腎血流量を直接測っているわけではない。生理学上の要点は、動脈圧が良好なら灌流も良好だと同一視せず、流入側の圧、流出側の圧、組織圧、抵抗を一緒に考えることである。
...
第5次心筋梗塞国際定義では、心筋梗塞を一次性、二次性、心臓手技関連の区分へ再編している。一次性心筋梗塞は急性の冠動脈病変によるもので、プラークに伴う血栓以外の機序も含む。二次性心筋梗塞は、別の急性疾患が酸素の供給と需要の不均衡を生じさせる場合であり、さらに客観的な診断要件を満たす必要がある。手技関連心筋梗塞は、心臓手技から30日以内の合併症に関する区分である。古い番号による分類は教科書や診療記録に残るため、背景機序と改訂後の基準を確認せず機械的に置き換えてはならない。

臨床推論では、心筋傷害を示す証拠は何か、虚血を示す証拠は何か、その原因は何かという三つの問いを分ける。バイオマーカーが答えるのは、この過程の一部分だけである。身体に負荷を与える疾患があることや、トロポニンが上昇したことだけでは、心筋梗塞の機序は確定しない。この日付付きの概説は分類を紹介するものであり、完全な診断基準に代わるものではない。
...
右室と左室は中隔を共有し、同じ心膜の囲いの中にある。圧の高まった心嚢液によって拡張が制限されると、一方の心室の充満が、もう一方の充満とより強く競合するようになる。自発呼吸の吸気では右心系への静脈還流が増え、中隔が左方へ偏位して左室充満が減ることがある。それに続く左室一回拍出量の低下は、吸気時に収縮期血圧が過度に低下する奇脈の一因となる。これは相互に作用する機序の一つであり、呼吸に伴うすべての圧変化を説明するものではない。

したがって、解剖学的な問題は外部から充満を制限されることであり、必ずしも心筋の収縮不全ではない。強く収縮していても、十分に充満していない心室から送り出される血液は少なくなり得る。心嚢液の量だけでは血行動態への影響は決まらず、貯留速度と心膜のコンプライアンスも重要である。また奇脈は心タンポナーデに特有ではなく、重症の閉塞性気道疾患でも生じ得る。原因を決める前に、観察された徴候を充満の力学と全身の臨床状態に結び付けて考える。
...
鉄が血液に乗って発達中の赤血球へ届くには、まず腸上皮細胞や鉄を再利用するマクロファージから外へ出なければならない。フェロポルチンは、これらの細胞膜にある鉄の排出タンパク質である。ヘプシジンはフェロポルチンに結合し、細胞表面からの除去を促して鉄の排出を減らす。この機序によって、鉄が貯蔵や再利用を担う細胞の中に残る一方、骨髄で利用できる鉄は減少し得る。したがって、循環中の利用可能な鉄が不足していても、すべての貯蔵鉄が空になっているとは限らない。

この機序を、先に述べた鉄欠乏と炎症に伴う鉄利用制限の区別へ結び付けよう。前者では利用できる鉄の総予備量が減っているが、後者では貯蔵鉄が残っていても、分布や利用経路が障害され得る。両者が併存する場合もある。復習として、循環中の鉄が低いという所見だけでは、どちらの機序か特定できない理由を説明してみよう。答えは、その測定が循環区画を表す一方、ヘモグロビン産生には、貯蔵、放出、輸送、取り込み、そして届いた鉄を骨髄が利用する能力も必要だからである。
...
単純化して、一呼吸あたりの死腔量を150ミリリットルと仮定する。500ミリリットルの呼吸を毎分12回行うと、分時換気量は6リットルになる。まず各呼吸から死腔量を引くと、ガス交換に使われる区画へ届くのは350ミリリットルなので、肺胞換気量は毎分4.2リットルとなる。次に、分時換気量を6リットルに保ったまま、250ミリリットルの呼吸を毎分24回行うとする。死腔量を引いた残りは一呼吸あたり100ミリリットルであり、肺胞換気量は毎分2.4リットルへ低下する。

したがって、この仮定では、同じ総量の空気を動かしていても、速い呼吸パターンの方が二酸化炭素を排出する能力は低い。疲労や疼痛のため浅い呼吸をしている患者では、呼吸数だけで有効な換気を確認できない理由がここにある。実際の死腔は疾患や機器によって変わり得るし、二酸化炭素の産生量も変わり得る。この計算は機序を説明するものであり、呼吸パターンや人工呼吸器設定を指示するものではない。
...
肋骨の位置から胸壁を通って内側へ進むと想像しよう。壁側胸膜に出会い、次に通常はごく薄い液体を含む胸膜腔、その先に肺の表面を覆う臓側胸膜がある。さらに肺組織の中へ進むと、最後に空気を含む肺胞へ到達する。胸膜腔と肺胞内の空間は別々の区画である。正常な吸気が一方を通って他方へ届くわけではない。

安静吸気では、胸郭の拡大によって胸膜腔内圧がより陰性になる。肺胞内と胸膜腔内の圧較差が増え、肺が広がる。肺胞内圧は一時的に大気圧より低くなり、伝導気道を通って空気が流入する。肺胞内圧と大気圧が等しくなると気流は止まるが、広がった肺を保つための拡張圧はなお必要である。

次に、胸膜腔に空気が入った状態を考えよう。正常な力学的連結が損なわれ、肺が内側へ縮み得る。主な異常の場所は肺胞の外であり、単に気管支が閉塞した状態ではない。一方、肺胞内の液体はガス交換面で直接空気を置き換える。どちらも酸素化を障害し得るが、異常がある区画をたどれば、解剖学的にも力学的にも異なる問題である理由が分かる。
...
肺炎では、通常は空気を含む空間を炎症細胞や液体が占めることがある。コンソリデーションとは、このように肺胞のガスが別の物質に置き換わる構造上の所見であり、病原体の名前ではない。結果を一つずつたどろう。病変部のガス交換面へ届く空気は減る一方、血流は続き得る。組織や液体は空気よりエックス線を減弱させるため、胸部画像では透過性が低下して白く見える。局所の断続性副雑音や呼吸音の減弱を伴うこともあるが、それらがないからといって肺炎を除外できない。

ただし、この推論を安易に逆向きにしてはいけない。画像の陰影だけでは感染を確定できない。浮腫、出血、無気肺なども肺の密度を増加させ得る。発熱、時間経過、曝露、免疫状態、診察所見、酸素化、そして適切な検査を合わせて、肺炎の可能性を判断する。同様に、解熱したからといってガス交換が回復したとは限らない。疑われる原因だけでなく、生理機能への影響も再評価する。

復習では、どの区画が異常なのか、どの過程がその異常を生んだのか、機能はどれほど損なわれているのか、という三つの問いを区別しよう。良い臨床説明は、一つの画像所見を診断全体の代わりにせず、三つすべてに答える。
...
役立つ言葉による診察記録には、左右、胸部の面、高さ、呼吸の時相、比較対象を含める。例えば、単に肺に異常があるとせず、右背側肺底部の吸気時に断続性ラ音を聴取したと記す。これは病理診断を確定したり、気管支肺区域を厳密に同定したりするものではない。しかし、別の診察者が同じ領域を再評価し、所見が続いているかを確認できる。

別の高さへ移る前に、対応する左右の部位を比較する。患者の状態が許す範囲で、前面、側面、背面を含める。吸気と呼気の両方を聴き、一方の時相だけで生じる音と、持続的な呼吸音の減弱を区別する。体位、呼吸努力、衣服の摩擦、骨の上で聴くことによって、聴診器へ届く音は変わる。技術的に不十分な比較から、局在を確信してはいけない。

新たな左右差を見つけたら、機序へ戻ろう。換気が減っているのか、音の伝達が変化したのか、それとも疼痛のため患者が運動を抑えているのか。単一の音だけで診断を決めず、胸郭拡張、打診、症状、酸素化と照合する。評価できなかった領域とその理由も記録する。不安定な患者では、この地図を作る作業のために、直ちに必要な評価と支持療法を遅らせてはならない。
...
アミノトランスフェラーゼは肝細胞膜傷害を示しますが合成機能を測りません。アルカリホスファターゼとガンマ・グルタミルトランスフェラーゼは胆汁うっ滞または胆管パターンを支持しますが、骨などの由来も考えます。ビリルビンは産生、取り込み、抱合、排泄を反映します。アルブミンと凝固時間は合成を反映しますが、栄養、炎症、喪失、ビタミンK、抗凝固薬、半減期にも変わります。
...
虚血性脳卒中は、大血管アテローム動脈硬化、小穿通枝血管病、心原性塞栓、動脈解離、凝固亢進、比較的まれな血管症から生じ得る。一過性脳虚血発作は、確立した梗塞を伴わない一過性の局在神経機能障害であるが、その直後の脳卒中リスクは高いことがある。症状が速やかに消失しても、緊急評価が必要である。
...
単純コンピュータ断層撮影は急性出血と大きな占拠効果を迅速に検出するが、虚血早期には正常なことがある。コンピュータ断層または磁気共鳴血管撮影は大血管閉塞と動脈解離を示し、灌流画像は選択例で重度損傷組織と低灌流組織を推定する。静注血栓溶解療法は出血と重要禁忌を除外した適格患者に行い、機械的血栓回収療法は選択された大血管の血栓を物理的に除去する。両者は競合せず補完する。検証済み適格基準を満たせば完全な診断確定を待たないが、制御不良血圧、抗凝固作用、最近の手術、出血歴、画像所見を規律的に評価する。
...
反射には、上腕二頭筋、腕橈骨筋、上腕三頭筋、膝、足関節、足底反射、および選択された表在反射を含める。左右を比較し、筋力および筋緊張との関係を考える。反射亢進、クローヌス、伸展性足底反射は上位運動ニューロン機能障害を支持する。反射低下は、下位運動ニューロン、神経、神経根、急性脊髄ショックを示唆するが、正常変異の場合もある。

## 感覚系診察

検査前に症状分布を図示する。閉眼させ、軽い触覚、針刺激、必要に応じた温度覚、振動覚、関節位置覚を左右で比較する。予測可能な一定リズムで検査せず、誘導的に尋ねるのではなく、何を感じたかを答えてもらう。消去現象、皮膚書字覚、立体覚、触覚定位などの皮質性感覚検査には、一次感覚と注意が保たれている必要がある。
...
リウマトイド因子は感度が中等度にとどまり、特異度も低い。抗シトルリン化ペプチド抗体は特異度がより高く、骨びらん性疾患を予測し得る。炎症マーカーが正常または抗体陰性でも、臨床的滑膜炎は除外できない。超音波検査または磁気共鳴画像法は炎症を検出でき、単純画像は構造損傷を記録する。
...
一次疹には、斑、大型の斑、丘疹、局面、水疱、大水疱、膿疱、結節、膨疹、嚢胞がある。二次的変化には、鱗屑、痂皮、びらん、潰瘍、亀裂、掻破痕、苔癬化、萎縮、瘢痕、色素変化がある。色、表面、境界、形、圧迫退色、圧痛、温度、可動性を記述する。
...
向性は受容体の存在だけではない。受容体が付着を許しても、細胞内因子、温度、極性、自然免疫応答、到達経路が生産性感染を決める。呼吸器ウイルスは気道環境、肝向性ウイルスは肝細胞侵入・複製因子を利用し、神経向性ウイルスは神経または血流を通る。組織損傷は直接細胞傷害、感染細胞への免疫攻撃、血管損傷、全身炎症から生じるため、ウイルス量、症状、組織障害の頂点は必ずしも一致しない。
...
寄生虫の生活環は症状と検査時期を決める。マラリアのスポロゾイトはまず肝細胞へ入り、後の血液期複製が発熱と溶血を起こす。一部原虫種は再発可能な休眠肝型を残すため、血液期治療だけでは不完全である。寄生虫密度と原虫種が緊急リスクを左右し、部分免疫と既治療が臨床像を変える。厚層血液塗抹は検出感度、薄層塗抹は原虫種・負荷評価に役立ち、初期負荷が低ければ反復採血が必要となる。
...
莢膜は貪食に抵抗し、抗原変異は認識される標的を変化させ、潜伏は遺伝子発現を隠し、細胞内寄生は抗体の到達を減らす。微生物は、補体を阻害し、抗体を分解し、インターフェロンを抑制し、抗原提示を遮断し、宿主分子を模倣し、免疫調節経路を誘導することがある。バイオフィルムは薬剤浸透を低下させ、増殖の遅い細胞を保護する。
...
フルオロキノロンは生体利用率が高く多くの区画へ移行するため便利だが、生態学的影響も強い。腱障害、ニューロパチー、中枢作用、血糖異常、補正QT延長、選択患者の大動脈リスク、クロストリジオイデス感染が最適用途を狭める。鉄、カルシウム、マグネシウム、アルミニウムとのキレートは経口吸収を下げる。リファンピシンも移行が良く一部併用でバイオフィルム関連ブドウ球菌に作用するが、大量活動菌へ単剤使用すると速く耐性化する。酵素誘導により避妊薬、抗凝固薬、抗レトロウイルス薬、抗真菌薬、オピオイド、移植薬を無効化し得る。
...
抗寄生虫治療は種、生活環段階、地理、重症度、宿主に従う。重症マラリアは寄生虫負荷、隔離現象、溶血、アシドーシス、脳・臓器障害が速く進むため、直ちに非経口治療する。該当原虫種の休眠肝型根絶には別薬を要し、溶血回避のためグルコース六リン酸脱水素酵素を先に評価する。組織寄生虫殺滅は抗原を放出し危険な炎症を起こすため、選択された神経、眼、高負荷症候群ではステロイド・支持療法を併用する。
...
換気は空気感染リスクへの集団的制御である。外気交換、濾過、圧管理室、適合した呼吸用防護具が吸入量を下げる。サージカルマスクは主に感染源制御と飛沫防護、呼吸用防護具は正しく選択・適合確認したとき吸入を減らす。眼防護は適切な場面で粘膜への飛沫・粒子曝露を防ぐ。着用、適合、脱衣、廃棄、供給が悪ければ個人防護具は失敗するため、文書だけでなく観察と訓練が必要である。
...
リスクは確率的である。曝露しても必ず癌になるわけではなく、癌を発症したからといって本人に責任があるわけでもない。予防に関する説明では非難を避け、社会的、商業的、環境的決定要因を考慮する。
...
治療終了要約には病理、病期、分子所見、手術と切除縁、総薬剤量、照射部位・線量、免疫毒性、輸血、器具、妊孕性温存のため保存した検体を含める。再発徴候と治療後晩期毒性を区別して患者へ説明し、どの専門科・一次診療者が何をいつ監視するか決める。就労、保険、家族計画、性機能、疲労、認知、恐怖も長期転帰であり、腫瘍消失だけを唯一の成功指標にしない。
## 想起問題
...
腎臓の濾過、濃縮、水、ナトリウム、薬剤、酸の処理は未熟で、特に早産児で顕著である。肝抱合と代謝も未熟である。出生時にはヘモグロビン濃度が高く、その大部分は胎児ヘモグロビンである。その後、エリスロポエチン低下に伴って総ヘモグロビンが生理的に減少し、胎児ヘモグロビンは徐々に成人ヘモグロビンへ置き換わる。
...
転倒は機序を持つ事象である。前・最中・後について、体位、旋回、つまずき、めまい、動悸、意識消失、局在筋力低下、尿意、履物、照明、外傷、床上時間を聞く。後方転倒は障害物につまずくのと異なる。失神、発作、前庭疾患、ニューロパチー、パーキンソニズム、視覚低下、疼痛関節、認知的誤判断、鎮静薬、環境危険が併存し得る。漸進的平衡・筋力運動、減薬、視覚・足管理、住環境修正、心血管原因など同定因子を治療する多因子介入が有効である。
...
外傷性脳損傷には、脳震盪、脳挫傷、びまん性軸索損傷、脳実質外または脳内出血が含まれる。抗凝固療法はリスクを高め、緊急中和を要することがある。連続神経診察と再画像検査は経過に従って行う。退院時には、悪化徴候、活動、認知、運転、監視について助言する。
...
何が起こったか、なぜ今なのか、本人が何を望むかから始める。発症、誘因、経過、機能、睡眠、食欲、活力、集中、気分、不安、通常と異なる体験、物質、薬剤、身体症状、過去のエピソードを確認する。治療、トラウマ、入院、住居、人間関係、文化、支援について尋ねる。
...
安定化後は、内視鏡で多くの上部病変を局在し治療する。プロトンポンプ阻害は潰瘍止血を補助する。静脈瘤出血が疑われる場合は、血管作動療法、抗菌薬、緊急内視鏡的止血が必要である。下部出血には、大腸内視鏡、コンピュータ断層血管造影、画像下治療（インターベンショナルラジオロジー）、手術が必要となることがある。抗血栓療法の中和と再開では、出血と血栓症を均衡させる。
...
潰瘍止血は病変に応じ注入、熱、機械、局所内視鏡法を組み合わせる。酸抑制は胃内pHを上げ血餅を安定させる。再出血には出血源と生理に応じ再内視鏡、放射線塞栓、手術を選ぶ。抗凝固拮抗は薬剤、時刻、腎機能、出血重症度、血栓リスクを考え、止血後再開を能動的に決める。静脈瘤疑いでは門脈生理と感染が転帰を変えるため、内視鏡前から内臓血管作動療法と抗菌薬を始める。
...
黄疸は画像検査の前に臨床的に病態の部位を推定する。非抱合型優位なら過剰産生、無効赤血球形成、取込・抱合障害を、尿へ入る抱合型なら肝細胞排泄不全または閉塞を示す。灰白色便は腸への色素不足、掻痒は胆汁成分貯留を支持する。発熱・全身不良を伴う有痛性黄疸は感染性閉塞、進行性無痛性黄疸は膵・胆道・肝悪性腫瘍を疑う。超音波で胆管拡張、胆嚢、腫瘤、門脈流、腹水を迅速評価し、断層・胆管画像を選ぶ。

薬物性肝障害には完全な曝露時系列が要る。処方、市販、ハーブ・生薬、筋肉増強、減量、嗜好、間欠薬の開始・終了、量、再曝露を含める。パラセタモールのような予測可能な用量依存性と、特異体質性遅発性がある。既知表現型、潜伏、薬中止後変化、競合するウイルス・免疫病、飲酒、ショック、胆道閉塞から因果性を評価する。再曝露はより重症化し得るため通常避け、「天然」製品にも未表示の複数肝毒性物質があり得る。
...
腹水治療はナトリウム保持と有効容量を均衡する。食塩を適度に制限し、アルドステロン拮抗薬とループ利尿薬で、体重、血圧、ナトリウム、カリウム、腎機能を監視しながら動員する。過剰利尿は腎障害、低ナトリウム、脳症、筋痙攣を生む。大量穿刺は圧・呼吸を改善するが、量と手順に応じアルブミンを補わないと循環障害を悪化させる。難治性ではシャント、移植、反復排液、目標指向緩和を検討し、心臓・脳症リスクも考える。
...
嘔吐の頻度、量、色、血液、胆汁、便臭、食事との関係、飲水保持能力を明確にする。早期の胆汁性嘔吐はファーター乳頭より遠位の閉塞を示唆する。反復嘔吐は塩化物と水素イオン喪失、収縮性アルカローシス、カリウム欠乏、腎障害を生じる。便臭性嘔吐は遠位閉塞または瘻孔を示唆する。嘔吐を、努力を伴わない逆流および反芻と区別する。
...
診察は触れる前に始まる。咳・動きを避け静止する患者は腹膜刺激、落ち着かず動く患者は疝痛に多いが診断的ではない。呼吸、色、発汗、栄養、水分、黄疸、瘢痕、膨満、ヘルニア、ストーマ、拍動を観察する。保温と尊厳を守り十分露出する。激痛にショック、呼吸努力、意識変化が伴えば局所診察完了前に蘇生する。
...
腸音の識別精度は低い。高音・頻回音は閉塞早期に、低下は麻痺性イレウス、腹膜炎、オピオイド、電解質異常、正常変動でも起こる。音があっても閉塞を除外できず、無音でも麻痺性イレウスを診断できない。膨満、嘔吐、排便・排ガス停止、既往手術、ヘルニア、圧痛、画像、軌跡がより有用である。直腸診は血液、腫瘤、便塞栓、肛門周囲病変、括約筋機能、手術計画に結果が関係する場合だけ行う。
...
単純性膀胱炎では、全身症状を伴わず、排尿痛、頻尿、尿意切迫、恥骨上部不快感が生じる。腟症状があれば膀胱炎の可能性は下がり、別の診断が示唆される。腎盂腎炎では、発熱、側腹部痛、悪心、全身症状が生じ、菌血症を伴うことがある。抗菌薬は、症候群、重症度、アレルギー、妊娠、腎機能、過去の培養結果、耐性、組織移行性、地域の指針に基づいて選択する。治療が失敗した場合は、閉塞、膿瘍、耐性菌、診断の誤り、服薬不良を再評価する。
...
プロゲステロンは換気刺激を高め、動脈二酸化炭素を下げ、腎代償で重炭酸も低下する。酸素消費量は増え、横隔膜挙上で機能的残気量が減るため、無呼吸時の酸素予備能が小さい。気道粘膜浮腫と誤嚥危険も増し、呼吸不全と麻酔導入は急速に悪化し得る。妊娠時血液ガスを基準に解釈し、非妊娠者では正常な二酸化炭素値が、妊婦では低換気を示し得ることに注意する。
...
妊娠高血圧腎症は単なる高血圧と蛋白尿ではなく、胎盤由来の多臓器内皮疾患である。妊娠中期以降の新規高血圧に、腎、肝、神経、血液、肺、胎盤機能障害があれば、蛋白尿がなくても診断し得る。激しい頭痛、視覚変化、右上腹部・心窩部痛、呼吸困難、乏尿、意識変容、腱反射亢進、出血、胎動減少は警告徴候である。適切なカフと体位で血圧を確認し、血小板、溶血、肝酵素、クレアチニン、尿蛋白、症状、胎児発育、羊水量、ドプラ血流を評価する。
...
耳、鼻、咽頭、喉頭、上気道では、感覚、呼吸、嚥下、発話、免疫の機能が狭い解剖学的領域に集中している。わずかな腫脹でも気流を閉塞し、感染は眼窩、頭蓋底、深頸部、脳へ広がり得る。評価では最初に、ストライダー（吸気性喘鳴）、流涎、呼吸努力、急速に拡大する頸部腫脹、重度出血、深部間隙感染、突発性感音難聴、中枢性めまいを認識する。
...
外耳炎では、外耳道の疼痛、掻痒、耳漏、耳珠を動かしたときの圧痛が生じ、湿気または外傷後に多い。外耳道を安全に清掃し、鼓膜と推定病原体の状況が許せば、局所抗微生物薬と抗炎症薬を用いる。糖尿病または免疫抑制があり、重度で持続する疼痛、肉芽、脳神経障害、全身症状を伴う場合は、侵襲性頭蓋底感染を疑い、緊急画像検査と全身性抗緑膿菌治療を行う。
...
発声には、声帯を振動させる気流、喉頭緊張による調節、共鳴腔による修飾が必要である。嗄声は、ウイルス性喉頭炎、声の酷使、逆流、喫煙、吸入ステロイド、声帯麻痺、神経疾患、がんで生じ得る。持続する嗄声、頸部腫瘤、喀血、嚥下障害、耳痛、体重減少、タバコまたはアルコール曝露、ストライダーには喉頭鏡検査が必要である。

ストライダーは上気道狭窄による乱流音であり、緊急徴候である。吸気性ストライダーは胸郭外閉塞を示唆し、二相性ストライダーは声門または声門下狭窄を示唆する。原因には、アナフィラキシー、異物、感染、腫瘍、外傷、浮腫、声帯機能障害がある。患者を落ち着かせ、酸素を投与し、気道専門家を呼び、閉塞が悪化し得る場合には苦痛を与える診察を避ける。原因に応じて、アナフィラキシーへのアドレナリン、異物除去、抗微生物薬、特定の浮腫へのコルチコステロイド、必要時の外科的気道確保を行う。
...
耳鼻咽喉と嚥下の評価は、気道と神経学的緊急性から始める。ストライダー（吸気性喘鳴）、唾液を飲み込めない流涎、急速に拡大する頸部・口腔底腫脹、気道へ流入する重症鼻出血、深頸部敗血症、突発性感音難聴、中枢徴候を伴う持続性めまいは時間依存性である。狭い解剖学的空間では局所感染や浮腫が急速に気道閉塞、頭蓋内波及、血管血栓、誤嚥へ進み得る。
...
ストライダーは重篤な上気道狭窄音である。吸気性は胸郭外、呼気性は胸郭内大気道、二相性は固定性声門・声門下病変を示唆する。重症度は音量でなく呼吸仕事量、気流、声、流涎、疲労、酸素化、意識で判断し、静かになったストライダーは疲弊を意味し得る。患者を座位で落ち着かせ、気道専門家を呼び、不必要な咽頭操作を避け、アナフィラキシー、クループ、感染、異物、腫瘍、浮腫を機序別に治療する。
...
持続嗄声では特に喫煙、飲酒、頸部腫瘤、嚥下障害、血痰、関連耳痛、体重減少、ストライダーがあれば声帯を可視化する。片側声帯麻痺は頭蓋底から頸部・胸部を通る反回神経のどこでも起こり、甲状腺、肺、大動脈、縦隔、神経、手術性疾患を示し得る。両側麻痺は気道を脅かす。閉鎖不全、誤嚥、意思疎通需要に応じ、音声療法、注入、喉頭枠組み手術、原因治療を選ぶ。
...
潰瘍は持続期間と背景で絞る。外傷性は刺激除去後に治癒する。再発性アフタは非角化粘膜に生じ、鉄、葉酸、ビタミンB十二欠乏、セリアック病、炎症性腸疾患、好中球減少、免疫疾患、薬剤に伴い得る。再発性ヘルペスは通常角化付着粘膜に群生小水疱後として現れる。持続性潰瘍、硬い辺縁、赤色または赤白混合斑、説明不能な感覚低下・動揺歯、片側関連耳痛、頸部リンパ節は緊急生検評価を要する。
...
アナフィラキシーは、急速に進行して気道、呼吸、循環を脅かす全身性過敏反応である。皮膚または粘膜症状を伴うことが多いが、伴わないこともある。嗄声、ストライダー（吸気性喘鳴）、舌腫脹、喘鳴、低酸素血症、低血圧、虚脱、妥当な誘因後の強い消化器症状、または急速に進行する多臓器症状があれば治療を開始する。検査による確認を待ってはならない。
...
メタノールとエチレングリコールはアルコール脱水素酵素代謝後に毒性を示す。メタノールのギ酸は網膜と基底核を障害し、エチレングリコール由来の酸は腎障害とシュウ酸カルシウム沈着を起こす。浸透圧較差は初期に高く、陰イオン較差上昇とともに下がるため、後期正常値は安心材料でない。ホメピゾールで代謝を遮断し、補因子で代替経路を支え、重炭酸で酸血症を治療し、重症では透析で親物質と代謝物を除く。確定濃度を待たず強い臨床根拠で開始する。
...
一酸化炭素は酸素運搬と細胞利用を障害するが、通常パルスオキシメータは一酸化炭素ヘモグロビンを酸素化血として読む。頭痛、悪心、意識変容、失神、心筋障害、胎児障害、遅発神経精神後遺症を起こす。曝露から離し高濃度酸素を投与し、COオキシメトリー、必要時心電図と心筋マーカーを行い、重い神経・心臓・酸血症、妊娠、曝露所見では高圧酸素を相談する。酸素投与後や時間経過後の低値は最大負荷を過小評価する。
...
全身酸素供給量は心拍出量と動脈血酸素含量の積である。酸素含量は主にヘモグロビン濃度と飽和度で決まり、通常圧で溶解酸素の寄与は小さい。飽和度百パーセントでも高度貧血や極端な低心拍出を補えない。組織酸素消費は供給が低下しても抽出増加により保たれるが、臨界供給量を下回ると供給に依存する。静脈血飽和度と乳酸は間接指標だが、シャント、アドレナリン性代謝、肝クリアランス、痙攣、ミトコンドリア障害で変わる。

酸素は患者に合う目標へ処方する。パルスオキシメータは飽和度を推定するが、低灌流、動き、異常ヘモグロビン、皮膚色に関連する機器偏り、プローブ位置の影響を受ける。酸素投与で飽和度が保たれても二酸化炭素上昇を伴う低換気が隠れる。動脈血ガスは分圧と酸塩基を、COオキシメトリーは一酸化炭素ヘモグロビン・メトヘモグロビンを測る。低酸素が続けば吸入酸素低下、低換気、拡散障害、換気血流不均衡、シャントを分析する。
...
失神は全脳低灌流による突然の一過性意識・姿勢緊張喪失で、速やかに自然回復する。本当に意識を失ったか確認し、目撃者から体位、誘因、前駆症状、蒼白・チアノーゼ、呼吸、眼位、動き、持続、外傷、回復を聞く。長い立位中の悪心、熱感、発汗、暗転は反射性を支持する。運動中・仰臥位の前触れない虚脱、動悸、胸痛、異常心電図、器質的心疾患、家族突然死は心臓危険を高める。
...
ナトリウム濃度は主に交換可能ナトリウム・カリウムに対する水の比であり、体内総ナトリウム量ではない。実測または有効浸透圧、血糖、容量状態、尿浸透圧、尿ナトリウム、腎機能、内分泌、薬剤を解釈する。急性重症低ナトリウムは脳浮腫を起こし高張食塩水を要し得るが、慢性を速く補正すると浸透圧性脱髄を起こす。高ナトリウムは水不足またはナトリウム増加で、持続する喪失を是正しつつ計算して制御補充する。
...
制度終了時にも、継続診療とデータ責任が失われない移行計画を置く。その計画では、制度を通じてすでに診療を受けている人がどのように受け続けるか、制度自体がなくなった後に制度が収集した情報を誰が保持し責任を負うかを定める。
## 想起問題
...
希少資源配分は関連する臨床基準を一貫・透明に適用する。予後推定には障害、人種、社会経済、アクセス偏りが埋め込まれ得るため、データを検討し再審査を可能にする。社会的価値、名声、富、受けるに値するかという道徳的判断、根拠のない生活の質推測は不適切である。同等適格者全員へ提供できなければ合意された公正な同順位基準を要し得る。配分方針とベッドサイド擁護を分けると、正当な制度制約内で個人患者への忠実性を保てる。
...
死後も、死亡確認、文化を尊重した身体ケア、証明・検視手続の説明、所持品返却、該当する提供経路、実務案内を通じてケアは続く。薬、食物、水分、治療中止への罪悪感など誤解を修正し質問を招く。通常の悲嘆には思いやりと地域支援を、希死念慮、長期重度機能障害、外傷侵入、物質使用、深い孤立、持続する無力な思慕には積極評価・治療を行う。
...
液剤は製品濃度が異なると誤りやすい。質量で処方し、必要なら正確な製品に対応する容量も示す。養育者には経口シリンジを渡し、実演し、本人に説明し返してもらって理解を確認する。薬剤照合には、市販の咳・感冒薬、補完療法、家族間で共有された薬も含める。
...
基準データと直接観察で現状と目標の差を定義する。工程図は手順、判断、待機、引継ぎ、再作業、失敗点を示す。パレート分析は頻度の高い寄与を示し、特性要因図は仮説を整理する。これらは問いを作る道具で、証拠なしに因果を確立しない。
...
小規模試験は害を制限して作業流問題を示すが、無期限の試行にしてはならない。拡大には標準化した中核要素、現場ごとの適応、訓練、データ、技術支援、指導者の責任が必要である。状況が違えば一病棟で成功した介入も他では失敗し得る。
...
有毒動物による刺咬症は地域、安全に同定できた種、受傷状況、局所作用、神経徴候、凝固障害、筋傷害、腎変化、全身症状で診断する。危険動物を捕獲しない。応急処置と抗毒素適応は地域特異的で、毒物情報機関への相談が高い価値を持つ。
...
妊娠評価では妊娠週数、胎動、出血、破水、収縮、血圧、頭痛・視覚症状、疼痛、出産歴、合併症を確認する。異所性妊娠、出血、高血圧性疾患、敗血症、閉塞性分娩、臍帯脱出、胎児機能不全には迅速搬送または緊急行動が必要である。
...
ここで用語を明確に区別する。英語のinternalとexternalは、特定の構造を基準にした内部と外部の関係を表し、一般に正中線を基準とするmedialとlateral、すなわち内側と外側を意味するわけではない。管腔臓器の壁の内部にある点が、必ずしも身体の正中線に近いとは限らない。同様に、浅い・深いという関係は表面からの距離を基準とし、近位・遠位という関係には起点が必要である。それぞれ何を基準に述べているのかを確認する。解剖学的正位では母指は小指より外側にあり、肘は手関節より近位にある。身体全体を回して観察者に背を向けても、観察者からの見え方が変わるだけで、これらの関係は変わらない。復習として、ある構造が深層にあり、同時に外側にもあり得る理由を説明してみよう。答えは、深さと正中線からの距離が異なる空間的関係を表すため、一方から他方は決まらないということである。
...
脊柱起立筋群は腸肋筋、最長筋、棘筋からなる。横突棘筋群には半棘筋、多裂筋、回旋筋があり、一般に横突起からより上位の棘突起へ走る。短い棘間筋と横突間筋は分節制御を支える。後頭下筋は上位頸椎関節周囲の頭部運動を微調整する。
...
典型的肋骨は頭、頸、結節、角、骨幹、肋骨溝を持つ。頭は通常、同番号と一つ上の椎体に、結節は同番号横突起と関節する。第一、二、十、十一、十二肋骨は非典型的特徴を持つ。
...
大心臓静脈は前室間動脈、中心臓静脈は後室間動脈、小心臓静脈は右縁に伴走する。主に冠状静脈洞へ流れ右心房へ入る。前心臓静脈は直接入り、微小血管は心腔と交通する。
...
胸膜疾患は表面と裂に沿い、胸膜外疾患は胸膜を内側へ押し得る。隔壁化液体は癒着で制限される。膿胸は滑らかな胸膜分離を伴うレンズ状貯留を作りやすく、肺膿瘍は実質内にあり胸壁と鋭角をなすことが多い。
...
腹腔内臓器はほぼ全体を覆われ腸間膜で懸垂され、胃、肝、脾、空腸、回腸、横行・S状結腸などを含むが部位による例外がある。一次性後腹膜臓器は腎、副腎、尿管、大動脈、下大静脈など腹膜後方に発生する。
...
前腸内臓求心線維は概ねT5からT9の胸髄へ入り心窩部痛を生む。中腸痛は臍周囲、後腸痛は下腹部または恥骨上部に感じられることが多い。重なりと臓器固有経路があるため近似である。
...
消化管は連続する筋性管で、部位ごとの形態、壁の特殊化、腸間膜、血流、括約筋が輸送と吸収を調節する。発生学的な前腸、中腸、後腸領域は、動脈供給、自律神経路、リンパ還流、関連痛を説明する。領域境界は臨床的に重要な分水嶺を作る。
...
疼痛求心線維は交感神経と、生理的反射求心線維は副交感神経と走ることが多い。歯状線下では陰部神経体性路が鋭い局在痛を生む。膨張、虚血、炎症、牽引は異なる型を活性化する。
...
脾破裂は腹腔内出血と横隔膜刺激による左肩関連痛を生む。副脾は脾門・靱帯付近に多く、治療的脾摘後に重要となる。
...
性発達に関連する平均差には入口形状、恥骨下角、仙骨弯曲、坐骨棘突出があるが分布は広く重なる。年齢、祖先、身長、活動、栄養、個人発達も寄与する。アイデンティティから解剖を推測せず、画像または直接診察で臨床的問いに答える。
...
腰仙神経幹は仙骨神経前枝と合流し梨状筋上に仙骨神経叢を作る。下肢・会陰への枝は骨盤内で近接する。腫瘤、出血、分娩、手術は複数神経へ影響し得る。
...
内腸骨動脈からの子宮動脈は子宮頸へ近付き尿管上を横切り、子宮側面を蛇行上行して卵巣動脈と吻合する。静脈叢は内腸骨系へ流れる。子宮底リンパは卵巣血管に沿い傍大動脈節へ、または円索に沿い浅鼠径節へ、体・頸は骨盤節へ流れる。
...
上行線維は進入後に短く走り、経路ごとに異なる高位で交叉するため、感覚レベルは解剖学的病変より一ないし数分節下になることがある。仙髄感覚温存は不完全な中心性病変を示し得る一方、早期の仙髄機能障害は円錐・馬尾病変を示唆する。画像は解剖学と照合して解釈し、画像だけを局在診断としてはならない。
...
視床は第三脳室外側壁の大部分を作り、感覚、運動、辺縁、覚醒情報を皮質へ中継する。視床下部は第三脳室周囲の下内側にあり、体温、浸透圧、食欲、概日リズム、下垂体、生殖、ストレス、自律出力を調整する。視床上部には松果体と手綱構造があり、腹側視床は運動回路に参加する。
...
弾性線維はフィブリリン豊富な微細線維を伴うエラスチン芯からなる。大型動脈、肺、皮膚、弾性靱帯で伸展・反跳する。動脈壁の弾性板は収縮期にエネルギーを蓄え拡張期の流れを維持する。フィブリリン欠損は微細線維構造と増殖因子調節を変え、骨格、眼、大動脈へ全身作用を及ぼす。エラスチン分解は肺気腫と動脈スティフネス増大に寄与する。
...
頭尾両端では中胚葉を挟まず外胚葉と内胚葉が口咽頭膜と総排泄腔膜で直接接する。将来の口腔と終末腸管・尿生殖路開口を示す。心原性中胚葉は当初口咽頭膜より頭側にあるが、後の屈曲で前腸腹側へ移る。
...
胚静脈は広範に再構成される。卵黄静脈は肝類洞、門脈系、下大静脈の一部を作る。胎盤血を運ぶ臍静脈は右が退縮し左が出生まで残る。主静脈系は選択的吻合と退縮で主要体静脈を作る。この複雑性が重複大静脈、左上大静脈、異常腎静脈、側副路を説明する。
...
腎は骨盤内から始まり、下半身成長に伴い上昇して見える。腎門が内側を向くよう回転し、大動脈から順次動脈枝を受け、遺残すれば過剰腎動脈となる。下極融合は馬蹄腎を作り、下腸間膜動脈下で上昇が止まる。異所性腎と交叉性融合腎は移動異常を反映する。
...
濃度はモル濃度、質量モル濃度、質量濃度、分率で表せる。モルは一定数の粒子を数え、モル濃度は溶液一リットル当たりのモル数である。容量オスモル濃度は一リットル当たり、重量オスモル濃度は溶媒一キログラム当たりの浸透活性粒子を数える。特に高イオン強度の非理想溶液では理想濃度でなく活量が化学挙動を決める。

拡散はランダム熱運動と化学ポテンシャル勾配に沿う正味移動である。浸透は選択透過膜を隔てた有効溶質活量差による溶媒移動をいう。張度は持続的細胞容積変化を予測し非透過性溶質に依存するが、容量オスモル濃度は透過性を問わず全粒子を含む。尿素は容量オスモル濃度を上げても多くの膜を通るため持続張度への寄与は小さい。
...
ミカエリス・メンテン解釈は初速度条件、酵素基質複合体の定常状態、単純機序を仮定する。多くの酵素には複数基質・生成物、配座状態、共有調節、協同性がある。逆数直線プロットは誤差を歪め低濃度に過大な重みを与えるため非線形当てはめが一般に好ましい。良いモデルは滑らかな曲線だけでなく仮定と残差で評価する。
...
代謝制御は分散しており、単離反応で最も遅い段階が生体経路の律速段階とは限らない。制御係数は酵素変化が経路流量・代謝物濃度へ与える影響を定量し、網全体に分布する。強く調節される不可逆段階が大きな制御を持つことはあるが、摂食、運動、疾患、薬物で制御位置は移る。
...
アラニンアミノ基転移酵素はアラニンとアルファケトグルタル酸をピルビン酸とグルタミン酸へ、アスパラギン酸アミノ基転移酵素はアスパラギン酸とオキサロ酢酸を相互変換する。組織損傷で血漿へ漏れ、前者は比較的肝に富み、後者は肝、筋、心などにも豊富である。血漿活性は漏出と文脈を示し肝機能の直接定量ではない。

グルタミン酸は中心的窒素収集体である。ミトコンドリアのグルタミン酸脱水素酵素はグルタミン酸をアルファケトグルタル酸と遊離アンモニアへ酸化的脱アミノ化しNADHまたはNADPHを作るが、条件により逆行もする。エネルギー状態ヌクレオチドに調節される。アミノ基転移後の脱アミノ化をトランスデアミネーションという。
...
ヒトゲノムは細胞周期ごとに一度だけ複製され、自然な化学変化、代謝性酸化物質、紫外線、電離放射線、毒物、複製誤りにさらされながら絶えず修復される。正確性は相補的塩基対、ポリメラーゼ校正、複製起点のライセンス化、チェックポイント、損傷別の修復経路に依存する。ゲノム維持は単一の万能機構ではなく、相互連結したネットワークである。
...
逆位は染色体区間を反転する。腕内逆位はセントロメアを含まず、腕間逆位は含む。保因者は無症状でも、逆位ループ内の組換えが異常産物を生むことがある。環状染色体は末端切断・融合から生じ、末端欠失と有糸分裂不安定性を伴いやすい。同腕染色体では一方の腕が重複し、他方を失う。
...
損傷と感染は同じ経路をしばしば活性化する。無菌性壊死はDNA、ATP、尿酸、ミトコンドリア分子、基質断片を放ち、結晶や微粒子はリソソームを傷つけ、虚血は酸化物質を生む。発熱と好中球増加だけで臨床炎症を感染性と決めず、微生物学、解剖、時間経過、治療反応を統合する。
...
H因子とI因子は保護表面の第二経路C3bを不活化する。崩壊促進因子は転換酵素の解離を促進し、膜補因子蛋白はI因子によるC3b・C4b分解の補因子となり、CD59は終末孔形成を防ぐ。発作性夜間ヘモグロビン尿症ではGPIアンカー型調節因子を失い、補体性血球傷害と血栓が起こる。
...
診断病理学は検体を診療に役立つ解釈へ変換する。その過程は組織が検査室へ届く前から始まる。臨床上の問いにより、採取部位、処理速度、培地や固定液、無菌・未固定・凍結・遮光の必要性が決まる。誤った検体に技術的に優れた検査を行っても、正しい問いには答えられない。病理医は形態を、病歴、解剖学的部位、画像、既治療、時間経過、誤判定の影響と統合する。
...
# 第97章：受容体理論、実験薬理学、創薬、薬理ゲノミクス

## TTSモジュール1：定量的受容体理論と用量反応推論

薬力学は、薬物が生体系へ何を行い、濃度が反応とどう関係するかを問う。標的は受容体、酵素、イオンチャネル、輸送体、核酸、膜、物理化学的構造などである。結合だけでは臨床効果にならない。作用部位の遊離濃度から、標的占有、シグナル伝達、細胞、臓器、個体反応へ連鎖する。各段階は前段を増幅、緩衝、遅延、拮抗するため、血漿濃度、受容体占有率、効果は必ずしも並行しない。

可逆的結合は質量作用則に従う。リガンドと受容体は各遊離濃度に比例する速度で会合し、複合体量に比例する速度で解離する。平衡解離定数K Dは、単純な一結合部位系で利用可能受容体の半数が占有される遊離リガンド濃度である。K Dが低いほど親和性が高い。占有率は濃度を濃度とK Dの和で割った値となる。この双曲線は漸近的に完全占有へ近づき、極低濃度以外では濃度を倍にしても占有率は倍にならない。

会合・解離速度には平衡親和性が隠す情報がある。同じK Dでも結合速度と結合持続時間が異なり得る。滞留時間はおよそ解離速度定数の逆数である。解離が遅いリガンドは遊離濃度低下後も標的占有を保ち、内因性伝達物質が短時間だけ現れる場合は速い会合が重要となる。生体膜、受容体構造、再結合、細胞内区画により生体内動態は均一溶液より複雑である。

親和性は結合を、効力は結合リガンドが反応を作る能力を示す。作動薬は親和性と正の効力を持つ。完全作動薬は規定条件で系の最大反応を生むが、部分作動薬は高占有でも最大に達しない。受容体密度と伝達効率が違うため、部分作動性は系に依存する。完全作動薬と共存すると、部分作動薬は受容体を占有しながら弱い活性しか与えず反応を下げるため、状況により作動的にも拮抗的にも見える。

受容体は複数の立体構造を取り、リガンドなしにシグナルを出す構造もある。逆作動薬は不活性構造を優先的に安定化し、構成的活性を低下させる。中性拮抗薬は基礎活性を変えずに作動薬結合を妨げる。構成的シグナルが十分なとき両者を区別できる。リガンドが特定の活性構造を選び、下流経路を異なる比率で活性化する偏向作動もある。増幅が選択性を装うため、偏向は明示した基準リガンドと測定系に対して評価する。

濃度反応曲線は通常、対数濃度に対して反応を描きS字形となる。E maxは観察された最大効果、E C五十は測定系でその半分を生む濃度であり、効力価の指標だが必ずしも親和性定数ではない。効力価は親和性、効力、受容体量、共役、組織到達性、競合リガンド、評価項目で変わる。高力価薬は一定効果に必要な濃度が低いが、最大効果、安全性、臨床的優越性が高いとは限らない。

全受容体占有前に最大反応が起こると予備受容体が存在する。シグナル増幅により少数の受容体でも十分な下流装置を動員でき、この場合E C五十はK Dより低くなり得る。不可逆的受容体不活化では、予備が消費される間は最大反応を保って曲線が右へ移動し、予備枯渇後に最大が低下する。予備量は組織間で異なり、同じ作動薬が一臓器では完全、別臓器では部分作動薬となり得る。

競合拮抗薬は作動薬認識部位へ可逆結合し、活性化しない。理想系では作動薬濃度を増せば阻害を乗り越え、最大反応を保って平行に右方移動する。濃度比は必要作動薬濃度の増加を表す。平衡、単純競合、系の安定という仮定下ではSchild解析で拮抗薬親和性を推定できる。非平行移動は、平衡不足、受容体減少、複数受容体集団、評価項目の歪みによることもある。

非競合拮抗は、実験条件下で作動薬を増しても完全に克服できない阻害である。拮抗薬は正規部位へ不可逆結合、アロステリック部位へ結合、下流伝達を遮断、またはチャネル伝導を妨げ得る。通常は最大反応が低下するが、予備受容体が初期には隠すことがある。アロステリック調節薬は親和性、効力、または両方を変え、自身の部位が飽和するため効果に上限を持ち得る。正の調節薬は増強し、負の調節薬は低下させる。

生理的拮抗では異なる標的を介して反対の機能を生み、例えば気管支拡張がメディエーター誘発収縮へ対抗する。化学的拮抗は受容体でなく直接相互作用や隔離で起こる。したがって機能的結果だけでは機序を決められない。また個体レベルの相乗効果に標的レベル相乗は必須でなく、別の制御点への二介入が共同で生理的閾値を越えることがある。

量子的用量反応解析は、各個体が睡眠、発作予防、毒性、死亡などの規定結果へ達したかを記録する。E D五十は半数に有効な用量、T D五十とL D五十は毒性と致死性を示す。これは一標本内の段階的E C五十と異なり、集団分布である。T D五十をE D五十で割る治療指数は分布間隔の粗い尺度であり、裾、結果の重症度、監視、患者異質性を表さない。

臨床的に有用な曝露範囲を治療域と呼ぶが、境界は柔軟で適応症に依存し、年齢、臓器機能、相互作用、遺伝、耐性で変わる。効果が血漿濃度より遅れる、または長く続くと濃度効果ヒステリシスが生じる。効果区画への分布、遅い受容体動態、活性代謝物、遅延遺伝子転写、不可逆結合、生理的フィードバックが時計回りまたは反時計回りの輪を作る。一時点の採血は因果曝露を誤って表し得る。

反復曝露は反応性を変える。脱感作は受容体リン酸化、非共役化、内在化、メディエーター枯渇、チャネル状態変化により秒から時間で起こる。ダウンレギュレーションは長期に受容体量を減らす。耐性は同じ曝露への反応低下で、薬力学的、薬物動態的、学習性がある。タキフィラキシーは特に急速な低下である。代償適応が除去後も残れば離脱や反跳が起こり、急な中止は単なる無治療と異なる。

受容体調節は過敏性も説明する。慢性拮抗は受容体数や共役を増やし、除神経による伝達物質曝露低下はシナプス後反応を高め得る。疾患は標的発現と伝達構造を変える。炎症は酵素や受容体を誘導し、心不全はアドレナリン伝達を変え、内分泌疾患はフィードバックを変える。用量反応曲線はある時点の薬物と系の組合せの性質であり、分子固有の不変指紋ではない。

実験曲線には厳密な設計が必要である。化合物が容器、蛋白、組織へ結合するなら名目濃度でなく遊離濃度が重要となる。溶媒対照は溶媒効果を示す。無作為化と盲検化は操作・解釈バイアスを減らす。独立した生物標本間の反復は一般化可能性を推定するが、一標本の反復ウェルは主に技術変動を測る。時間、温度、酸素化、基礎緊張、洗浄、添加順、生命力が曲線を変え、精緻なモデルでも不安定標本を救えない。

パラメータ推定には不確実性が必要である。Hill式は傾斜、中点、最大を要約するが、Hill係数は自動的に結合部位数を意味しない。急傾斜は協同性、増幅、異質性、閾値、測定圧縮から生じ得る。信頼区間、残差、代替モデル、実測範囲を調べる。プラトーがなければE maxとE C五十の同定は弱い。各曲線を自身の最大へ正規化すると効力差を隠す。

臨床移行では標的妥当性と治療価値を分ける。単純測定系で強力に標的を占有しても、関連細胞へ届かず、冗長経路が代償し、同じ標的を持つ別組織で有害作用が出れば失敗する。選択性は濃度依存であり、低曝露で一標的を好む薬も高曝露では多標的に作用する。最終的な問いは結合するかではなく、達成可能な曝露が対象集団で再現可能な利益を許容可能な害とともに生むかである。

定量的受容体理論はこの推論の文法となる。親和性、占有、効力、効力価、最大効果、拮抗、予備、適応、変動性は別の問いに答え、同義に扱えない。系、評価項目、時間尺度、不確実性を明記すれば、用量反応曲線は証拠となる。条件を欠けば、その数値は生物学にない精密さを装う。

## TTSモジュール2：創薬、前臨床開発、臨床試験

医薬品開発は、操作可能な機序を意味ある利益へ結び付ける反復作業である。標的から治療へ単純に進むことは少ない。ヒト疾患が標的に依存せず、モデルが疾患の一面しか表さず、生物活性化合物でも曝露や安全性が不足し得る。したがって開発は因果生物学、医薬化学、薬理学、毒性学、製造、統計、臨床判断を結ぶ。どの接点の破綻も優れた結果を無効にし得る。

標的同定はヒト遺伝学、病理、生理、疫学、オミクス、臨床観察、表現型スクリーニングから始まる。関連は検証ではない。独立した証拠が操作による疾患関連生物学の変化を示し、介入方向と時期が理解され、ヒト変異が整合する効果を予測すると標的は強くなる。生涯の遺伝的機能喪失は、発達と代償のため発症後の薬理阻害と異なり得る。妥当な標的でも到達不能または危険なことがある。

表現型創薬は既知分子標的を必須とせず、望ましい細胞・個体反応を探す。標的型創薬は定義した蛋白や経路に化合物を試す。表現型探索は統合生物学を保つが機序解明と最適化が難しく、標的探索は扱いやすいが疾患を単純化し得る。異なる測定原理の直交測定で活性を確認し、カウンタースクリーンで干渉、細胞毒性、凝集、蛍光人工像、不要標的作用を見つける。

ヒットは再現性ある活性を持つ出発化合物であり、薬ではない。確認では同一性、純度、濃度反応、妥当な機序を確立する。医薬化学は構造を変え、力価、選択性、溶解性、透過性、代謝安定性、合成可能性を改善する。構造活性相関は化学変化と性質を結ぶ。一性質の改善が他を悪化させ、脂溶性増加は膜通過を上げる一方、非特異結合、代謝、組織蓄積を増し得る。

リード最適化には薬物動態と薬力学の同時推論が必要である。吸収、利用率、分布、蛋白結合、クリアランス、半減期、活性代謝物が曝露を決める。標的占有バイオマーカーは化合物が標的へ到達し調節したかを示す。下流マーカーは生物学的結果、臨床評価項目は人がどう感じ、機能し、生存するかを示す。マーカーは機序を支持しても利益の代替指標とは限らず、因果性がない、または害が利益を相殺すれば検査値改善は転帰を保証しない。

試験管内系は精製蛋白、細胞株、初代細胞、オルガノイド、共培養まで幅がある。複雑化は妥当性を高め得るが制御と処理量を下げる。細胞株は変異を獲得し、専門形質を失い、非生理的標的量を発現し得る。オルガノイドは一部の空間・細胞関係を再現するが、完全な循環、免疫、行動、長期環境を持たない。実験濃度を達成可能なヒト遊離曝露と比較し、非現実的高濃度だけの活性は弱い移行証拠とみなす。

動物モデルは統合的な動態、生理、行動、毒性を調べられるが、種差が標的、代謝、免疫、寿命、疾患発現を変える。モデルはヒト原因と相同、別原因で同じ表現型を再現、または経験的に反応を予測する場合がある。無作為化、割付隠蔽、盲検評価、事前除外基準、十分な標本数、研究室間再現により誇張を減らす。性、年齢、併存症、標準治療の考慮は重要だが、生物学的問いに基づかせる。

安全性薬理は特に心血管、呼吸、中枢神経機能を調べる。毒性学は単回・反復投与、臓器傷害、可逆性、曝露余裕、遺伝毒性、生殖発生影響、必要に応じ発癌性を評価する。無毒性量は実験境界であり危険ゼロの証明ではない。初回ヒト用量は動物曝露、薬理活性用量、予測不確実性、標的生物学、急峻または遅延毒性を統合して決める。

製造は同一性、純度、安定性、剤形、粒径、添加剤、放出特性を通じて曝露を決めるため薬理学の一部である。拡張可能な工程が規定品質を一貫して作らねばならず、不純物には別の毒性があり得る。生物製剤は折り畳み、糖鎖、凝集、汚染、免疫認識に敏感である。動物用剤形がヒトで許容または生物学的同等とは限らず、工程変更には比較可能性証拠が必要となる。

初回ヒト試験は安全性、忍容性、動態、時に標的占有を調べる。単回漸増・反復漸増試験は事前中止規則の下で連続コホートへ投与する。危険が許容されれば健康成人を用い、毒性、不可逆機序、疾患生物学が健康者曝露に不適なら患者を用いる。累積曝露、活性代謝物、遅延作用、受容体占有、各コホート情報を考慮し、用量だけで増量しない。

第二相は対象疾患で用量、投与法、機序、予備的有効性を探索する。用量選択は最大耐量探しでなく推定問題である。低すぎれば有効機序を捨て、高すぎれば有害作用が利益を隠す。単一任意用量より複数用量と曝露反応モデルが望ましい。濃縮選択は反応しそうなマーカーや特徴を持つ患者を選び信号を高めるが、結果を適用できる集団を狭める。

第三相確認試験はより大きな集団で事前仮説と臨床的比較対照を用い利益と害を検証する。無作為化は既知・未知予後因子を平均的に均衡させる。割付隠蔽は登録が割付予測に左右されるのを防ぐ。盲検は診療、報告、評価の差を減らすが、作用から割付が分かる場合がある。治療意図解析は割付群で解析して無作為化を保ち、プロトコル遵守解析は別の問いに答え登録後選択に弱い。

評価項目は目的とする主張に一致させる。死亡、主要罹患、症状、機能、生活の質は直接重要である。複合評価項目は事象数を増すが、頻繁な軽症項目が結果を支配し重症項目が不変なことがある。代替評価項目で期間を短縮するには、同じ介入分類と状況で臨床利益との関係が十分確立している必要がある。患者報告評価には検証済み尺度と、欠測、言語、文化、盲検解除への配慮が必要となる。

優越性試験は対照より優れるかを、非劣性試験は効果損失が事前限界より小さいかを調べ、対照薬がその試験で効いたはずという確信を要する。遵守不良、交差、鈍い評価項目、低事象率は偽の類似を作る。等価性では差の上限と下限がともに範囲内でなければならない。統計的有意性は臨床的重要性を保証せず、効果量、不確実性、基礎リスク、期間、害が価値を決める。

適応的デザインは事前規則により登録、割付、用量、標本数を変更しつつ誤差を制御する。プラットフォーム試験は共通基盤で複数介入を評価し群を追加・除去できる。中間解析は大きな利益、害、無益性で早期終了できるが、反復観察には統計調整と運用上の防護が必要である。独立データ監視委員会が非盲検データを審査する。結果を見た後の無計画変更は適応デザインでなく通常のバイアスである。

稀な有害事象、長い潜伏、妊娠転帰、相互作用、少数集団での性能は承認後に初めて現れ得る。市販後監視は自発報告、登録、電子医療データ、観察研究、追加試験を組み合わせる。自発報告は信号に有用だが分母が不確かで報道に影響される。観察比較では交絡、選択、時間関連バイアス、転帰誤分類を制御する。信号を即時因果とせず、無視もせず、比例的に調べる。

開発判断は確率、結果の重大性、機会費用を統合する。無効計画の中止は参加者と資源を守るが、早すぎれば有用な治療を失う。単一の小さなp値より、再現性、大きさ、曝露反応整合性、機序的一貫性、ヒト証拠が信頼を高める。陰性結果は標的仮説、モデル、分子、用量、集団、評価項目を別々に更新すべきで、一つの失敗が全ての失敗を証明しない。

移行連鎖の各段階は別の問いに答える。標的は疾患を変えるか、分子は選択的に調節できるか、有効曝露を得られるか、ヒト生物学は予測通り反応するか、その反応は害と負担を正当化するほど転帰を改善するかである。創薬はこれらの答えが実験、製造ロット、臨床集団、時間を越えて一貫するときにのみ成功する。

## TTSモジュール3：薬理ゲノミクス、有害作用、相互作用、規制

薬物反応の変動は曝露、標的生物学、疾患、行動、偶然から生じる。薬理ゲノミクスは遺伝性・後天性ゲノム変異の寄与を調べる。有用な結果は、処方するか、どの薬を選ぶか、開始量、調整速度、監視する毒性のいずれかを変えなければならない。統計的関連だけでは足りず、変異を正確に測定し、再現可能な表現型と結び、使用する祖先集団、治療、臨床状況で解釈する。

薬物動態遺伝子は吸収、輸送、代謝、排泄を変える。対立遺伝子により酵素機能が欠失、低下、正常、増加、または質的変化を示す。低代謝、中間、正常、高速、超高速などの表現型分類は連続体を単純化した遺伝子別の概念である。活性親薬物では代謝低下が曝露と毒性を上げ得る。活性化を要するプロドラッグでは同じ機能低下が活性代謝物と有効性を下げ得るため、経路を知らずに方向を推定できない。

遺伝型は現在の表現型と常に一致するとは限らない。他薬による酵素阻害で遺伝的正常者が低代謝者のようになる表現型転換が起こる。酵素誘導は新蛋白産生に伴い数日で能力を増す。炎症、肝腎疾患、年齢、妊娠、食事、喫煙、微生物叢が発現や競合経路を変える。限定パネルは稀な変異やコピー数変化を見逃し、新規対立遺伝子の機能は不明なことがある。

薬力学的変異は標的、免疫認識、下流反応を変える。受容体や伝達変異は感受性を変え得る。抗原提示分子の特定変異は、薬物関連抗原をT細胞へ提示し特異的過敏症リスクを大きく上げる。腫瘍の後天変異は経路依存性や治療抵抗性を予測し得るが、不均一性のため一生検が全クローンを表すとは限らない。生殖細胞系列所見は本人全体と血縁者に、体細胞所見は主に採取組織に関係する。

先制遺伝型検査は処方前に結果を用意し、反応的検査は治療判断時に行う。先制検査は遅延を防ぎ再利用できるが、永続記録、解釈更新、誤適用防止が必要である。反応的検査は目前の問いに合うが、緊急治療に間に合わないことがある。意思決定支援は説明のない警告でなく、遺伝子、二対立遺伝子型または変異、推定表現型、根拠ある行動、代替、限界を示す。

薬物有害反応は意図した薬理の延長、標的外作用、免疫反応、毒性代謝物、離脱、相互作用、投薬過誤から生じる。予測可能な用量関連反応は多く、用量や曝露調整で管理できることがある。予測困難な反応は稀で用量との関係が不明瞭でも、遺伝・免疫的感受性を持ち得る。分類は推論補助であり法則ではなく、内因性毒性、宿主脆弱性、曝露が複合する事象が多い。

投薬後の有害事象が自動的に薬物原因とはならない。因果評価は時期、既知機序、用量反応、中止後改善、再投与再発、代替疾患、併用薬、客観証拠を考える。再投与は推論を強めるが、重篤既往では非倫理的である。中止後改善も疾患の自然軽快や複数薬同時中止で誤解し得る。形式的尺度は一貫性を増すが、臨床判断を代替せず欠測情報を作れない。

免疫性反応には即時抗体関連、細胞傷害、免疫複合体、遅延T細胞反応があるが、臨床症候群が一分類へ収まらないこともある。以前の無症状曝露は感作を否定せず、初回と認識した曝露以前に環境または交差反応性接触があり得る。重症皮膚・全身反応は免疫活性化が自律化し中止後も進行し得る。記録には単なるアレルギーでなく、原因薬、表現型、重症度、時期、確実性を残す。

臓器毒性は局所曝露と脆弱性を反映する。肝は初回通過で高濃度に接し、直接、代謝性、免疫性、ミトコンドリア性、胆汁うっ滞性傷害を受ける。腎は濾液を濃縮し、輸送依存毒性、結晶、血行動態変化、免疫傷害へ尿細管を曝す。心では伝導、再分極、収縮、虚血、構造障害が起こる。骨髄、肺、神経、筋、生殖組織にも特徴的パターンがある。監視は全検査の反復でなく、妥当な潜伏期と機序に合わせる。

相互作用は、一薬が他薬の曝露を変える薬物動態的作用と、共通生理結果で効果が組み合わさる薬力学的作用に分かれる。吸収は結合、pH、運動、輸送で変わる。代謝阻害は阻害薬濃度上昇とともに始まるが、誘導は蛋白量変化を要し発現・消退が遅い。腎輸送競合、灌流、蛋白置換も関与するが、置換だけなら遊離濃度に応じクリアランスが増して一過性のことが多い。

薬力学的相互作用は相加、相乗、拮抗となる。複数鎮静薬は相互濃度を変えず共同で意識と換気を抑制し得る。異なる機序で止血を障害する薬は出血を増す。心再分極を遅らせる複数薬の危険は電解質、心拍、性、構造疾患、濃度で変わる。相互作用データベースは可能性を示すが、管理には大きさ、時間経過、患者脆弱性、代替、監視で害を減らせるかの推定が必要である。

年齢は生涯を通じ反応を変える。新生児は排泄経路が未熟で体組成も異なる。成熟は非線形なため、小児は体重換算した成人ではない。高齢者は腎予備能低下、体組成変化、虚弱、多疾患、薬力学的感受性を持ちやすい。筋量が低いと濾過低下でも血清クレアチニンが正常に見える。多剤は相互作用と服薬負担を増すが、各薬に現在の適応、純利益、実行可能な方法、中止計画があるかを問う。

妊娠は血漿量、体水分、蛋白結合、腎濾過、酵素活性を変える。胎盤通過は分子と輸送体特性に依存し、胎児リスクは発達時期で異なる。早期曝露は喪失や大奇形、後期曝露は成長、臓器成熟、新生児適応へ影響し得る。妊婦は試験から除外され観察証拠が多いため、不確実性により有効治療が控えられる害も生じる。薬物リスクは無治療をゼロリスクとせず母体疾患と比較する。

授乳リスクは母体濃度、乳汁移行、乳児経口吸収、乳児クリアランス、体重当たり用量、毒性で決まる。早産や疾患は脆弱性を増す。腎肝障害は親薬物または代謝物曝露を上げ得るが、単純減量が常に正しくない。負荷量は主に分布容積、維持投与速度は主にクリアランスに依存する。透析除去は分子量、蛋白結合、分布、膜、治療強度で変わる。

薬物安全は処方、調剤、投与、監視、移行を含む。類似名称、曖昧な単位、小数点誤り、成分重複、不適合剤形、不完全な薬剤照合は薬理知識を迂回する。標準化、明確表示、高リスク工程の独立確認、事故からのフィードバックにより、正しい行動を容易にし危険行動を難しくする。個人を責めて工程を調べなければ、誤りを生んだ条件が残る。

規制当局は定義された適応、集団、用量、製品について品質、有効性、安全性を評価する。承認はその条件で利益危険バランスを支持する証拠があることを意味し、完全な知識や全代替への優越を意味しない。製品情報、リスク管理、流通制限、義務的研究、安全情報、表示変更、撤回により不確実性を管理する。利用可能治療、許容評価項目、法的任務、不確実性許容が違えば当局間判断も合理的に異なり得る。

発売後も証拠と推奨は変わる。新規リスクは絶対頻度、予防可能性、可逆性、治療利益、代替結果と比較する。相対危険が大きくても絶対増加が小さい場合があり、一般的重篤転帰なら小さな相対増加も重要となる。利益と害は異なる人と時間に生じ得る。共同意思決定では、全選択肢の根拠が同等と装わず不確実性と代替を伝える。

責任ある薬理学は分子機序を特定の人と医療制度へ結ぶ。ゲノムは確率を精密化しても、臓器機能、併用薬、診断、服薬、観察を置換しない。安全信号は即断でなく調査を要し、規制は必然的に不完全な証拠を管理する。明確な目標へ曝露を選び、患者生物学による変化を予測し、利益と害を早期検出し、新証拠に応じ治療を改訂することが実践上の規律である。

# 第98章：自律神経、神経筋接合部、局所メディエーターの薬理学

## TTSモジュール1：コリン作動性伝達と薬理学

自律神経系は意識的命令なしに循環、換気、消化、体温、排尿、腺分泌、代謝、性機能を調節する。交感神経と副交感神経は単純な反対ではない。起始、神経節、伝達物質、受容体分布、発火様式が異なり、多くの臓器で入力は不均等または協調的である。したがって薬効は受容体選択性だけでなく、安静時緊張、反射、疾患、用量、中枢・末梢への到達性で決まる。

すべての自律神経節前ニューロンはアセチルコリンを放出し、交感・副交感神経節の神経型ニコチン受容体と副腎髄質の関連受容体へ作用する。大部分の副交感神経節後ニューロンもアセチルコリンをムスカリン受容体へ放出する。重要な交感神経例外はエクリン汗腺へのコリン作動線維である。体性運動ニューロンも骨格筋接合部でアセチルコリンを使うが、ニコチン受容体亜型とシナプス構築は自律神経節と異なる。

アセチルコリンは終末内でコリンとアセチル補酵素Aからコリンアセチルトランスフェラーゼにより合成される。高親和性輸送体がコリンを回収し、持続活動時には合成律速となり得る。小胞輸送体が伝達物質を小胞へ入れ、活動電位後のカルシウム流入が専門蛋白を介し小胞融合を起こす。シナプス間隙のアセチルコリンエステラーゼが速やかにコリンと酢酸へ分解する。この時間精度の高い終結機構が強力な薬理標的となる。

ニコチン受容体は複数サブユニットからなるリガンド作動性陽イオンチャネルである。アセチルコリン結合で開口し、後シナプス膜を脱分極して活動電位を開始し得る。作動薬が持続すると初期刺激後に脱分極遮断と脱感作が起こる。神経型受容体は神経節伝達と中枢回路に、筋型受容体は運動終板に集中する。亜型差は部分的選択性を許すが、高用量では境界を越えて不要作用を生む。

ムスカリン受容体はG蛋白共役型である。M一、M三、M五は主にホスホリパーゼC経路へ共役し細胞内カルシウムと蛋白キナーゼCを増す。M二、M四は主に環状AMPを減らしカリウムチャネルを開き得る。結果は細胞で異なり、心臓M二は洞結節発火と房室伝導を遅くする。内皮M三は一酸化窒素を放出し血管を拡張するが、多くの血管に直接副交感神経支配はない。腺と平滑筋M三は分泌を増し多くの内臓を収縮させる。

直接ムスカリン作動薬はアセチルコリンを模倣するが、分解感受性と受容体選好性が異なる。縮瞳、近見調節、唾液・涙液増加、気管支収縮と分泌、心拍低下、消化管運動増加、排尿筋収縮、括約筋弛緩を生じ得る。治療は選択効果を利用するが、全身曝露は他部位の同じ受容体群も活性化する。喘息、伝導障害、消化性疾患、閉塞、低血圧では危険となる。

ピロカルピンは外分泌を促進し虹彩括約筋と毛様体筋を収縮させる。ベタネコールはコリンエステラーゼへ抵抗性で主にムスカリン受容体へ作用し、膀胱と消化管平滑筋を増強する。望ましい反応には機能する筋と開通した出口が必要である。尿路や腸管の機械的閉塞時に作動薬を与えると流れを戻さず圧を上げ得るため、症状だけでなく機械的診断に従う。

アセチルコリンエステラーゼ阻害薬は伝達物質が放出される全場所でアセチルコリンを増す。可逆薬は持続時間と中枢移行性が異なる。末梢増強は神経筋伝達、消化管・膀胱活動を改善し、非脱分極性筋弛緩を逆転し、副交感緊張を増す。中枢移行薬は一部神経変性症候群の伝達を軽度補助するが、失われたニューロンを戻さない。同時にムスカリン性・ニコチン性毒性も生じ、用量と状況が有用性を決める。

有機リンは酵素をリン酸化して長時間阻害する。時間とともに複合体はエイジングし再活性化へ抵抗性となる。過剰アセチルコリンは分泌、発汗、嘔吐、下痢、縮瞳、気管支収縮、徐脈または多様な循環作用、筋束攣縮から筋力低下、中枢興奮、痙攣、昏睡を起こす。呼吸不全は気道分泌、気管支攣縮、中枢抑制、神経筋麻痺が組み合わさる。汚染衣服と皮膚から曝露が続くこともある。

重症中毒では汚染から医療者を守り、気道、酸素化、換気、循環を支持する。アトロピンはムスカリン受容体を競合遮断し、瞳孔でなく特に気管支分泌と攣縮など危険なムスカリン所見の改善へ滴定する。オキシムはエイジング前の一部リン酸化酵素を再活性化し、特にニコチン性筋力低下に関係するが、効果は化合物と時期に依存する。ベンゾジアゼピンは痙攣を治療する。除染と支持療法はいずれにも置換できない。

ムスカリン拮抗薬は副交感性アセチルコリンの効果器受容体活性化を防ぐ。代表的競合薬アトロピンは分泌と発汗低下、散瞳と調節麻痺、頻脈、気管支拡張、消化管運動低下、尿閉を起こす。反応は基礎緊張に依存し、迷走神経優位の安静心では遮断により著明に速くなるが、交感神経最大時の影響は小さい。低用量ではシナプス前・中枢作用により単純な用量関係に合わない反応もあり得る。

拮抗薬は投与経路、動態、組織移行で使い分ける。吸入四級薬は全身吸収を抑え気道へ作用を集中する。眼科薬は局所散瞳または調節麻痺を作る。膀胱選択戦略は排尿筋過活動を抑えながら口渇、便秘、認知作用、発汗障害を減らそうとする。中枢作用薬は前庭性動揺信号や一部運動症状を抑える。選択性は相対的であり、曝露が増せば利点は失われる。

抗ムスカリン毒性では粘膜乾燥、発汗障害による熱い皮膚、散瞳、近見障害、頻脈、腸音低下、尿閉、興奮、せん妄、幻覚、高体温が起こる。幼児と高齢者は体温・認知作用に特に脆弱である。多くの抗ヒスタミン薬、抗うつ薬、抗精神病薬、膀胱薬、市販薬が累積抗コリン負荷へ寄与するため、自律神経薬と表示されない処方からも毒性が生じる。

神経節作用薬は交感・副交感伝達をともに変えるため、臓器効果は優位な安静時緊張を反映する。血管緊張は主に交感性なので神経節遮断は血管拡張と起立性低血圧を起こす一方、安静心は副交感優位なので頻脈を生む。口渇、調節麻痺、便秘、尿閉、性機能障害も起こる。臓器選択性の欠如が治療利用を制限するが、優位緊張を通じて自律神経薬理を読む重要性を示す。

シナプス前受容体と共伝達物質がコリン伝達をさらに複雑にする。自己受容体は追加放出を抑え、ATP、ペプチド、一酸化窒素などが古典的伝達物質とともに放出され得る。高頻度刺激は低頻度とは異なる混合を動員する。合成、貯蔵、放出、分解、フィードバックへ作用する薬は、一受容体のアセチルコリン量だけでなく伝達の時間パターンを変える。

眼のコリン作用は連結した解剖を示す。虹彩括約筋収縮は縮瞳を起こし、毛様体筋収縮はチン小帯張力を緩め、水晶体を丸くして近見調節を行う。同時に線維柱帯流出路を開き眼圧を下げ得る。ムスカリン遮断は散瞳と調節麻痺を起こし、解剖学的狭隅角では排出を妨げ得る。局所有用作用も、解剖、用量、投与法を考えなければ全身吸収や危険な眼圧反応を生む。

臨床推論はシナプスを順に追うと明瞭になる。部位が中枢、神経節、節後ムスカリン、骨格筋接合部のどれかを同定する。アセチルコリンを増減すべきか、解剖経路が保たれているか、他のどの臓器が同じ受容体を持つかを判断する。持続、可逆性、経路、反射性代償、累積負荷も考える。同じコリン機序でも作用部位と強度により、尿閉を改善し、閉塞を悪化させ、筋力を高め、呼吸分泌やせん妄を起こし得る。

## TTSモジュール2：アドレナリン作動性伝達と薬理学

交感神経伝達は一様な闘争逃走状態を作るのでなく、需要変化へ臓器を適応させる。節前コリン線維は神経節と副腎髄質を活性化する。大部分の節後交感線維は標的組織に分布する膨大部からノルアドレナリンを放出し、副腎クロム親和性細胞はアドレナリンと一部ノルアドレナリンを血中へ放出する。反応は受容体亜型、濃度、基礎緊張、ホルモン、反射性代償に依存し、一薬が昇圧、反射性徐脈、気管支拡張、代謝変化、消化抑制を同時に起こし得る。

カテコールアミン合成では、律速調節段階としてチロシン水酸化酵素がチロシンをジヒドロキシフェニルアラニンへ変える。芳香族アミノ酸脱炭酸酵素がドパミンを作り、小胞輸送体が貯蔵小胞へ移す。小胞内ドパミンベータ水酸化酵素がノルアドレナリンを作る。副腎髄質では皮質由来の高局所糖質コルチコイドに促進されたフェニルエタノールアミンNメチル基転移酵素がアドレナリンを作る。ATP、ペプチド、蛋白と貯蔵され、カルシウム依存性開口放出を受ける。

終結はコリン伝達と異なる。多くの交感シナプスではノルアドレナリン輸送体によるシナプス前再取り込みが主要な即時機構である。再利用される伝達物質は小胞へ戻るか、モノアミン酸化酵素で代謝される。カテコールOメチル基転移酵素は神経外組織で働き、代謝物はさらに処理され排泄される。再取り込み阻害は拡散した伝達物質の持続と作用範囲を増す。合成、食事性アミン、他モノアミンが増えると代謝酵素阻害の影響も大きくなる。

アルファ一受容体は主にホスホリパーゼCと細胞内カルシウムを介し、血管平滑筋、虹彩散大筋、膀胱出口、一部括約筋を収縮させ、腺・代謝反応も促す。血管作用は末梢抵抗と静脈緊張を上げる。動脈圧上昇は圧受容器を活性化して反射性徐脈を生じ得るため、心拍は純粋な受容体指標ではない。局所鼻・眼血管収縮は充血を減らすが、反復曝露は虚血や反跳性充血を起こし得る。

アルファ二受容体は通常アデニル酸シクラーゼを抑え、シナプス前終末からの伝達物質放出を減らす。脳幹、血小板、膵、血管などの後シナプス部位にもある。中枢アルファ二作動は交感出力を減らし、心拍と血圧を下げ、鎮静と口渇を生む。急速全身曝露では末梢血管作用により初期昇圧後に中枢作用が優位となり得る。適応後の急な中止は交感活動を解放し反跳性高血圧を生む。

ベータ一受容体は心臓で環状AMPとカルシウム処理を増し、心拍、伝導、収縮、弛緩を高める。傍糸球体細胞のレニン放出も促す。収縮と心拍増加は酸素需要を上げ、冠供給が限られると有害となる。ベータ一選択性は相対的で濃度増加とともに低下する。内因性作用は神経支配にも依存し、心終末のノルアドレナリンは効率よくベータ一へ作用し、血中アドレナリンは全身ベータ受容体へ届く。

ベータ二受容体は環状AMP依存経路により多くの平滑筋を弛緩し、気管支拡張、特定血管床の拡張、子宮弛緩を生む。カリウムを細胞内へ移し、グリコーゲン分解を刺激し、振戦と頻脈を起こし得る。頻脈は選択性喪失による直接作用、血管拡張への反射、または両者で生じる。吸入は作用を気道へ集中するが全身曝露を消さない。短時間作用性拡張薬の頻回使用は無制限刺激の必要でなく、基礎炎症疾患の制御不良を示し得る。

ベータ三受容体は脂肪分解、熱産生伝達、膀胱排尿筋弛緩に寄与する。ドパミン受容体はアドレナリン受容体ではないがカテコールアミン薬理に関係する。低曝露のドパミン受容体作用は血管・内分泌機能を変え、高曝露ではベータ、さらにアルファ受容体も活性化する。確実に腎選択的なドパミン用量という歴史的概念は急性腎傷害予防へ結び付かなかった。用量名でなく実測血行動態と臓器反応をみる。

直接交感作動薬は受容体自体へ結合する。アドレナリンはアルファとベータを活性化し、濃度と組織で均衡が変わる。重症全身アレルギー反応で血管緊張、心拍出、気管支拡張、メディエーター放出抑制を支える。ノルアドレナリンは血管緊張を強く高め血管拡張性ショックの圧を支えるが、反射が頻脈を制限し得る。選択的ベータ作動薬は心拍出を、アルファ一作動薬は血管抵抗を支え得る。低圧数値だけでなく血行動態欠陥を同定して選ぶ。

間接交感作動薬は放出促進、輸送逆転、再取り込み阻害、代謝阻害により内因性カテコールアミンを増す。効果は機能する終末と貯蔵量に依存し、反復投与でタキフィラキシーが起こり得る。混合作用薬は受容体作動と放出を併せ持つ。中枢刺激はドパミンとノルアドレナリン経路も介し、用量と感受性により覚醒、食欲低下、多幸、不安、精神病を生む。末梢では血管収縮、頻脈、高体温、消化機能低下が起こる。

アルファ一拮抗薬は細動脈・静脈緊張と膀胱出口平滑筋を弛緩する。動的筋緊張が閉塞へ寄与すれば尿流を改善するが、固定組織を縮小せず機械病変を直さない。起立時の正常交感代償を妨げ、初回・起立性低血圧を起こす。反射性頻脈は選択性と動態で異なる。カテコールアミン産生腫瘍では計画的遮断が必要で、十分なアルファ遮断前の単独ベータ遮断は血管収縮を悪化させ得る。

ベータ遮断薬はベータ一選択性、部分作動性、脂溶性、膜作用、排泄、付加的血管拡張性が異なる。心拍、収縮、レニン、一部不整脈を抑え、特定心不全で有害な慢性アドレナリン伝達を修正する。急性陰性変力作用があり得ても利益は時間とともに現れる。受容体増加後の急な中止は反跳性頻脈や虚血を起こす。用量と適応が同じ薬理作用を治療的または危険にする。

ベータ二遮断は特に反応性気道疾患で気道抵抗を上げ、救急気管支拡張を妨げ得る。低血糖のアドレナリン警告を隠すが、発汗は交感コリン性なので残り得る。末梢血管症状、疲労、運動制限、睡眠障害、伝導遅延は患者と薬で異なる。見かけの禁忌は薬効群名だけでなく、選択性、疾患重症度、利益、用量、監視で解釈する。

アドレナリン作動ニューロン遮断薬は合成、小胞貯蔵、放出を阻害できるが、交感代償を広く妨げ起立性・性機能有害作用を生む。モノアミン酸化酵素阻害は相互作用するモノアミンや一部間接薬への脆弱性を増す。過剰基質が制御を越えてノルアドレナリンを放出すると重症高血圧と高体温を起こす。相互作用は阻害薬選択性、可逆性、用量、腸肝代謝、中止後時間に依存する。

交感作動薬毒性は一検査値でなく生理学的症候群である。興奮、散瞳、発汗、頻脈、高血圧、高体温、振戦、胸痛、痙攣、筋傷害が起こる。高度血管収縮と血管内容量不足が共存し得る。体温上昇は筋活動、中枢駆動、放熱障害から生じ能動的管理を要する。治療は支持、刺激低減、適切な鎮静、冷却、生理に応じた輸液、個別循環合併症管理を中心とし、不用意な単独受容体遮断は不安定な均衡を悪化させ得る。

自律神経反射は直感に反する所見を説明する。血管収縮は直接心刺激があっても圧受容反射で心拍を下げ、血管拡張はベータ作動なしに頻脈を起こし得る。除神経、神経障害、加齢、脊髄傷害、脱水、併用薬が反射を変える。直接受容体作用と代償反応は発現・持続が違うため、一時点より経時測定が有用である。

アドレナリン薬理は系制御の問題である。受容体特性だけでなく、到達区画、内因性伝達物質量、基礎緊張、反射環を同定する。血圧を心拍出量と血管抵抗に、心拍出量を心拍数と一回拍出量に分ける。患者内の薬は単なるアルファ作動薬やベータ遮断薬ではなく、状況と時間で反応を変える循環、気道、代謝系、脳への入力である。

## TTSモジュール3：神経筋伝達と局所メディエーター薬理学

骨格筋神経筋接合部は運動神経活動電位を大きな正常安全余裕をもって筋収縮へ変える。一つの専門終末から放出されたアセチルコリンが狭い間隙を渡り、接合ひだに密集する筋型ニコチン受容体へ結合する。ナトリウム流入が終板電位を作り、近傍の電位依存性ナトリウムチャネルを活性化する。筋活動電位は筋鞘と横行小管を伝わり、筋小胞体からカルシウムを放出してアクチン・ミオシン回転を始める。疾患や薬物は他の段階を保ったまま一連鎖を遮断し得る。

非脱分極性筋弛緩薬は筋型ニコチン受容体を開かず競合占有する。占有率が増すと終板電位が閾値へ達せず弛緩性麻痺となる。小さく速い筋が横隔膜より先に弱まり、回復順序は異なり得る。これらは意識消失、健忘、鎮痛、鎮静を生まない。麻痺した人も完全に覚醒し得るため、神経筋遮断を麻酔と誤認してはならない。

末梢神経刺激と筋反応で遮断深度を評価できる。反復刺激では伝達物質動員が受容体遮断を克服できず減衰が現れる。定量監視は視触診より信頼でき、呼吸が十分に見えても咽頭機能回復を保証しない。残存遮断は気道閉塞と誤嚥を増す。コリンエステラーゼ阻害でアセチルコリンを増やし、不要ムスカリン作用を遮断して逆転するか、特定遮断薬分子を結合剤で包接できる。

脱分極性遮断ではニコチン作動薬が終板チャネルを開くが、アセチルコリンより長く残る。初期脱分極は筋束攣縮を起こし、その後電気的不活性化と弛緩性麻痺になる。長時間曝露では膜と受容体が非脱分極性遮断に似た後期相へ変わる。熱傷、除神経、大きな筋傷害、長期不動、神経筋疾患では接合外受容体が増え、反復脱分極でカリウム流出が危険となる。血漿コリンエステラーゼ遺伝変異は代謝と無呼吸を著しく延長し得る。

ボツリヌス毒素はコリン小胞融合に必要な蛋白を切断する。運動終末では局所筋力低下、自律コリン終末では分泌と平滑筋作用低下を生む。正確な少量注射は局所過活動を治療するが、拡散や過量は嚥下障害、全身筋力低下、呼吸障害を起こす。破傷風毒素も運動終末へ入るが中枢へ移動し抑制性伝達物質放出を遮断するため、末梢弛緩でなく脱抑制と攣縮を生む。同じ分子装置でも解剖学的輸送により反対症候群となる。

局所メディエーターは作用部位近くで、多くは迅速・一過性に作られる。血管緊張、透過性、平滑筋、血小板、侵害受容、炎症、分泌、細胞増殖を調整する。通常の内分泌ホルモンと異なり、濃度は微小距離と秒単位で急変する。薬物は合成遮断、放出防止、受容体拮抗、除去促進、模倣により作用する。複数メディエーターが共同するため、一経路抑制は反応を消すより別経路を露出させ得る。

ヒスタミンは主に肥満細胞と好塩基球顆粒へ貯蔵され、胃と神経細胞でも作られる。免疫学的架橋、補体断片、物理刺激、一部薬物が放出を起こす。H一受容体は内皮収縮と透過性、感覚神経性掻痒、気管支・腸平滑筋収縮、中枢覚醒伝達を促す。内皮一酸化窒素が血管拡張へ寄与する。H二受容体は胃酸分泌と一部心血管作用を促す。他亜型は神経伝達物質放出と免疫細胞を調節する。

H一抗ヒスタミン薬は不活性受容体状態を安定化する逆作動薬である。旧来脂溶性薬は脳へ入り、鎮静、能力低下、抗ムスカリン作用、起立症状を起こし得る。新しい薬は概して中枢移行が少ないが、動態と相互作用リスクは同一でない。ヒスタミン性掻痒、くしゃみ、膨疹を減らすが、重症全身アレルギーの全要素を確実に逆転しない。気道、呼吸、循環が脅かされるときは複数の致命的機序へ作用するアドレナリンを置換できない。

H二拮抗薬は壁細胞ヒスタミン伝達を遮断し酸分泌を減らす。プロトンポンプ阻害薬は最終酸ポンプという下流へ作用し通常より強く抑える。胃ヒスタミン放出は神経・ホルモン入力に刺激されるため、受容体遮断は統合ネットワークを変える。慢性酸抑制は感染リスク、栄養処理、フィードバックホルモンを変え得るが、影響の大きさと意義は患者と期間で異なる。

セロトニンはトリプトファンから合成され、脳、腸管神経、消化管粘膜、血小板、血管で働く。末梢の大部分は腸クロム親和性細胞が作り、血小板は合成せず取り込み活性化時に放出する。受容体群にはG蛋白共役型とリガンド作動性陽イオンチャネルがある。亜型ごとに気分、悪心、運動、血管緊張、血小板、侵害受容へ作用するため、単にセロトニン性という説明は機序として不完全である。

セロトニン受容体拮抗薬は迷走・中枢経路の悪心を抑え、選択的作動薬は片頭痛で頭蓋血管を収縮し神経ペプチド放出を抑える。過剰セロトニンは興奮、クローヌス、反射亢進、振戦、自律神経不安定、下痢、高体温を起こす。合成、放出、受容体刺激を増す薬、再取り込み・代謝を減らす薬の併用で起こりやすい。神経筋所見と曝露歴が他の高体温毒性症候群との鑑別を助ける。

エイコサノイドは膜多価不飽和脂肪酸の酸化産物である。細胞活性化によりホスホリパーゼがアラキドン酸を放出する。シクロオキシゲナーゼはプロスタグランジン、プロスタサイクリン、トロンボキサンの中間体を作り、リポキシゲナーゼはロイコトリエンなどを作る。必要時に合成され局所作用後速やかに代謝される。内皮、血小板、白血球、腎、胃粘膜、生殖組織などで均衡が異なる。

プロスタグランジンは疼痛感作、発熱、血管緊張、腎灌流、胃保護、子宮活動、動脈管開存を調節する。内皮プロスタサイクリンは血管を拡張し血小板を抑え、血小板トロンボキサンは凝集と収縮を促す傾向がある。ロイコトリエンは炎症細胞を動員し透過性を増し気道を収縮させ得る。最終作用は受容体と組織に依存し、合成類似薬と拮抗薬が産科、消化器、肺、血管、眼科で特定経路を利用する。

非ステロイド性抗炎症薬はシクロオキシゲナーゼを阻害しプロスタノイドを減らす。鎮痛・解熱は主にプロスタグランジン低下から生じ、抗炎症には一般に持続曝露を要する。同じ機序が胃粘膜防御を減らし、腎血行動態を変え、程度の異なる血小板障害を起こす。選択的阻害は一部胃腸傷害を減らし得るが血管血栓均衡を乱し得る。危険は用量、期間、年齢、腎機能、体液量、心血管疾患、抗凝固、併用薬で決まる。

糖質コルチコイドは遺伝子転写、白血球移動、サイトカイン、アラキドン酸放出・処理酵素を変え、さらに上流でメディエーターを抑える。広い有効性は感染防御、糖、骨、筋、皮膚、気分、眼、視床下部下垂体副腎抑制という広い生理負担を伴う。持続全身治療後の急な中止は副腎不全と炎症反跳を露出する。局所投与は全身作用を減らすが消さない。

ブラジキニンは血漿・組織のカリクレイン・キニン経路で作られ、主に内皮一酸化窒素とプロスタグランジンを介して血管拡張、透過性、疼痛、一部平滑筋作用を促す。アンジオテンシン変換酵素はアンジオテンシン二を作ると同時にブラジキニンを分解するため、阻害は収縮物質形成を減らしブラジキニンを増す。咳と稀な危険な腫脹は後者を反映する。特定腫脹疾患では受容体またはカリクレインも遮断できる。

一酸化窒素はアルギニンから合成酵素により作られる。内皮のカルシウム依存産生は血管平滑筋の可溶性グアニル酸シクラーゼを活性化し、環状GMPを増して弛緩させる。神経性一酸化窒素は伝達物質となり、誘導性高出力産生は宿主防御と炎症性血管拡張に関与する。有機硝酸薬は関連信号を与え、ホスホジエステラーゼ阻害薬は環状GMP分解を遅らせ、グアニル酸シクラーゼ刺激薬は経路を増強する。強い入力の併用は高度低血圧を起こし得る。

持続硝酸薬曝露への耐性には複数の血管・全身適応が関与し、適切な適応では低曝露時間を設けると反応性が戻る。一酸化窒素はヘモグロビンと酸化物に速やかに不活化され多くの作用が局所に限られる。酸化ストレス下では反応性窒素種を作り傷害へ寄与する。同じ小分子が濃度と化学環境により、生理的内皮制御、薬理的血管拡張、抗微生物防御、病的傷害を支える。

神経筋・メディエーター薬理の共通教訓は、標的名と同じく解剖部位と時間が重要ということである。運動終板遮断は意識を失わせず麻痺を起こし、ヒスタミン遮断は掻痒を軽減しても全アナフィラキシーを治療せず、シクロオキシゲナーゼ阻害は疼痛を減らしながら腎胃保護を除き、一酸化窒素増強は望ましい血管とともに全身圧を下げる。安全使用には生理回路全体と、同じ介入が他に何を除去・増幅するかを予測する。

# 第99章：学習、発達、認知、ストレス、行動変容

## TTSモジュール1：学習、記憶、その生物学的基盤

学習は経験により知識、行動、反応傾向が比較的持続して変わることである。記憶は情報を符号化、保存、安定化、検索する過程群であり、単一能力ではない。練習場面を思い出せなくても運動技能を獲得し、顔を認識しても名前を言えず、事実を覚えても有効に使えないことがある。したがって臨床評価は、すべての失敗を記憶喪失とせず、感覚入力、注意、符号化、保持、検索、言語、動機、遂行を分ける。

馴化は反復する無害刺激への反応低下、感作は強い重要刺激後の反応性増加である。これら非連合学習は神経系が重要性を継続推定することを示す。馴化は感覚疲労ではなく、時間や新奇刺激で反応が戻り得る。感作は元の手掛かりを越えて一般化し、脅威後の疼痛、警戒、驚愕亢進へ寄与する。シナプスの伝達物質放出と興奮性変化が短期変化を、遺伝子発現と構造再編が長期持続を支える。

古典的条件付けでは、以前は中性だった手掛かりが生物学的に重要な事象を予測し反応を引き起こす。獲得には単なる時間的対提示でなく随伴性、つまり手掛かりが結果情報を追加することが重要である。予期結果なしの反復提示で消去が進むが、通常は元の連合を消さず新しい抑制学習を作る。時間後の自然回復、別文脈での更新、結果再出現後の復元は古い記憶が利用可能なままと示す。

恐怖条件付けは感覚手掛かりと文脈を防御反応へ結び、扁桃体、海馬、前頭前野を含む回路が働く。扁桃体は脅威価値と自律・行動出力を、海馬は文脈と関係を表し、前頭前系は安全性と目標に応じ表出を調節する。独立した貯蔵箱でなく相互作用網である。曝露療法は予測誤差と抑制学習を用い、耐えられる関与、多様な安全文脈、恐れた結果が起こらないまたは対処可能と学ぶ機会が成功を支える。

オペラント条件付けは結果により行動を変える。強化は将来の行動確率を増し、罰は減らす。正は追加、負は除去を意味し、善悪ではない。逃避が不安を直ちに除くと負の強化が回避を維持し、回避は修正学習を妨げ長期障害を生む。即時で確実かつ価値ある結果は、遅れた抽象的結果より強く行動を形成する。

強化スケジュールは反応様式を変える。連続強化は速い獲得を支えるが、報酬停止後に消去しやすい。間欠強化、特に反応数や時期が予測不能な場合は行動を持続させ、確認、賭博、デジタル報酬の反復を説明する。シェイピングは目標へ近づく逐次行動を強化する。医療では達成可能な小段階が自己効力感を作る一方、能力を大きく超える要求は努力を罰し関与を減らし得る。

観察学習は他者を見ることで行動を獲得する。注意、保持、再現能力、動機が模倣を左右し、他者が報酬や害を受ける観察が期待を変える。臨床家、家族、仲間、メディアは健康行動をモデル化する。実演行動が学習者環境で実行可能で、フィードバックが情報を繰り返すだけでなく遂行を修正すると指導は有効になる。

作業記憶は限られた情報を一時保持・操作し、推論、理解、暗算、計画を支える。注意は競合入力から選択し、実行制御は目標を守り、内容更新と課題切替を行う。注意散漫、睡眠不足、疼痛、不安、中毒、急性疾患で容量は下がる。チャンク化は意味構造で負担を減らすが、専門家のチャンクは初心者へ自動移転しない。見かけの不遵守が反抗でなく認知過負荷の場合がある。

宣言的記憶には文脈内出来事のエピソード記憶と事実・概念の意味記憶がある。非宣言的記憶には技能、習慣、プライミング、条件反応がある。海馬系を中心とする内側側頭葉は新しい宣言的記憶形成に重要だが、全詳細の永久保管庫ではない。分散皮質系が長期表象を支え、大脳基底核と小脳回路が習慣、技能、時間、誤差適応へ寄与する。

注意を能動化し、精緻化、組織化、既知知識との結合、学習者による生成を行うと符号化が改善する。検索練習は受動的再読より後の想起を強め、時間を空けた学習は詰め込みより長期保持に優れる。関連問題を交互に扱うと識別が改善し得るが難しく感じる。再読の流暢感は親近感を高めても検索・応用能力を保証せず、学習度の悪い指標である。

固定化は符号化後の記憶を安定化する。シナプス固定化は受容体輸送、キナーゼ、遺伝子発現、蛋白合成により分から時間で進む。システム固定化は長期に神経網間依存を再編する。睡眠は海馬と皮質活動の協調変化を通じ記憶を支えるが、記憶型と睡眠段階で異なる。睡眠は注意と感情制御も回復するため、睡眠後改善は保存過程だけではない。

長期増強は特定活動後にシナプス効率が持続増加する現象で、記憶関連可塑性の一モデルである。多くの興奮性シナプスでは脱分極とグルタミン酸信号が一致するとN M D A受容体からカルシウムが入り、キナーゼとA M P A受容体挿入・修飾を起こす。強い反復活性は遺伝子発現と構造変化を誘導する。長期抑圧は選択シナプスを弱め、精緻化、柔軟性、飽和防止に同じく重要である。

可塑性は時間、神経調節、ネットワーク状態の規則に従う。ドパミンは予測誤差と動機的重要性を、アセチルコリンは注意と皮質学習を、ノルアドレナリンは覚醒と不確実性を示し得る。ストレスホルモンは中心的感情特徴の記憶を強めながら柔軟な文脈想起を損ない得る。慢性疼痛、依存、外傷性恐怖、不適応習慣も学習性ネットワーク変化を含み、最大可塑性でなく適切な学習が目標となる。

検索は再構成的である。手掛かりが分散表象の一部を再活性化し、現在の文脈、期待、感情、後からの情報が隙間を埋める。確信と正確性は不完全にしか相関しない。誘導質問と反復想像は想起を変え得る。再固定化は再活性化記憶が再安定化前に一時修正可能になる現象だが、境界条件があり、どの記憶も意図的に書き換えられるとは言えない。

忘却は減衰、干渉、検索失敗、適応的更新から生じる。順向干渉では古い学習が新しい学習を、逆向干渉では新しい内容が古い情報へのアクセスを妨げる。類似記憶ほど競合し、文脈を再現する検索手掛かりは助けになるが、一文脈への依存は転移を減らす。教育では例を変え、将来利用に似た条件で想起させる。

記憶障害は過程境界を示す。内側側頭系損傷は新規エピソード学習を重く損なっても、即時記憶範囲、遠隔知識、技能獲得を保ち得る。前頭機能障害は保存があっても方略、情報源監視、検索を損なう。せん妄は注意と認知全体を変動させ、記憶検査を不確かにする。抑うつ、不安、睡眠不足、聴覚障害、薬物、疼痛も符号化を下げるため、記憶訴えには一得点でなく病歴、機能、経過、診察が必要である。

知識が表面的特徴へ結び付くと学習転移は弱い。専門性は曝露だけでなく、組織化概念、反復検索、フィードバック、多様な応用で発達する。フィードバックは適時、具体的、制御可能な過程へ向けると有用である。心理的安全性と規則を説明する訂正があれば誤りは学習を促す。過剰な脅威は注意を狭め隠蔽を促し、学習と患者安全を損なう。

生物学的水準と行動水準は相補的である。シナプス可塑性は経験が回路を変える仕組みを、条件付けと認知理論は何がいつ学ばれ表出するかを記述する。どちらだけでも社会環境内の人間行動を予測できない。有効な医学学習と行動変容は、注意、意味ある予測誤差、反復検索、睡眠、フィードバック、動機、複数文脈で望ましい行動を練習する機会を整合させる。

## TTSモジュール2：生涯発達、認知、社会情動的成長

発達は遺伝子、成熟、経験、関係、文化、歴史条件が作る連続的変化である。硬直した普遍時刻表でも無限の可塑性でもない。技能は範囲内で現れ、先行能力の上に築かれ、複数の有効経路を取り得る。発達評価は領域ごとの能力、経時変化、利用可能だった機会、機能困難を問う。一つの遅い節目だけでは原因を決められず、獲得済み技能の喪失は単なる遅い獲得より通常懸念が大きい。

出生前脳発達には細胞増殖、移動、分化、軸索誘導、シナプス形成、選択的細胞死がある。出生後はシナプスが過剰形成され活動で精緻化され、髄鞘化とネットワーク専門化は数十年続く。感受性期は特定経験が特に強く作用する時期だが、常に絶対期限ではない。重い剥奪は発達を変えるが、後の豊かな経験で、時期、持続、系、個体生物学に応じ相当回復し得る。

乳児は独立調節前に養育者との相互作用で覚醒と苦痛を調節する。愛着は安全を求め、親しい養育者を安全基地として使う組織的様式であり、固定人格ラベルや親の愛の単純尺度ではない。養育者の利用可能性、乳児気質、ストレス、文化、文脈が観察行動を形作る。安全な関係は探索と苦痛回復を支え、非典型様式は意図的選択でなく不一貫または恐ろしい環境への適応を反映し得る。

気質は反応性、注意、活動、自己調節の早期個人差である。生物学的連続性を持つが経験で形作られる。適合性は環境期待と支援が子どもの様式に合う程度を表す。高反応性の子は予測不能環境で苦労しても、予告と穏やかな日課で成長できる。難しい気質というラベルは人と環境の相互作用を隠し、確率的傾向を運命として扱わせ得る。

運動発達は神経成熟、身体比率、筋力、感覚フィードバック、動機、練習機会に依存する。乳児は既定系列を実行するだけでなく、変化する身体・環境制約への安定解を発見する。新しい移動は見える物、届く物、社会的共有を変え、認知経験を変える。評価では運動遅延を孤立させず、視聴覚、筋緊張、左右差、疼痛、心肺持久力、文化的抱き方を考える。

言語は生物学的準備と社会学習から発達する。乳児は音声パターンを識別し、共同注意、会話交替、語と対象の対応、文法規則推定を行う。受容言語は一般に表出より先行し、共同注意と身振りが他者の焦点を物と語へ結ぶ。音声量だけでなく応答的で意味ある相互作用が重要で、聞き流しや受動メディアは同じ随伴フィードバックを与えない。多言語曝露自体は言語障害を起こさない。

概念発達は物、原因、心、数量、規則の表象を変える。幼児は親しい文脈で優れた推論をしながら、言語、抑制、特殊指示を要する課題で失敗し得る。段階理論は大きな質的変化を捉えるが、早期能力と変異を過小評価しやすい。知識は領域特異的で、親しい領域の専門性は年齢予測を越える推論を支える。発達は一様な上昇でなく、漸進蓄積、方略変化、時々の再編を組み合わせる。

実行機能には抑制、作業記憶更新、柔軟な切替、計画、監視がある。分散した前頭頭頂、皮質下、小脳網に依存し、児童期・青年期を通じ発達する。遂行は睡眠、ストレス、動機、課題経験、環境構造に強く影響される。静かな一対一では成功しても騒がしい教室で苦労し得る。日課、視覚手掛かり、小段階、即時フィードバックで実行要求を外在化できる。

心の理論は信念、欲求、知識、意図など他者の心的状態を表す能力で、言語、社会相互作用、実行制御、文化実践から発達する。誤信念課題合格は一節目で社会理解全体ではない。実際の社会認知は曖昧な手掛かり、過去、皮肉、自身の感情調節、解釈修正を統合する。神経発達的差異はこれらを変え得るが、共感や道徳的関心の欠如を意味しない。

道徳発達には感情、社会学習、推論、同一性、制度が関与する。子どもは結果と模倣で規範を学ぶが、多くの道徳的害と任意規約も区別する。推論は罰回避から互恵、社会秩序、権利、原理へ広がり得るが、文脈ごとに複数様式を使う。高度な道徳言語も、権力、集団忠誠、疲労、脅威、誘因が別方向へ引けば行動を保証しない。

青年期は思春期生物変化と、拡大する認知的、社会的、法的役割を組み合わせる。特に感情的な仲間文脈では、報酬・社会情動系が高反応となった後に調節系が成熟し得る。しかし青年が一様に非合理的なのではなく、穏やかな場では成人同様に推論し、速く学び、地域の誘因へ適応する。探索と危険行動は自立を支え得るが、強い報酬、監督不足、慢性ストレス、致死手段への容易な接近で有害となる。

同一性発達は価値、関与、社会役割、身体、文化、将来像を統合する。関与なしの探索と探索なしの関与はいずれも一時段階となり得る。性、ジェンダー、民族、障害、信仰、職業の中心性は文脈で変わる。支援的環境は強制や拒絶なしの探索を許す。苦痛は内的葛藤、対人害、差別、危険環境から生じ得て、同一性自体へ自動帰属してはならない。

成人発達には親密性、仕事、養育、次世代への貢献、獲得と喪失への適応がある。認知は一方向に動かない。処理速度と新規問題解決の一部は若年成人期から徐々に低下し得るが、知識、語彙、専門性は維持・増加し得る。方略、教育、健康、感覚、職業要求が軌道を形作る。横断的年齢差は加齢でなく世代歴を、縦断研究は選択的生存と反復検査を反映し得る。

正常認知加齢では検索が遅く分割注意へ弱くなるが、認知症は必然ではない。高齢者は知識、日課、外部補助、両側ネットワークで補償し得る。聴覚・視覚低下は認知障害に見え、真の認知負荷と社会孤立も増す。急性低下では評価までせん妄、疾患、薬物、可逆性障害を考える。独立機能を進行性に妨げる変化は正常加齢という安心だけで済ませない。

将来時間が短いと感じるにつれ社会情動的優先順位は変わり得る。高齢者は少数の感情的に重要な関係を選び、身体喪失があっても感情を有効に調節し得る。悲嘆は経過が多様な適応反応で、必須段階の系列に還元できない。死別は安堵、怒り、罪悪感、意味、継続的つながりと共存し得る。持続する重い機能障害や危険には対応するが、人と文化による表現差は正常である。

発達は入れ子状制度に埋め込まれる。家族資源、地域安全、教育、医療、法、差別、紛争、経済政策が神経系への日々の入力を形作る。慢性逆境はストレス生理と機会を変えるが、統計関連は結果を必然にしない。保護的関係、物質支援、予測可能な日課、共同体所属、利用可能なサービスは危険を緩衝する。レジリエンスの強調で有害制度への責任を耐える個人へ移してはならない。

発達分類は必要を説明し支援を開くと有用だが、完全な同一性として扱うと有害である。診断閾値は連続特性を分け、年齢、文化、要求、測定に影響される。マスキングや代償は大きな負担で困難を隠し、強みと障害は共存し得る。良い定式化はラベルだけでなく、本人のプロフィール、文脈、目標、必要な配慮を記述し変化へ開かれている。

生涯発達は確率的適応として最もよく理解できる。早期経験は後の機能を制約するが完全には決定しない。生物学が機会と脆弱性を作り、関係と制度が練習、安全、ストレスを配分する。臨床推論は集団期待だけでなく本人の軌道と比較し、差異と障害を分け、現在の人生段階で参加を改善できる修正可能障壁を見つける。

## TTSモジュール3：ストレス、動機、習慣、行動変容

ストレスは知覚された要求に対して適応を動員する過程である。ストレッサーは事象や条件、ストレスは生体の反応と解釈である。同じ事象も予測可能性、制御、資源、学習、社会的意味により脅威、挑戦、喪失、無関係として経験される。急性ストレスは注意とエネルギーを優先し生存と遂行を改善し得る。活性化が極端、反復、遷延、要求と不一致、または回復不足なら害となる。

迅速な反応には交感神経と副腎髄質が関与する。ノルアドレナリンは覚醒と血管緊張を変え、アドレナリンは心拍出、換気、糖利用、血流再配分を支える。より遅い視床下部下垂体副腎系は副腎皮質刺激ホルモン放出信号、同刺激ホルモン、コルチゾールを放出する。コルチゾールは基質を動員し免疫と記憶を変え、脳と下垂体へフィードバックする。日内律動と拍動性のため、一回測定は時刻と文脈なしに解釈しにくい。

アロスタシスは変化により安定を得ることで、心拍、血圧、代謝、警戒、免疫が予測需要へ調整される。アロスタティック負荷はメディエーターの反復活性化、停止失敗、非効率な代償による累積生理費用を表すが、普遍的標準臨床検査ではない。貧困、差別、危険労働、介護、慢性疾患、孤立、睡眠障害が持続要求を作るため、ストレスを個人の態度へ還元してはならない。

認知的評価が反応へ影響する。一次評価は何が危機にあるか、二次評価は選択肢と対処資源を問う。問題焦点型はストレッサーを、情動焦点型は情動反応を変え、意味焦点型は価値や目的へ位置付ける。普遍的優劣はない。制御可能問題には直接行動が、不能なら受容や情動調節が適応的になり得る。回避は短期安堵を与えても恐怖を維持し実際の問題を拡大し得る。

知覚制御はストレスを減らしやすいが、幻想的制御や責任追及を伴うと有害となる。予測可能性は準備を許す一方、避けられない有害事象の確実な予期は苦痛を延ばし得る。社会的支援は実務援助、情報、所属、承認、生理的緩衝を与える。接触数より質が重要で、本人の目標、私生活、文化、自律を無視する助言は資源でなく新たな要求となる。

動機は行動を開始、方向付け、維持する過程である。動因は生理状態、誘因は予想される外的結果、目標は表象された将来状態から生じる。ドパミンはどの手掛かりと行動が報酬を予測するかの学習へ寄与するが、単純な快楽物質ではない。欲求、快楽、努力、学習は分離できる。摂取の快楽が乏しくても手掛かりが強い動機的牽引を持つことがあり、依存と強迫行動に重要である。

期待価値理論では、行動は成功期待と結果価値に依存し費用で修正される。健康を重視しても失敗を予測し、変化可能と思っても努力、費用、副作用、スティグマ、不便を高すぎると判断し得る。危険情報は一要素しか変えない。有効な定式化は何が重要か、何が起こると予想するか、どの即時費用が遠い利益を上回るかを問う。

自己効力感は規定条件で特定行動を実行できるという確信である。成功練習、信頼できるモデル、有用な励まし、生理状態の解釈で育ち、一般的自尊心とは異なる。具体的で挑戦的な目標は達成可能でフィードバックがあれば努力を導く。健康になるという広い目標は方向を示しても実行動ではない。観察可能な段階へ分けると達成と修正の機会が生まれる。

自己決定理論は、選択され価値と一致する自律的動機と、圧力、恥、条件付き承認による統制的動機を区別する。有能感、自律性、関係性が持続関与を支える。外的報酬は開始に役立つが、統制と感じれば内発的関心を弱め得る。医療の情報に基づく選択は放置ではない。臨床家は根拠を説明し本人の優先へ計画を合わせながら、強く推奨しても主体性を保てる。

習慣は安定文脈での反復から得る手掛かり結合反応傾向である。熟慮負荷を減らし、結果価値が低下しても続き得る。目標が行動を始めても、同じ時と場所で繰り返すと環境手掛かりが制御する。その後は知識変更だけの効果が限られる。手掛かり、摩擦、順序、即時強化を変え、新行動を既存日課へ結び付けることで再設計できる。

実行意図は規定状況が起これば規定行動を行うという手掛かりと行動の連結である。遠い意図を検索可能な規則へ変え、障壁を予測すると特に有用である。行動計画は場所、時、方法を、対処計画は障壁時の対応を定める。疾患、介護、交代勤務、費用、変動能力へ適応できる柔軟性が必要である。

能力・機会・動機モデルでは、身体的心理的能力、社会的物質的機会、熟慮的自動的動機が揃うと行動が生じる。これは構造障壁を動機説明へ吸収するのを防ぐ。費用負担不能、利用不能、危険、身体的不可能、仕事と不適合な助言には従えない。訓練は能力不足、リマインダーは記憶不足、環境再設計は機会不足を助けるが、道徳的叱責や教育一つで全てを直せない。

段階モデルは現時点の意図なし、検討、準備、行動、維持への移動を記述し、準備性に支援を合わせることを促す。ただし人は常に順序通り進まず境界も不鮮明で、段階を診断のように使うと葛藤を単純化する。動機づけ面接は協働会話で混合動機を探索し、本人の変化理由を引き出し、反射的議論を避ける。自律を尊重しつつ現行動と価値目標の不一致へ注意を向ける。

危険知覚は数値確率だけで決まらず、即時性、鮮明さ、恐怖、親近性、制御感、信頼に反応する。基礎リスクなしの相対危険は利益や害を誇張し、微小確率は無視または過大評価され得る。同じ分母、関連期間、均衡した結果の絶対頻度が理解を改善する。情動的意味も重要で、本人の言葉で選択を説明してもらい理解を確認する。

行動経済学はデフォルト、現在偏重、損失回避、社会規範、有限注意の予測可能な影響を示す。デフォルトは一選択肢を容易にして利用を増やすが、倫理的利用には透明性、容易な拒否、制度都合でなく福祉との整合が必要である。誘因は遅い健康利益への即時強化に有用だが、資源が乏しいと強制的になり得る。ナッジは代替を隠さず、真の障壁除去を置換してはならない。

再発は古い手掛かり反応経路、報酬、ストレッサー、社会文脈が残るため多い。道徳的失敗でなく計画と環境についての情報である。一回の逸脱を完全放棄へしないため、迅速な見直し、自己への思いやり、具体的再開を行う。行動自体が報酬的で同一性と一致し、社会的に支えられ、日課中断へ耐えると維持しやすい。目標と状況が変わるため定期見直しが必要である。

ストレスと行動は双方向に作用する。ストレスは注意を即時安堵へ狭め、作業記憶を下げ、睡眠を乱し、習慣反応を強める。活動、規則的睡眠機会、社会接触、物質使用、回避、援助希求は後のストレスを変える。生活行動だけで構造的逆境を除き疾患を治せると約束してはならないが、適切な医学・社会支援内の小変化は機能と主体性を改善し得る。

行動変容介入は機序と結果を明示する。知識、自信、接近性、行動頻度、バイオマーカー、症状、長期健康の何を改善したかを問う。関与自体は利益でなく短期遵守も持続を保証しない。スティグマ、監視、機会費用、格差拡大を含む不平等負担と意図しない影響を監視する。当事者との共同設計は理論が見逃す実際の制約を示す。

実践的統合では人格をラベル付けせず行動を分析する。行動と文脈を定義し、能力と機会を同定し、予想報酬と費用を理解し、手掛かりと結果を地図化し、ストレスと回復を評価する。次に機序へ合う最小介入を選び、効果を測り、修正する。実行可能で意味があり、支援環境で反復され、中断後に回復できる変化ほど持続しやすい。

# 第100章：社会心理学、コミュニケーション、文化、健康行動

## TTSモジュール1：社会的認知、同一性、影響、集団

社会心理学は、現実、想像、暗黙の他者が思考、感情、行動をどう形作るかを研究する。医療判断は純粋な個人計算ではない。患者は家族と文化の期待から症状を解釈し、臨床家はチームと階層内で働き、制度がどの行動を容易、報酬的、可視、禁止にするかを定める。社会過程は診療を調整し所属を与えるが、偏見、異論抑制、害の不均等も生む。社会影響の理解は非合理性を意味せず、危険、信頼、許容行動について不可欠な証拠でもある。

社会的知覚は迅速な分類から始まる。顔、声、衣服、役割、文脈が期待を活性化し注意と解釈を導く。分類は認知負荷を減らすが群内変異を隠す。ステレオタイプは集団への信念、偏見は評価的態度、差別は不平等な処遇を作る行動または制度実践であり、別々に起こり得る。明示的に偏見を否定しても、学習した連合や組織慣行が不均等な判断を生み得る。

帰属は行動原因の説明である。観察者は特に状況制約が見えないと、安定した個人特性を過大評価し状況を過小評価しやすい。行為者は自身の事情へ接近でき、同じ行動を仕事量、恐怖、限られた選択で説明し得る。医療では受診欠席が無責任とされても、交通、交代勤務、障害、育児、費用、過去の不当処遇が原因かもしれない。有用な定式化は個人と環境の両説明を検証する。

帰属は結果知識にも影響される。診断や有害事象を知ると以前の曖昧な徴候が明白に見える後知恵バイアスが予測可能性を誇張する。公正世界傾向は世界の秩序感を守るため、人が結果に値したと仮定し、疾患や外傷を本人行動のせいにし得る。自己奉仕的帰属は成功を能力、失敗を状況へ帰すが、抑うつ、恥、周縁化で逆転する場合もある。

態度には認知的信念、情動評価、行動傾向があるが、具体的、利用可能、安定し状況に関係するとき行動をよく予測する。運動一般への賛成は危険な天候で今日歩くことを保証しない。行動も態度を変える。自己概念と矛盾した行動は認知的不協和を生み、行動や信念の変更、正当化追加、情報回避で軽減される。強制的公開関与は真の合意でなく抵抗を固定し得る。

説得は発信者、メッセージ、受け手、媒体、文脈に依存する。動機と能力が高ければ証拠を慎重処理し、注意が限られれば専門性、親近性、感情、社会的支持などの手掛かりを使う。どちらも適応的になり得る。信頼性には能力と誠実性の知覚が必要で、利益相反は両方を損なう。脅威だけを強調し有効で実行可能な反応を示さない恐怖メッセージは、防御的回避を起こしやすい。

社会規範は他者の行動または承認の知覚である。記述的規範は他者が何をするか、命令的規範は何を是認するかを示す。有害行動が普遍的という誇張を修正すると減らせる。しかし不正の高頻度を広報すると、価値ある基準を併記しない限り正常化し得る。規範は参照集団特異的で、社会全体より信頼する仲間の行動が重要なことが多い。

同調は他者を証拠とする情報的影響、または所属を守り拒絶を避ける規範的影響から生じる。不確実性、全会一致、公開回答、集団重要性が強める。一人の目に見える異論者は、自分と違う答えでも全会一致を壊し圧力を減らす。臨床チームでは議論前に独立評価を求めると、上位者の見解への早期アンカリングを減らせる。

応諾は依頼への反応、服従は権威命令への反応である。小さな初期関与は後の一貫性を増し、大きすぎる依頼後の小依頼は合理的に見え、希少性と返報性も判断へ影響する。技法自体は必ずしも欺瞞でないが、知識と権力の非対称性により医療利用は倫理的に敏感である。社会圧力で肯定を得るだけでは同意にならない。

権威は専門性と責任を調整する一方、責任が上へ移り、作業が断片化され、異論が不忠に見えると有害行動を容易にする。専門職も免れない。明確なエスカレーション、段階的主張、閉ループ連絡、懸念提起へ感謝する指導者が安全異議を実行可能にする。形式的に発言を許しても社会的に罰する文化は問題を解決していない。

集団同一性は意味、相互援助、期待を与える。人は自己と他者を内集団・外集団へ分け、任意区分でも内集団を優遇しやすい。脅威、競争、不平等な地位が境界を強める。集団間接触は、意味ある協力、支援された平等、制度的裏付けがあると偏見を減らし得るが、敵対条件の近接は強化し得る。個人は交差する複数同一性を持ち、一分類だけで経験を完全に予測できない。

没個性化では匿名性、覚醒、集団没入、説明責任低下が行動を顕著な局所規範へ寄せる。必ず攻撃性を生むのでなく、向社会的規範も強まり得る。多数の傍観者が他者の行動を期待すると責任分散で援助が減る。個人へ明確に仕事を割り当てれば曖昧さを減らせる。緊急時には不特定群へ呼ぶより、名指しで連絡を依頼する方が有効である。

集団極性化は議論後に初期傾向がより極端になる現象で、共有方向を支持する論拠を多く聞き、集団規範と自己を比較するため起こる。集団思考は圧力下の凝集集団で疑問抑制、代替不足、合意幻想が起こる欠陥判断過程である。凝集性自体でなく、指示的指導、隔離、同質性、方法不足が危険を作る。構造化異論と独立審査は対人敵意なしに判断を改善する。

集団知性は最も賢い一人より、情報共有、発言交替、心理的安全性、課題専門性に依存する。集団は全員が知る情報を議論し、固有情報を言わない傾向がある。共有情報バイアスにより会議が合意的に感じても決定的事実を逃し得る。各人へ何が計画を変えるかを問い、未解決異論を記録すると隠れた情報が表れやすい。

社会的手抜きは個人寄与が識別不能なときの努力低下、協調損失は有能な個人が互いを妨げる現象である。明確な役割と可視的相互依存が減らす。競争は単純課題の努力を高めても、学習、率直さ、援助希求を抑え得る。医療チームには共有目標と役割明確化が必要だが、誤りを捕捉する重複も必要である。全重複除去は見かけの効率を上げても回復力を壊す。

権力は結果、資源、注意、規範を形成する能力で、専門性、地位、報酬、強制、関係、情報統制から生じる。高権力者は多く話し賛同され、制約へ気付きにくく、低権力者は他者を注意深く監視し対立リスクを負う。患者の見かけの合意は選好でなく依存を反映し得る。臨床家は質問の私的機会を作り、拒否を実際に安全にする。

向社会的行動は共感、同一性、規範、費用、返報性、有効感に影響される。共感的関心は援助を動機付けるが、自分の不快へ集中する苦痛は撤退を促し得る。苦痛への反復曝露が機械的に思いやりを消すわけではなく、疲労、道徳的苦悩、資源不足、防御的対処は別機序である。臨床家へ強靱性を説くより、組織支援、管理可能要求、仲間とのつながり、有効感が重要である。

葛藤には課題、工程、価値、同一性、関係についてのものがある。心理的安全性と共有目的が強ければ課題異論は推論を改善するが、個人的軽蔑は協力を損なう。交渉は立場と根底の利益を分け、可能なら複数利益を満たす案を探す。真の希少性や両立不能価値による葛藤は単純な相互利益へ変えられない。全員が希望を得られないときも公正手続き、透明性、審査が重要である。

社会的認知は文脈依存で確率的である。バイアスは他人だけの欠陥でなく、教育だけで消えない。よりよい環境は高リスク判断を遅くし、基礎率を示し、独立見解を招き、理由を記録し、集団別転帰を監査する。医療から社会影響を除くのでなく、有益な影響を可視化し説明可能にし、同調、階層、分類、権力が密かに診療を決めるのを制限する。

## TTSモジュール2：文化、言語、スティグマ、臨床コミュニケーション

文化は経験を解釈するための学習された意味、実践、関係、制度の動的集合であり、民族へ固定された特性表ではない。人は家族、言語、宗教、職業、世代、移住、障害、性、階級、場所が形作る複数文化に参加し、同一化は文脈で変わる。文化的謙虚さとは、他集団を習得したと主張せず、持続する好奇心、自己省察、権力への注意、誤解を修復する意思を持つことである。

病いは症状と生活破綻の本人経験、疾患は変化した生物学についての専門的説明であり、重なるが同一ではない。患者と臨床家は原因、時期、重症度、身体機序、適切な治療、予想転帰について異なる説明モデルを持ち得る。問題を何と呼ぶか、何を恐れるか、なぜ始まったと思うか、どんな援助を期待するかを尋ねれば、一方を非合理と仮定せず臨床的情報を得られる。

伝統的、補完的、宗教的、生物医学的実践は共存し得る。祈り、食事規則、薬草、家族助言、処方薬を別目的で使う場合がある。否定すれば実践が隠れ相互作用を見逃し、無批判な容認は毒性や有効治療遅延を見逃す。何を、どう調製し、誰が勧め、何を期待し、治療と調整する意思があるかを敬意をもって尋ねる。敬意は人へ向け、事実主張は証拠に開く。

構造的能力は対人文化から健康を作る制度へ注意を広げる。住宅、移民規則、警察、教育、労働条件、交通、食料制度、環境曝露、医療接近性が利用可能な選択を形作る。臨床家一人で全構造を直せないが、制約行動を選好と誤認せず、障壁を記録し、資源へつなぎ、計画を適応し、制度改善を支援できる。文化説明で物質的剥奪や差別を隠してはならない。

言語不一致は診断精度、同意、安全、信頼を変える。訓練通訳者は内容と語用的意味を伝え、発言交替を管理し、話者が会話を所有したまま曖昧さを明確化する。家族は重要な支援を提供し得るが、情報を選別し、葛藤を持ち、敏感な話題に不適切なことがある。重大医療情報の通訳責任を子どもに負わせない。自動翻訳は限定課題を助けるが、ニュアンス、私生活、危険が大きい場では注意する。

通訳利用時は患者へ向き一人称で話し、処理可能な区切りで止まり、横の会話を避ける。専門用語を予測できる文脈を通訳者へ与え、不確実性を明示する。翻訳発話が長いことは不正確さの証拠でなく、概念には単語置換以上の説明が必要なことがある。記録には通訳関与と方法を残し、通訳者を同意者として扱わない。

ヘルスリテラシーは特定課題と制度内で健康情報を探し、理解し、評価し、使う能力であり、関係的である。高学歴者も恐怖、疾患、疼痛、慣れない言語、不透明な書式で苦労する。普遍的予防策は誰もが平易な説明から利益を得ると仮定し、非公式識字試験で人を選別し恥を与えるのを防ぐ。平易な言葉は必要な精度を保ちながら不要な複雑さを減らす。

少数の実行可能な要点を優先し、未知語を説明し、数値を判断へつなぎ、必要なら図や実演を使う。ティーチバックでは本人の言葉で計画を説明してもらい、知能でなく臨床家の説明を検査する。中立的な依頼は修復を安全にする。機器、注射、創傷処置、緊急行動には再実演が有用で、文書は対話を置換せず補強する。

非言語連絡には視線、表情、姿勢、距離、接触、沈黙、速度、声調がある。意味は人と文化で異なり、一徴候を過剰解釈しない。視線回避は欺瞞でなく、敬意、不安、疼痛、神経発達様式、外傷、視覚障害を反映し得る。言葉と感情の不一致を観察しても開かれた確認を行う。同じ高さに座り中断を減らすと大きな時間追加なしに注意を伝えられる。

スティグマは属性を社会的に信用を損なうものとして印付けし、ラベル、ステレオタイプ、分離、地位喪失、権力差下の差別を通じ働く。公的、予期、経験、内面化された形があり、精神疾患、感染、体重、物質使用、障害、貧困、性などへ付く。判断予期は受診を遅らせ開示を減らす。人を診断名や道徳分類へ変える臨床言語は、侮辱意図なしにも再生産し得る。

人を先に置く言葉と同一性を先に置く言葉の好みは異なる。病気を持つ人を好む者も、価値ある共同体として同一性を名乗る者もいる。可能なら尋ね本人の言葉に従い、責任や汚染を示唆する語を避ける。語彙だけより、自律を尊重し、アクセスを与え、低品質治療を避けることが重要である。丁寧な言葉は差別的判断を補償できない。

暗黙バイアスは意図的支持なしに知覚や行動へ影響し得る連合である。疼痛評価、信頼性、診断閾値、会話、紹介へ作用し得る。工程が無検証裁量を許し歴史的不平等を符号化したままなら、個人意識研修の効果は限られる。標準化された根拠基準、性能を監査する支援、多様なチーム、十分な時間、集団別転帰監視が機会を減らす。アルゴリズムも偏ったデータと代理変数で格差を自動化し得る。

トラウマインフォームドケアは過去・現在の外傷が安全、信頼、身体反応、制御を形作り得ると認識し、全患者へ開示を求めない。予測可能性、接触前説明、意味ある選択、私生活、協働、中断許可が不要な脅威を減らす。困難に見える行動が制御喪失への保護反応かもしれない。明確な境界と緊急行動とも両立し、必要性を説明し可能になれば選択を戻す。

開放質問は物語を招き、焦点化閉鎖質問は詳細を明確化する。反映的傾聴は言葉を繰り返すだけでなく意味と感情を確認し、要約は説明を整理して訂正機会を与える。早すぎる中断は優先事項が現れる前に病歴を変えるが、完全な非構造化面接は安全情報を逃し得る。熟練した会話は開放探索と焦点検証を意図的に移動し、その移行を明示する。

共感は他者視点と感情を理解しようとする正確な努力を伝えることで、同じ感情を経験したり全解釈へ同意する必要はない。感情の名付けは仮説として訂正を許す。妥当化は事実誤認を確認せず、文脈上理解可能と認める。理解前の安心は軽視と感じられ得る。現実的安心は既知事項、行うこと、不確実性の管理を示す。

悪い知らせは予想未来を大きく変える情報である。私的空間、十分な時間、希望する支援者、現在事実を準備する。理解状況と希望する詳細量を確認し、困難な情報の予告後に直接的に伝え、止まり、感情へ応答し、次段階を話す。婉曲表現は混乱させ、衝撃直後の過剰詳細は保持されない。追跡で情報を再訪できる。

葛藤は単純な会話欠陥でなく、満たされない必要、恐怖、不一致情報、過去の害、両立不能目標を反映し得る。鎮静化は穏やかな速度、空間、敬意、明確な限界、可能な選択で即時脅威を下げる。暴力切迫時は安全を優先する。安定後は全非難を議論するより根底懸念を同定する。謝罪は害と責任を認め得るが、認識前の防御的技術説明は葛藤を強めやすい。

守秘は開示を支えるが、限界を暗黙にせず説明する。家族が答える、ポータルアクセスが共有される、混雑場で相談すると私生活が損なわれ得る。敏感な質問は正常化して可能なら私的に行う。共通文化背景が信頼を保証せず、小共同体では特定への恐れが増す。通信制度も臨床家の約束と同じく情報を守らねばならない。

有効なコミュニケーションは診断後に加える装飾的対人技能ではない。得られるデータ、症状解釈、同意の妥当性、治療実行可能性、害の検出を変える。文化的謙虚さ、言語アクセス、構造認識、スティグマ低減、明瞭な対話は臨床説明を正確にし認識の質を高める。最終的には尊厳と本人の人生への正当な権限を守りながら、安全に行動できる十分な共通理解があるかを問う。

## TTSモジュール3：アドヒアランス、プラセボとノセボ、リスク、同意、共同意思決定

アドヒアランスは服薬や健康行動が合意計画と一致する程度を表す。協働を保つならコンプライアンスより望ましいが、用語だけで敬意は保証されない。計画は無効、高価、複雑、負担、文化的不適合、身体的困難、本人目標との不一致で失敗する。具体的行動と理由を同定せず非アドヒアランスと呼ぶと、結果を性格判断へ変え有用な介入を妨げる。

治療実行には開始、実施、持続の段階がある。処方を受けても開始せず、不規則に使い、正しく使った後に中止し、または症状に応じ意図的調整をする場合がある。各様式の原因と解決は異なる。薬局補充データは所持を推定して服用を示さず、電子容器は開封を記録して嚥下を示さない。自己報告は正直な開示が安全なときに有用である。

非意図的困難には失念、誤解、巧緻・感覚障害、複雑な時刻、日課中断、アクセス失敗がある。意図的非使用は副作用、必要性の低い知覚、依存恐怖、不信、スティグマ、競合優先、合理的選好を反映し得る。両者は重なり、供給への反復挫折が価値信念を変え、混乱計画が後に意図的拒否となり得る。完全服用の確認を迫るより、飲み忘れ頻度を正常化して尋ねる方が情報を得やすい。

投与設計自体が臨床介入である。頻度を減らし安定日課へ合わせ、不要薬を除き、操作可能な包装・機器を提供し、供給を整え、飲み忘れ時の対応を明確化すると実施が改善する。リマインダーは展望記憶失敗を助けるが、副作用や費用を直さない。監視を懲罰的にしてはならない。目標は制度が作る複雑さへの服従でなく、最小負担で確実な利益を得ることである。

プラセボ効果は、研究対象の特異的活性成分でなく、意味、期待、学習、治療文脈に帰属する変化である。主観症状、自律機能、内分泌反応、運動遂行、一部生理を変え得るが、疾患が想像上という意味ではない。期待、条件付け、注意、不安軽減、臨床家との相互作用、自然変動が寄与する。試験のプラセボ反応には自然変化、平均への回帰、測定、報告も含まれ、真の文脈効果より広い。

ノセボ効果は否定的期待と文脈により形作られる有害症状や悪化である。正確な警告は検出と選択を改善するが、警戒的枠付けは苦痛と症状帰属を増幅し得る。倫理的説明は重大リスクを隠さず、頻度と重症度を中立的に示し、一般的な一過性作用と緊急危険を分け、取るべき行動を説明する。影響割合と非影響割合の両方を示す正負枠付けは数値を操作しない。

オープンラベル・プラセボ研究は、活性成分がないと知っても一部条件で文脈効果が起こり得ることを示すが、条件特異的で日常的な欺瞞治療を正当化しない。欺瞞は信頼と有効同意を損なう。明瞭な根拠、証拠に比例した確信、共感的注意、一貫した計画、追跡により倫理的に文脈治癒を強められる。これらは診断とアドヒアランスも改善し、単なるプラセボとして軽視できない。

リスク説明では結果、集団、期間、比較対象を定める。これらなしの確率は曖昧である。相対リスクは比、絶対リスク差はパーセントポイント変化、治療必要数・有害必要数は規定期間の絶対差の逆数である。同じ相対効果も基礎リスクにより絶対利益が異なるため、必要数は薬の固定特性でなく、不確実性と期間を伴う。

自然頻度は条件付き確率を理解しやすくする。一千人中何人と示す方が孤立した百分率より明瞭なことがある。一貫した分母は比較を助け、一割と千人中五人の切替は不要な作業を作る。アイコン配列も視覚的に助けるが、色、順序、分母が知覚へ影響する。稀などの言語ラベルは解釈が不一致なので、判断が大きさに依存すれば数値を添える。

数学的に同じ情報でも枠付けで選択が変わる。生存表現は死亡表現より好ましく感じ、獲得と損失は心理的に非対称である。可能なら両方を示し、利益を相対、害を絶対で示すような不均衡を避ける。精度は証拠へ合わせる。不確かな推定を多桁表示すると偽の確実性を作り、説明なしの広い範囲も役立たない。不確実性が判断へ何を意味するかを示す。

共同意思決定は、判断が必要と認識し、証拠と個人優先を交換し、熟慮し、方針へ合意または延期する過程である。選択肢の期待転帰が似て負担が異なる、または転帰価値が人により違うと特に重要である。案内なしのメニュー提示ではない。臨床専門性は医学的に合理的な選択と証拠を定め、患者は価値、生活事情、許容できる交換条件への権限を持つ。

時間切迫または一選択肢が明らかに優れる判断もある。説明、同意、適応は可能なので共同性は残るが、選好依存の待機的選択とは形が違う。理由と不確実性を明瞭にし拒否を罰しなければ強い推奨と自律は両立する。逆に理解も利用もできない選択を患者に迫れば、権力共有でなく負担移転となる。

意思決定支援は選択肢、確率、価値明確化を標準形で示す。個別予後、識字、感情、実行可能性の解釈が必要なので会話を置換しない。高品質支援は最新証拠、均衡提示、作成者と利益相反、更新日を示す。情報量が多いほど良いとは限らず、判断品質は全技術詳細の記憶でなく、情報に基づき価値と一致した選択である。

意思決定能力は特定の判断と時点に依存し、関連情報の理解、本人への適用の認識、選択肢間の推論、意思表明を一般に要する。診断、年齢、障害、異論、珍しい判断だけでは決まらない。せん妄、中毒、疼痛、恐怖、薬物、通信障壁で変動する。能力欠如と結論する前に支援、通訳、感覚補助、単純説明、可逆性障害治療を試す。

結果と複雑性が大きいほど評価閾値を厳しくし得るが、臨床家へ同意する者だけが能力を持つという意味ではない。推論は専門職優先と違っても価値に基づき得る。能力がなければ代理人は可能な限り既知の本人価値と過去希望を用い、なければ最善利益を用いる。本人も可能な程度まで参加し、制限は必要以上に広く長くしない。

有効な説明同意には関連情報開示、理解、自発性、能力、肯定的判断が必要で、署名書は過程の証拠であって過程自体ではない。重要情報には目的、期待利益、主要リスク、合理的代替、該当すれば無介入がある。何が重要かは合理的人の関心と本人が表明した懸念に依存する。同意は撤回でき、一介入への合意が別介入を意味しない。

緊急治療は、即時行動が必要で能力がなく、認可代理人や適用される拒否を時間内に得られない場合、法と文脈に従い事前同意なしに行える。この例外は狭く、便宜、時間圧、異論予測は緊急事態ではない。事前指示と記録された目標は現在通信不能時も自律を保つ。不確実なら臨床、倫理、法的問いを分け適切な支援を求める。

信頼は判断の入力であり結果でもある。能力、誠実、確実性、配慮、利益の整合に依存し、盲目的受容を要求しない。信頼に値する実践は質問を歓迎し、不確実性と利益相反を明かし、誤りを訂正し、約束を実行する。歴史的・現在の不当処遇があれば懐疑は合理的である。信頼再建には影響集団へ信頼を要求するのでなく、行動変化と説明可能な制度が必要である。

統合的方法は判断とその後必要な行動を定義する。本人の理解、価値、制約、過去経験、希望役割を引き出す。比較可能な絶対リスクと不確実性で選択肢を示し、比例した推奨を行い、理解を確認し、実行可能な計画を作る。その後転帰を追い選択を再検討する。同意記録や処方だけでは成功でなく、情報に基づき、自発的で、実行可能で、その後の事実へ応答する選択が成功である。

# 第101章：生物医学・臨床科学の定量的生物統計学

## TTSモジュール1：変数、分布、標本抽出、推定

### 医学部入学前の基礎：計算より先に量を区別する

独自の希釈例を考えよう。原液の濃度が1リットルあたり2ミリモルで、その5ミリリットルを容器に取り、最終体積が20ミリリットルになるまで溶媒を加える。反応や損失がなければ、移した溶質の物質量は保存される。最終濃度は2に5を掛けて20で割り、1リットルあたり0.5ミリモルとなる。20ミリリットルは最終体積であって、加えた溶媒の量ではない。二つの体積は同じ単位なので、その比には単位がない。この推論では濃度、物質量、体積を混同せずに結び付ける。

次に、実験で測った応答が任意単位で20から30へ増えたとする。絶対増加は10単位、相対増加は10を20で割った50パーセントである。逆に30から20へ戻る変化は、基準値が変わるので50パーセントではなく3分の1の減少となる。割合を計算する前に、その分母が何かを明示しよう。どちらの割合だけでも、結果の再現性や因果関係は判断できない。それらの結論には研究設計と不確実性についての情報が必要である。

生物統計学は確率を用い、変動する観察から集団と機序について不確かな結論を導く。不完全データを確実性へ変えるものではない。すべての解析は集団、標本抽出、変数、時点、目的量の定義から始まる。適格性、測定、追跡が対象と違えば、数学的に正しい計算も誤った問いへ答える。したがって統計推論は研究設計と生物学的解釈から分離できない。

変数はカテゴリまたは数量である。名義カテゴリに固有順序はなく、順序カテゴリには順序があるが間隔が等しいとは限らない。数量変数は離散的計数または連続測定となる。この区別は要約を導くが機械的に決めない。零から十の疼痛尺度は順序を持ち数値解析されやすいが、一単位差の意味が全範囲・全個人で同じとは限らない。

測定は操作的定義を作る。正確度は意図する真値への近さ、精密度は反復性、信頼性は一貫性、妥当性は目的構成概念を表す程度である。ランダム誤差は変動を増し通常は関連を弱める。系統誤差は値をずらす、または群で異なり関連を作り隠し得る。追跡可能標準への校正は一部誤差を扱うが、主観構成概念には内容、構造、転帰との関係の証拠も必要である。

分布は値の並び方を表す。中心は平均、中央値、最頻値で要約できる。算術平均は全値を使い極値へ敏感、中央値は中央を示し歪みに強く、最頻値は最も多い値で複数または無意味なことがある。散らばりは範囲、四分位範囲、分散、標準偏差で表す。中心だけでは異質性を、散らばりだけでは値の位置を隠す。

正規分布は平均と標準偏差で決まる対称釣鐘形である。選択集団の多くの生物変数は近似正規だが、混合集団、検出限界、疾患亜群が歪みや複数峰を作る。正規モデルは目的により正当化する近似で、自然への既定主張ではない。対数変換は乗法的変動を対称化し得て、逆変換後の要約は加法差でなく比として解釈する。

z得点は観察値が参照平均から標準偏差何個分離れるかを示し、適切な参照分布なら尺度間比較を可能にする。病的確率を示すものではない。統計的に稀でも健康で、一般的でも特定患者には危険な値がある。基準範囲は定義参照集団の中央割合を含むため、健康者の一部は外れ、疾患者の一部は入る。

二項分布は共通確率を持つ固定回数の独立試行で成功数を表し、平均は試行数と事象確率の積である。ポアソン分布は事象がほぼ一定率で独立に起こるとき、時間、面積、曝露当たり計数を表し、単純モデルでは平均と分散が等しい。生物学的計数には過分散や集積が多く、単純ポアソンへ強制せず拡張を用いる。

確率は零から一で、補集合、和、積、条件付き事象の規則に従う。独立とは一事象を知っても他の確率が変わらないこと、相互排他とは同時に起こらないことであり同じではない。ベイズ則は事前確率を観察証拠の尤度で更新する。診断検査では事後確率が感度・特異度だけでなく検査前確率に依存する。

母集団は推論対象の全集合、標本は観察部分である。無作為抽出は各適格単位へ既知の選択確率を与え、集団一般化を支える。便宜標本も機序を示し得るが対象と系統的に違い得る。実験の無作為割付は別概念で、研究内群の因果比較を支える。無作為割付は参加者を代表的にせず、無作為抽出だけで曝露交絡は除けない。

標本変動により有効な別標本から異なる推定値が出る。標本分布は同じ過程から反復標本を取ったときの推定量分布で、その標準偏差が標準誤差である。標準偏差は個人間変動、標準誤差は推定不確実性を示す。標本数増加で標準誤差は概ね平方根に反比例するため、不確実性を半分にするには約四倍の独立観察が必要である。

中心極限定理は広い条件下で、独立寄与が蓄積すると適切に標準化した平均の標本分布が正規へ近づくことを示す。必要標本数は歪み、裾、依存、推定量で異なる。元データを正規化せず、バイアスから守らない。診療所内患者や同一人の反復測定など集積観察は、同数の無関係観察より独立情報が少ない。

点推定は母数の一つの妥当値、区間推定は不確実性を表す。頻度論的九十五パーセント信頼区間は、モデル仮定下の反復標本で真値を九十五パーセント含む手順が作る。一つの実現区間では母数は固定でランダム移動しない。仮定、設計、モデルを忘れなければ、妥当値範囲という非形式的表現は有用である。

信頼区間幅は標本数、変動、信頼水準、設計を反映する。偏った推定周囲の狭い区間も誤解を招く。非応答、測定誤差、選択的脱落、モデル誤指定、未認識集積は名目区間に表れないことがある。したがって区間は設計評価を補うが置換しない。帰無値をまたぐ区間は効果なしを証明せず、臨床的に重要な利益と害を含むデータ・モデル適合値を示す。

ベイズ推論は事前分布を定め、尤度と結合して事後分布を得る。事後分布はモデルとデータを条件に母数値の確率を直接述べられる。事前分布は既存証拠、専門知識、弱い正則化、懐疑性を表し得る。感度解析で争点となる事前分布への結論依存を示す。ベイズ法も仮定を消さず、一部を明示し不確実性を一貫して伝播する。

推定量はバイアス、分散、一致性、頑健性で評価できる。バイアスは反復標本で目的値から平均的にずれる程度である。低バイアス高分散は不安定で、小さなバイアスが全体予測誤差を減らすこともある。頑健推定は外れ値や仮定違反へ強い。目的から独立した最良推定量はない。平均、中央値、因果効果、個人予測は同じ観察を使っても別課題である。

再標本法は観察データから標本不確実性を近似する。ブートストラップは復元抽出を反復し統計量を再計算し、解析式が難しいときに有用である。経験標本が関連分布を表すと仮定し、集積や依存を適切に保存する必要がある。置換法は帰無交換可能性の下でラベルを並べ替える。どちらも選択バイアスを直さず、標本にない情報を作れない。

標本数計画は目的効果、変動、許容誤差、事象頻度、設計、予想欠測を結ぶ。小さすぎれば有用推定ができず、大きすぎれば些細な差が統計的に精密になる。可能なら臨床・科学的最小重要効果を事前定義する。実行可能な小研究に合わせ仮定効果を膨らませても検出力は生まれず、問いを非現実的なものへ変えるだけである。

複雑モデル前に記述解析を行う。範囲、欠測、単位、不可能組合せ、重複識別子、時点、関連群別分布を調べる。可視化は一要約が逃す歪み、外れ値、非線形関係、バッチ効果を示す。外れ値は自動削除せず、データ誤り、稀な有効患者、モデル不完全の証拠かを調べる。影響を見た後の除外規則はバイアスを招く。

本質的習慣は、解析が推定する量であるエスティマンドを名付けることである。母平均、ある時点のリスク差、治療割付者の効果、定義介入下の平均変化などがある。明示すれば標本、測定、追跡、解析がそれを同定するかを問える。数値は目的と仮定が小数桁と同じほど明確なときにのみ科学的意味を持つ。

## TTSモジュール2：仮説検定、効果量、検出力、多重性

仮説検定は観察データが規定統計モデルと十分不整合で、それを疑うべきかを問う。帰無仮説は通常、差なし、関連なし、または基準値を表し、対立仮説は関心ある逸脱を表す。明示した統計量、標本分布、解析計画が必要で、科学理論の真偽、効果の臨床的重要性、バイアス不在を直接決めない。

p値は帰無モデルと全検定仮定を置いたとき、観察結果以上にモデルと不整合な結果を得る確率である。帰無仮説が真である確率、結果が偶然に起きた確率、再現成功確率ではない。小さいp値は意味ある効果、大標本の些細な効果、モデル違反、バイアス、選択解析から生じ得る。

有意水準は反復使用で帰無を棄却する事前長期閾値である。第一種過誤は真の帰無を棄却、第二種過誤は定義した対立が真でも棄却しないこと、検出力は規定対立が真のとき棄却する確率である。これらは仮定下の手順特性で一結果の事後ラベルではない。非有意は自動的第二種過誤でなく、有意も第一種過誤がなかった証明ではない。

検出力は標本数、効果量、変動、事象率、設計、割付、測定信頼性、有意閾値で決まる。計画には期待する最大効果でなく、検出に値する効果が必要である。観察効果から計算する事後検出力はp値を言い換えるだけで情報が少なく、データ後は効果推定と不確実性が有用である。事前妥当性が低いと低検出力は有意所見が真の割合も下げる。

片側検定は棄却域を一方向へ配分し、その方向の検出力を高め得るが、反対方向効果を判断上無効果と同じに扱う場合だけ適切である。予想外方向の害は通常無関係でない。結果方向を見て片側を選ぶことは事前仮説でなく機会主義であり、実質的に第一種過誤率を倍増させる。方向と根拠を結果前に規定する。

統計的有意性は臨床的重要性ではない。二値転帰のリスク差は絶対変化、リスク比は比例変化、オッズ比はオッズ比較を示す。稀な事象ではオッズ比はリスク比へ近いが、一般的事象ではより極端に見える。連続転帰の平均差は自然単位を保ち、標準化平均差は尺度間比較を許す代わり直感的意味を失う。

最小重要差は患者、臨床、政策の観点から価値ある最小変化で、基礎重症度、負担、費用、有害作用により変わる。信頼区間を意味ある利益、些細な効果、意味ある害の領域と比較できる。零を除くかだけより豊かで、有意でも小さすぎて無意味、非有意でも重要な利益と害の両方に適合し得る。

対応解析は個人内または組内差を使い安定した単位間変動を除ける。独立群解析は観察を無関係として扱う。対応データへ独立検定を使うと情報を捨て、無関係データへ対応検定を使うと依存を捏造する。反復測定には時間相関を表すモデルが必要で、全観察を独立扱いすると標準誤差を人工的に小さくし偽の精度を作る。

パラメトリック検定はデータまたは残差の分布モデルを定める。ノンパラメトリックや順位検定は別仮定を持ち、平均でなく分布・順位を対象とすることが多い。仮定不要ではなく、外れ値、不均一分散、集積、情報を持つ欠測を自動解決しない。大標本では平均比較は中程度非正規へ頑健だが、小標本の極端歪みでは推定と解釈に注意する。

多重性は多数の仮説、転帰、時点、亜群、モデル、中間観察が好結果の複数機会を作ることから生じる。独立した多数の真の帰無検定を各五パーセント閾値で行うと、一つ以上の偽棄却確率が上がる。家族内誤差率制御は定義家族内の任意偽棄却確率を、偽発見率法は規定条件下で棄却中の期待偽割合を制御する。適切な家族は科学的主張に依存する。

ボンフェローニ調整は有意閾値を検定数で割り単純だが、検定が相関すると保守的になり得る。段階法は家族内誤差を保ちながら検出力を改善し、階層検定は前の主張が通った場合だけ後を解釈する。多変量モデルや次元削減は相関転帰を扱うがモデル仮定を導入する。失敗検定を隠す未定義解析宇宙はどの調整でも救えない。

選択的報告は結果を知った後に転帰、時点、除外、変換、モデルを選ぶことから生じる。研究者自由度は意図的捏造なしにも説得的p値を生む。事前規定、登録、時刻付きプロトコル、利用可能コードが計画と探索を分ける。探索は正直に表示し新データで検証すれば発見に有用だが、確認的だったと装うと証拠を誇張する。

亜群解析は患者特性で効果が違うかを問う。一群で有意、他群で非有意という比較でなく直接交互作用検定が必要である。方向が事前規定、特性が治療前測定、検定数が少数、生物学的根拠があり、再現すると信頼性が上がる。任意切点は情報を捨て、連続関係に見かけの閾値を作り得る。

等価性・非劣性検定は通常の立証責任を逆転する。等価性には効果区間全体が事前の上下許容域内にあること、非劣性には有効対照に対する許容不能な損失を除外することが必要である。限界は正当化された対照利益を保存すべきである。類似へ向かうバイアス、遵守不良、転帰誤分類、低い分析感度が偽の非劣性を支え得るため、治療意図とプロトコル遵守の両視点を調べることが多い。

モデル仮定は全検定へ影響する。等分散検定には同等残差分散または調整が必要で、カイ二乗近似には十分な期待度数が必要で疎表には正確法が適することがある。生存時間比較は打切りとハザード仮定に依存し、診断精度区間は抽出設計を反映する。ソフトが出すp値は自己検証せず、予備正規性検定で本検定を選ぶ二段階推論は不安定になり得る。

再現性には複数意味がある。計算再現性は同データとコードで同結果、追試可能性は十分類似した新データで整合証拠を得ること、一般化可能性は異なる集団、場所、実施へ関係する。計算再現可能でも偏り、一狭小場で再現して他で失敗し、または異質効果を正確に推定し得る。これらをp値が閾値未満かへ圧縮しない。

出版バイアスは陽性、新規、劇的結果を優先する。小研究効果は小研究ほど選択報告され、または集団・方法が違うと起こり得る。ファンネル図は非対称を示唆しても一原因を診断できない。メタ解析は研究の目的量、バイアス、異質性が許す範囲でのみ意味を持ち、系統的に偏った研究の精密な統合値は精密に誤る。

逐次証拠には特別な処理が必要である。蓄積データを反復確認し有意になった時点で止めると、設計が考慮しない限り偽陽性が増える。群逐次境界、アルファ消費、ベイズ監視が原則的中間判断を許す。少数事象で利益早期中止すると効果を誇張し得る。妥当な重篤害が出れば、安全監視は通常有意性を待たず重症度とパターンを考える。

規律ある解釈は推定効果、区間、モデル、比較、判断閾値を示し、次にバイアスと関連性を検討する。p値は帰無モデルとの不整合を較正できるが議論全体を担わない。設計、測定、効果の大きさ、不確実性、事前知識、再現の収束が、生物学的理解や臨床行動を変えるかを決める。

## TTSモジュール3：回帰、生存、予測、因果、欠測データ

回帰モデルは転帰を予測因子へ関係付ける。関連記述、調整比較、交互作用検定、将来予測に使えるが、目的ごとに仮定と評価が違う。変数追加は自動的にバイアスを除かず、調整係数だから因果的になるわけではない。転帰尺度、関数形、標本過程、変数時点が各母数の意味を決める。

線形回帰は連続転帰の条件付き平均を予測因子の関数として表す。係数は他のモデル変数を固定したとき、一単位変化に伴う期待転帰差である。この解釈は式の形が適切と仮定する。残差で非線形、不均一分散、依存、影響観察を調べる。残差正規性は主に小標本推論へ関係し、平均関係自体が線形かとは別である。

カテゴリ予測因子には参照カテゴリが必要で、係数はそれとの比較になる。連続予測因子を直線で入れると範囲全体で単位効果一定を仮定する。多項式、スプライン、変換は任意カテゴリなしに曲線を表せる。連続値のカテゴリ化は情報と検出力を失い、選択切点依存の閾値解釈を作る。臨床的閾値は便宜だけでなく生物学や判断から得る。

交互作用は一予測因子と転帰の関連が別予測因子で異なることを示す。線形モデルでは加法効果、ロジスティック・生存モデルでは各尺度上の効果を変える。一尺度で交互作用なしでも別尺度でないとは限らない。特に中心化・変換変数があると個別係数は不透明なので、意味ある値での予測転帰や対比として解釈する。

ロジスティック回帰は二値転帰の対数オッズをモデル化する。指数化係数は含まれる変数で条件付けたオッズ比で、リスク比ではなく、転帰が一般的なら相対変化を誇張して見せ得る。予測確率は理解しやすいが切片と共変量型に依存する。連続予測因子の直線性は確率でなく対数オッズ尺度で仮定され、確認が必要である。

計数転帰はポアソンまたは負の二項回帰でモデル化し、異なる観察時間にはオフセットを用いる。率には明確な分子、人時間分母、再発規則が必要である。同一人の反復事象は依存し、初回事象解析は後の負担を捨てる。混合モデル、一般化推定方程式、頑健標準誤差は集積を表せるが、集団平均または個人特異的という異なる問いに答える。

交絡は共通原因が曝露と転帰の両方へ影響し、非因果関連を作る、または因果関連を歪める現象である。調整は測定交絡経路を遮断できるが、曝露の結果を調整すると効果の一部を除き、二変数の共通結果を調整するとコライダーバイアスを作る。因果図は時間・因果仮定を明示し十分な調整集合を選ぶが、仮定の真実を証明しない。

統計的有意性だけの変数選択は不安定で、重要交絡を除き選択係数を誇張し得る。交絡因子選択は因果知識を使い、予測では正則化と検証で有用集合を選び得る。多重共線性は重複情報を持つ予測因子の個別係数を不精密にするが、全体予測は良い場合がある。高い分散拡大値は自動治療すべき疾患でなく、別々の効果がデータから同定不能かもしれない信号である。

生存時間解析は事象の有無と発生時点を扱う。打切りは正確な事象時が観察境界の先または前で不明なことを示す。標準法は通常、条件付きで打切りが事象過程から独立と仮定する。重症者が異なる形で追跡を離れれば単純推定は偏る。競合事象は対象事象を妨げまたは確率を変え、常に通常打切りとして扱えない。

Kaplan-Meier推定は右打切りを考慮し無事象確率を時間で表す。曲線は打切り時でなく事象時に下がり、リスク集合減少とともに不確実性が広がる。生存中央値は推定生存が二分の一となる時点で、曲線がそこまで下がらなければ推定できない。中央値比較だけでは追跡全体の重要差を逃し得る。

ハザードはまだ無事象者の瞬間事象率である。Cox比例ハザードモデルは基準ハザード形を規定せずハザード比を推定するが、拡張しない限り比が時間一定と仮定する。ハザード比はリスク比でも生存中央値比でもない。ハザードが変化または交差すると、制限平均生存時間や時点別絶対リスクが効果を明瞭に示し得る。

競合リスクでは原因別ハザードと累積発生を区別する。競合死亡を打切り扱いすると、その競合を強い仮定下で除去できる仮想世界を推定するが、累積発生法は競合がある観察世界の事象確率を推定する。どちらも有用だが問いが異なる。慣れたソフト命令でなく臨床判断に目的量を合わせる。

予測モデルは利用可能情報から個人・集団転帰を推定する。識別能は高リスク者ほど事象を経験する傾向を測り、二値転帰では受信者動作特性曲線下面積が多い。較正は予測リスクと観察リスクの一致を測る。識別良好でも系統的過大予測し、平均較正良好でも重要亜群で失敗し得る。臨床有用性は関連閾値の判断が転帰を改善するかにも依存する。

感度と特異度は予測閾値で変わり、受信者動作特性曲線は交換を示すが、有病率と誤り結果を無視する。稀な転帰には適合率再現率表示が有用なことがある。一般指標最大化で閾値を選ぶと偽陽性・偽陰性に特定の等価費用を仮定し、臨床と合わないことがある。決定曲線解析は閾値と純利益を結ぼうとするが仮定理解が必要である。

過学習はモデルが標本固有雑音を学び新データで性能低下することをいう。柔軟モデル、多数候補、小事象数、反復調整が危険を増す。訓練データ性能は楽観的である。交差検証とブートストラップは前処理・選択を含む全モデル過程を再標本内で繰り返せば内部楽観を推定できる。一回の訓練試験分割は変動が大きく、中規模データの情報を浪費する。

外部検証は固定モデルを新しい参加者、場所、時期で評価し、計算再現だけでなく移送可能性を検査する。症例構成、測定、治療、有病率、生物関係が異なれば性能は変わる。切片や傾き再較正でモデル再構築なしに確率精度を戻せる場合がある。更新は検証と分け透明に報告する。誤りが不平等な害を課すなら亜群性能が重要である。

欠測機序は観察情報に対して記述する。完全無作為欠測は欠測が観察・非観察値と無関係、無作為欠測はモデル内観察変数だけに依存、非無作為欠測は見えない値へなお依存する。これらは統計検定で確立する性質でなく過程仮定である。設計知識から理由、時点、欠測型を調べる。

完全症例解析は必要値が一つでもない記録を捨て、限られた条件だけで不偏で、精度を下げ対象集団も変え得る。単一補完は埋めた値を既知扱いし不確実性を過小評価する。多重補完は複数の妥当な完成データを生成し解析し、補完内・間不確実性を統合する。補完モデルには転帰、予測因子、補助変数、非線形、交互作用、集積を必要に応じ含める。

感度解析は検証不能仮定からの妥当な逸脱下で結論を調べる。非無作為欠測機序、未測定交絡の強さ、モデル形、打切り重み、曝露定義、影響観察を変え得る。多数解析を試し一致したものだけ報告しても頑健性ではなく、代替と根拠を可視化する。穏当な妥当仮定で変わる結果は二値結論へ押し込まず脆弱と記述する。

現代モデルは複雑でも証拠要件は変わらない。未来または転帰由来情報が予測へ入るデータ漏洩は驚異的だが無効な性能を作る。自動特徴選択は施設や同一性の代理を符号化し得る。解釈法は適合モデルの挙動を記述しても因果機序や公正を証明しない。臨床利用には代表的検証、較正、工程統合、影響評価、監視、経時変更計画が必要である。

統一原理は問い、目的量、データ生成過程、モデルの整合である。回帰係数、ハザード比、識別能、補完推定はそれぞれ制約された問いへ答える。良い解析は制約を可視化し、データと設計に対し仮定を確認し、不確実性を定量化し、目的場への移送を検証する。統計的高度さは整合を改善するとき有用で、そうでなければ誤答を見抜きにくくする。

# 第102章：実験生物医学的方法、測定、オミクス、再現性

## TTSモジュール1：顕微鏡、培養、分離、定量測定

生物医学的方法は標本化、調製、測定、解釈を通じ生体系を観察へ変える。各方法は物理原理と処理が保存するものだけを見る。鮮明画像、精密数値、自動分類は自然への直接接近ではなく、装置、試薬、校正、解析パイプライン、モデルの出力である。方法理解では、何をどの材料から、どの分解能と検出限界で、どの対照を用いて測り、どの別過程が同じ信号を作るかを問う。

光学顕微鏡は標本を透過、反射、または標本から放出される光子で画像を作る。分解能は近接点を区別する能力で、倍率だけでなく主に波長と開口数に依存する。空倍率は情報を増さずぼけを拡大する。コントラストは吸収、位相、偏光、蛍光から生じる。固定、薄切、染色、封入は可視性を上げるが、構造を収縮、変形、抽出、移動させ得る。

明視野顕微鏡は明るい背景に有色染色を用いる。位相差と微分干渉法は屈折率差をコントラストへ変え、無染色の生きた透明細胞を観察できる。蛍光法はある波長で蛍光体を励起し、より長い波長の放出を検出する。フィルターが励起と放出を分ける。自家蛍光とスペクトル重複は背景を作り、照明は退色と生細胞傷害を起こす。強度定量時は露光条件を比較可能に保つ。

免疫蛍光法は抗体で抗原を局在化する。直接法は一次抗体へ蛍光体を付け、間接法は標識二次抗体で信号を増幅する。特異性は製造者表示だけでは足りない。陽性対照は染色系が働くこと、陰性対照は非特異・背景信号を示し、直交検証は別試薬や方法で標的を試す。可能なら標的遺伝子除去が特に有用である。

共焦点顕微鏡はピンホールで焦点外光を除き、光学切片を走査して三次元再構成できる。多光子励起は近同時の低エネルギー光子を使い、焦点近傍に励起を集中して深部撮像する。超解像法は構造化照明、蛍光体切替、単一発光体位置推定で通常の回折限界を越える。再構成細部は標識密度、動き、光子数、アルゴリズムに依存し、ナノ構造には方法特異的対照が必要である。

電子顕微鏡は短い有効波長の電子線を使う。透過型は超薄切片を通る電子から細胞小器官・膜の超微細構造を示し、走査型は表面信号から地形的外観を示す。真空、固定、脱水、重金属染色、薄切、被覆により生体観察不能で人工像も作る。低温法は含水材料をより自然状態に近く保ち、多数の雑音粒子像から巨大分子構造を再構成できる。

細胞培養は制御条件で生物過程を分離する。初代細胞は組織特性を多く保つが寿命制限、提供者変動、分離選択がある。不死化株は反復・増殖可能だが、遺伝的ドリフト、人工条件への適応、誤同定、汚染を起こす。認証、継代記録、形態、増殖、定期マイコプラズマ検査が基本品質管理である。有名な株名も特定培養器内細胞の真正性を保証しない。

培地は塩、栄養、緩衝、しばしば血清または定義増殖因子を供給する。酸素、二酸化炭素、pH、浸透圧、基質硬度、表面被覆、密度、空間構築が表現型へ影響する。通常大気酸素は多くの組織に対し高酸素となり得る。二次元単層は極性と力学信号を変える。スフェロイド、オルガノイド、共培養、臓器チップは選択的構築、流れ、細胞相互作用を加えるが、完全な個体を自動再現しない。

微生物培養には生きた微生物の採取、適切な栄養と気相、十分な培養時間、事前治療による阻害がないことが必要である。選択培地は競合菌を抑え、鑑別培地は代謝特性を示し、増菌は稀な標的の回収を増す。陽性は感染、定着、汚染のいずれかで、陰性は低菌量、誤部位、難培養性、抗菌薬、輸送遅延を反映し得る。検体品質と宿主文脈を微生物同定へ統合する。

遠心分離は遠心場での沈降により成分を分ける。一般に大きく高密度の粒子ほど速く沈むが、形と媒質粘度も関係する。分画遠心は順次力を使い細胞、核、細胞小器官、巨大分子を濃縮する。密度勾配法は沈降速度または浮力密度で分ける。沈殿は濃縮画分で完全純化された小器官群ではなく、再懸濁は脆弱構造を乱し得る。

クロマトグラフィーは移動相と固定相への異なる分配で分子を分離する。サイズ排除は細孔アクセス、イオン交換は電荷、アフィニティーは選択結合、逆相法は主に疎水相互作用を使う。保持時間は校正条件下でのみ同定を助け、検出器応答が既知ならピーク面積で量を求める。共溶出、マトリックス効果、分解、カラム変化が清潔に見える誤ピークを作り得る。

電気泳動は荷電分子を電場で移動する。アガロースゲルは核酸断片を主に大きさで、ポリアクリルアミドは蛋白をより細かく分離する。界面活性剤処理は蛋白を展開しほぼ均一な電荷質量関係を与える。ネイティブ法は構造と複合体を保つが電荷、大きさ、形を組み合わせる。バンドは同位置を移動した材料で単一分子種とは限らず、分子量標準、負荷対照、線形露光範囲が必要である。

ウェスタンブロットは分離蛋白を膜へ移し抗体検出する。概算分子量と量を示すが、転写効率、エピトープ接近性、飽和、背景減算、正規化が結果へ影響する。処置が発現を変える、または信号が飽和するハウスキーピング蛋白は有効負荷対照でない。総蛋白正規化と複数検証が推論を改善する。切り抜き画像にも非特異バンドと処理選択が分かる文脈を残す。

分光光度法は光吸収を測り、線形範囲では吸光度、光路長、モル吸光係数、濃度のBeer-Lambert関係を用いる。濁りと散乱は単純吸収仮定を破る。蛍光測定は高感度になり得るが消光、退色、環境条件に影響される。ブランクは試薬と容器背景を減算する。理想係数を仮定するより、未知標本に近いマトリックスで校正曲線を作る方が安全である。

免疫測定は抗原抗体結合で標的を検出・定量する。サンドイッチ法は二抗体間に抗原を捕捉し、競合法は標識結合低下から分析物を推定する。感度は低濃度検出、分析特異性は関連分子やマトリックス干渉へ関係する。異好抗体、高用量フック、交差反応、ロット差が偽結果を作る。標準、複数濃度対照、希釈確認、添加回収試験が一部障害を露出する。

フローサイトメトリーは懸濁粒子を集束光へ通し各事象の散乱と蛍光を記録する。前方・側方散乱は大きさと内部複雑性に概ね関係するが直接測定ではない。蛍光抗体はマーカーを示し、補償は検出器間のスペクトル漏れを修正する。ゲーティングは解析集団を定め主観を導入し得る。生死染色、単一細胞選択、蛍光一種除外対照、生物対照が妥当ゲートを支え、稀事象には十分な数と残骸・凝集除外が必要である。

質量分析は分子をイオン化し質量電荷比で分離する。クロマトグラフィーとの結合で複雑混合を事前分離し、タンデム法は選択イオンを断片化して構造同定を高める。定量には内部標準、校正、イオン抑制補正を使うことが多い。プロテオーム同定はスペクトルをデータベースへ照合し偽発見を制御する。未検出分子は不在、検出限界以下、低イオン化、調製除外のいずれでもあり得る。

測定性能にはブランク限界、検出限界、定量限界、直線性、動的範囲、精密度、正確度、回収率、頑健性がある。技術反復は測定変動、生物反復は独立した生物単位を表す。多数の技術ウェルを平均しても一頭や一提供者が大標本にはならない。可能なら検出器だけでなく抽出・調製を含む全過程を対照で試す。

最強の測定戦略は三角測量である。形態は位置、生化学は量や活性、摂動は機能的必要性を示せる。独立原理の一致は人工像が揃いにくいため信頼を高める。不一致も区画化、不活性蛋白、標本差、誤仮定を示す情報である。方法は高度だからでなく、限界と対照により観察が生物学的問いへ答えられるとき科学的に有用となる。

## TTSモジュール2：分子、遺伝、オミクス、単一細胞、計算的方法

分子的方法は核酸、蛋白、代謝物、その相互作用から生物状態を推論する。高感度で微量を検出できる一方、汚染、標本偏り、計算選択も増幅する。原検体にある分子と、抽出、増幅、標識、配列決定、フィルタリングが作る表現を区別する。各変換は材料を選択的に失いまたは濃縮するため、対照は全連鎖を追う必要がある。

核酸抽出は細胞を破壊し、分解酵素を不活化し、汚染物を分離してDNAやRNAを回収する。収量は量、純度比は一部汚染を示すが適性を証明せず、完全性は断片化を示す。RNAは特に分解されやすく、虚血や取扱中に量が変わる。抽出ブランクは試薬汚染を、添加分子は回収を監視する。異なるキットの系統差が生物差に見え得る。

ポリメラーゼ連鎖反応は変性、プライマー結合、伸長を反復してDNA領域を増幅する。プライマーが標的を定めるが、ミスマッチと標的外結合は効率と特異性を変える。終点PCRは多数サイクル後の産物有無を示すが、試薬飽和後は定量性が低い。定量PCRは増幅中の蛍光を監視し、効率とベースライン処理が妥当なら閾値通過サイクルから初期鋳型を推定する。

逆転写は増幅前にRNAを相補DNAへ変える。逆転写酵素効率、RNA構造、プライミング法が結果へ影響する。相対発現は標的を参照遺伝子と比べることが多いが、参照発現は実験下で安定でなければならず、有名な一ハウスキーピング遺伝子が自動的に適するわけではない。絶対定量は標準またはデジタル分割を使う。デジタルPCRは多数反応へ分け、陽性割合から確率モデルで分子数を推定する。

合成時解読法は多数のクローン増幅鋳型へ塩基が取り込まれる信号から配列を決める。短いリードは高精度・高処理量だが反復や相同領域で曖昧に配置される。長いリードは構造変異、反復、転写物アイソフォームをまたぐが誤差特性と入力要件が違う。カバレッジは位置当たり観察数で、深く読むと低頻度変異検出を改善するが、系統的配置・増幅バイアスは直さない。

配列工程にはライブラリ調製、索引付け、増幅または単分子装填、装置取得、塩基判定、品質選別、アラインメントまたはアセンブリ、変異判定、注釈がある。索引誤割当はリードを標本間移動させる。重複リードは独立分子でなく増幅を反映し得る。参照への配置は参照バイアスを導入し新規配列を逃す。変異判定法は感度と偽陽性の均衡が異なり、影響が大きければ直交法確認が必要となる。

Sanger法は蛍光終端断片を分離し、小領域と確認に有用である。合意信号を作るため低頻度変異を逃し得る。染色体分析は分裂細胞の大きな数・構造異常を検出し、蛍光インサイチューハイブリダイゼーションは細胞や組織の選択部位を調べる。比較ゲノム・配列法はコピー数を高分解能で検出するが、均衡再構成や空間的モザイクを同じようには示さない。変異型と問いで方法を選ぶ。

全ゲノム関連研究は多数人の一般変異と形質の統計関連を検定する。連鎖不平衡により関連マーカーは機能変化自体でなく目印かもしれない。集団構造、血縁、表現型誤差、多重検定を制御する。再現と微細マッピングが候補変異を絞り、機能実験が機序を試す。多遺伝子得点は多数の重み付き変異を統合するが、発見データで過少代表の集団では性能が低下し得る。

ゲノム編集は配列指向性核酸切断酵素などで標的変化を作る。ガイドが切断を指示し、細胞修復が小挿入・欠失または供給鋳型を組み込む。塩基・プライム編集は通常二本鎖切断なしに選択変化を作れる。効率、標的外編集、モザイク、大再構成、p53関連選択、送達を測る。編集後表現型では標的機能と人工像を分けるため、救済実験や独立ガイドが必要である。

RNA配列法は転写物由来断片を測る。計数はRNA量、転写物長、ライブラリ法、深度、配置に依存する。バルク法は細胞を平均するため、発現変化は細胞内変化または細胞混合比変化を反映し得る。正規化は大部分の特徴または適切な参照集合が予測可能に振る舞うと仮定する。差次発現解析は計数変動をモデル化し数千遺伝子の偽発見を制御する。

転写物量は蛋白量や活性と直結しない。翻訳、分解、局在、切断、リン酸化、複合体形成が介在する。プロテオーム法は通常蛋白をペプチドへ消化し分離後タンデム質量スペクトルで同定・定量する。データ依存取得は豊富なイオンを確率的に選び、データ非依存法は広い規定窓を測る。欠測ペプチド信号は生物的または技術的で、アイソフォームと翻訳後修飾には識別ペプチドが必要である。

メタボロームは食事、日内相、取扱、温度、酸素、薬物で急変する小分子を測る。標的法は標準で規定代謝物を定量し、非標的法は多数特徴を検出するが多くが未同定となる。一代謝物が複数イオン、付加体、断片を作り、別分子が同じ質量を持ち得る。同定確信度は正確質量、保持、断片化、真正標準との比較に依存する。

エピゲノム法はDNAメチル化、クロマチン接近性、ヒストン標識、蛋白DNA相互作用を調べる。亜硫酸法は化学変換で修飾シトシンを区別するが、拡張なしに全修飾型を分けない。クロマチン免疫沈降は選択蛋白・ヒストン標識が結合するDNAを濃縮し、抗体特異性へ強く依存する。接近性測定は開いたクロマチンへ入りやすい酵素を使う。単一細胞へ適応しない限り集団平均信号である。

単一細胞RNA配列法は細胞または核を分割し、細胞バーコードで分子を標識し、各転写物を疎に標本化する。バルクが隠す異質性を示すが、捕捉、解離ストレス、細胞大、RNA量、生存性が出現細胞を偏らせる。空液滴は周囲RNAを含み、二重体は細胞を混ぜ、ドロップアウトは真の不在でなく標本不足を示す。クラスターは解析選択から生じ、マーカー、解剖、機能、独立検証なしに自然種と扱わない。

空間的方法は位置を保ちながら選択転写物、蛋白、広範分子を測る。一部は規定標的を画像化し、他は一個または複数細胞を含むバーコード配列上で分子を捕捉する。分解能、感度、組織品質、区画化、位置合わせが交換関係にある。計算的デコンボリューションは細胞混合を推定するが参照とモデル仮定に依存する。空間近接は相互作用可能性を支持しても通信を証明しない。

マルチオミクスはゲノム、エピゲノム、転写物、蛋白、代謝物、微生物叢、画像を統合する。協調経路を示し得るが、次元、欠測、バッチ効果も増やす。相関特徴により多くの同等モデルが適合する。経路濃縮は背景遺伝子集合、データベース定義、選択閾値へ依存し、経路活性の直接証拠でなく仮説生成である。同データでパターンを選び検定すると循環解析になる。

採取日、研究室、試薬ロット、装置、操作者、保存、パイプラインの系統差がバッチ効果を作る。疾患群とバッチが完全に重なると計算補正で技術信号と生物信号を確実に分けられない。標本をバッチへ無作為配置し橋渡し対照を入れる方が取得後補正より偏りを防ぐ。補正はバッチと整合する真の生物を除き、人工的類似を作り得るため、生と補正データをともに調べる。

計算パイプラインは測定装置の一部である。ソフト版、参照ゲノム、パラメータ、乱数種、データベース日、機器依存挙動が出力を変える。ワークフロー管理、コンテナ、版管理、機械可読履歴が再現性を高める。品質閾値は事前規定または除外標本を隠さず正当化する。対話的探索は有用だが、最終解析は原入力から報告出力まで再構築可能でなければならない。

高次元法はボトルネックを生成から因果解釈へ移す。分子署名は機序を同定せず標本を分類でき、濃縮経路は細胞組成や共通ストレスを反映し得る。強い推論は一データで発見し、独立材料で検証し、関連細胞へ局在し、適切な系で摂動し、ヒト表現型へ結ぶ。オミクスは観察可能性を広げるが、対照、反復、生物学的推論の必要性を廃止しない。

## TTSモジュール3：実験設計、不確実性、再現性、倫理、検査室安全

実験設計は因果的問いを答えられる比較へ結ぶ。介入、対照、実験単位、転帰、時点、解析を測定前に定める。実験単位は独立して割り当てられる最小実体である。処置を培養皿、同腹、ケージ、診療所全体へ与えるなら、その中の細胞、仔、動物、患者は独立処置反復でなく副標本である。単位誤認は疑似反復と偽の精度を作る。

無作為化は偶然過程で単位を割り付け、平均的に系統的基礎差を防ぐ。ブロック化や層別化はバッチ、性、施設など強い既知変動源を均衡できる。標本処理・測定順も無作為化すればドリフトと群の一致を防げる。無作為化は記述だけでなく実施・記録が必要で、便宜的交互割付やケージ位置は予測可能で交絡を残し得る。

盲検化は割付知識を処置、測定、解析から分離し、特に主観転帰の差別的取扱と解釈を減らす。全介入を盲検化できなくても、転帰評価、標本ラベル、画像解析、コード審査は可能なことが多い。外見表現型や副作用で盲検が破れるため仮定せず評価する。自動解析は一部裁量を減らすが、人が決めた閾値と訓練選択を継承する。

陰性対照は背景または試験した因果成分なしで起こることを推定し、陽性対照は系が期待反応を作り検出できると示す。溶媒、偽処置、アイソタイプ、鋳型なし、未導入、野生型、救済対照は別の問いへ答え交換不能である。陽性対照失敗時の陰性実験結果は解釈不能で、隠れた生物活性を持つ陰性対照は見かけ効果を抑制・作成し得る。

要因実験は複数介入を系統的に変え、主効果と交互作用を効率よく推定する。用量反応設計は一任意用量と零の比較より形と閾値を示し、時系列設計は早期原因と後期結果を分ける。クロスオーバーは各被験者が複数条件を受け個人間変動を減らすが、安定疾患と十分な洗い出しを要する。持越しや不可逆作用は仮定を破る。

生物変動は一狭小系の成功後に追加せず設計へ入れる。提供者、系統、性、年齢、研究室、試薬、条件を越える反復は頑健性を試すが、初回実験へ全因子を入れる必要はない。意図する推論が関連多様性を決める。技術標準化は精度を高め、意図的異質性は一般化を高め得る。変動源を記録すれば両目標は相補的である。

標本数計算には主要転帰、解析、分散または事象率、目的効果、誤差率、割付、予想脱落が必要である。予備研究は実行可能性と大まかな変動を推定できるが、効果量は確定的検出力計算には不精密なことが多い。逐次設計は事前規則で無益性や成功時に停止できる。推論対象が人なら測定細胞数を増やしても少数独立提供者を補えない。

プロトコルは暗黙選択を可視化する。材料、調製、環境、時点、包含除外、中止規則、転帰定義、データ処理、逸脱を規定する。事前登録は仮説と計画解析に時刻を付け、登録報告は結果前に審査を受け得る。品質を保証しないが選択的変更を検出可能にする。正当な逸脱は完全性を装い隠さず、理由とともに報告する。

研究記録は何が起きたか再構成可能にする。固有標本識別子、試薬源とロット、装置校正、原ファイル名、ソフト版、操作者、時刻、変換がデータ来歴を作る。電子ノートは検索とバックアップを改善するが、アクセス制御と永続書き出しが必要である。原データは原形で保存し、清掃と除外は不可逆上書きでなく追跡可能スクリプトや変更記録で行う。

品質保証は検証済み手順、訓練、保守、管理文書で誤りを予防する。品質管理は標準、ブランク、反復、管理図で実行中性能を監視する。狭い対照を通っても目的利用に方法全体が妥当とは限らない。受入基準は群差を見る前に定める。一群の失敗らしい標本だけ再測定すると好結果への機会が差別的になる。

再現性には反復可能な詳細方法、識別可能材料、倫理法的に可能なデータ・コード検査、独立検証がある。生体系は変動するため完全一致は期待しないが、説明不能な方向反転は調査が必要である。直接再現は条件を反復し、概念再現は別方法で同じ主張を試す。両方が重要で、検証なき新規性は脆弱な文献を蓄積する。

研究公正は提案、実施、審査、報告の誠実性を要する。捏造はデータを作り、改ざんは材料や記録を操作し、盗用は言葉や着想を奪う。選択的省略、不適切画像変更、重複出版、名誉著者、不都合結果抑制も証拠を歪める。著者資格は実質的で説明責任ある寄与を反映する。利益相反は開示・管理し、無害とも自動失格とも仮定しない。

画像処理は科学的に追跡可能でなければならない。特徴を隠さず作らず原画像を保つ均一な明度・対比調整は適切なことがある。選択的変更、バンド移動、境界表示なしの視野結合は証拠を誤表示する。定量は圧縮提示画像でなく原データまたは検証済み線形データを使う。代表画像は事前基準で選び、独立単位全体の要約データを伴わせる。

人研究倫理は人格尊重、利益害の良好均衡、公正選択に基づく。独立審査は科学的価値を評価し、情報を生まない研究への曝露自体が非倫理的である。同意は目的、手順、危険、代替、私生活、自発性を理解可能に説明する。依存、能力低下、貧困、収監、限られた選択が脆弱性を増せば追加防護が必要である。除外も診療に必要な証拠を群から奪えば不公正となる。

私生活保護は必要な識別情報だけを収集することから始まる。符号化は直接識別子を置換しても、豊かなゲノム・連結データを匿名にはしない。再同定リスクは詳細、連結、アクセス、将来技術に依存する。統治は許可利用、保存、共有、撤回限界、偶発所見対応を規定する。個人名がなくても識別可能集団に関するデータなら共同体関与が重要な場合がある。

動物研究には置換、削減、改善を適用する。置換は問いへ答えられる非動物法を使い、削減は検出力不足の浪費を避けつつ最少動物で十分な情報を得る。改善は疼痛、苦痛、長期害を減らし福祉とデータ品質を高める。科学的に可能なら死亡前の人道的終点を使う。倫理費用は無関係なデータで償えないため、種とモデル妥当性を正当化する。

生物安全は病原体、手順、経路、量、濃度、曝露結果へ封じ込めを合わせる。リスク評価はエアロゾル、鋭利物、遠心、漏出、廃棄、輸送、脆弱職員を考える。生物安全キャビネットは正しく使えば制御気流で製品、作業者、環境を守るが、化学ドラフトではない。訓練、適切な予防接種、曝露計画、迅速事故報告が工学的防護を補う。

化学安全は危険性と曝露で決まる。毒性、腐食性、可燃性、反応性、発癌性、生殖影響には異なる制御が必要である。より安全な試薬への置換、囲い、換気、量制限、適合保存は個人防護具だけより強い。ドラフトはサッシと気流が正しければ揮発性化学物質を制御する。ラベルと安全データは取扱を導くが、混合廃棄物と予期しない反応には地域手順が必要である。

検査室事故は一人の不注意でなく、相互作用する制度弱点から起こることが多い。疲労、乱雑、所有者不明、非互換接続、保守不足、生産圧、常態化した回避策が揃う。報告が安全で変更につながればニアミスは価値ある信号である。緊急計画は曝露、漏出、火災、装置故障、封じ込め喪失を含み、ストレス下で使える程度に練習する。

完全な報告は問い、設計、実施、解析、限界を結ぶ。計画と探索を分け、陰性・有害所見を報告し、効果量と不確実性を示し、除外を明記し、設計が支持しない因果表現を避ける。報告指針は有用なチェックリストだが判断の代替ではない。他研究者が実施を理解し、解析を再現し、仮定を批判し、どこへ安全に適用できるか判断できる監査可能連鎖が目標である。

# 第103章：社会的決定要因、医療制度、経済、世界疾病負担

## TTSモジュール1：社会的決定要因、格差、不公正、集団健康

健康は生物学と、人が生まれ、育ち、学び、働き、暮らし、老い、医療を受ける条件の相互作用から作られる。社会的決定要因には所得、教育、住宅、雇用、食料、交通、環境、社会的つながり、法、差別、政治力がある。遠い背景ではなく、曝露、生理的ストレス、発達機会、疾患発見、治療実行可能性、回復を形作る。臨床医学は個人身体の下流影響へ接し、集団健康はその分布を調べる。

健康格差は人・集団間の測定可能な差である。健康不公正は社会制度に照らし回避可能で不正と判断される差で、明示すべき規範主張を加える。年齢による変異は生物学的に予想され得るが、貧困による予防可能死亡の大差は修正可能条件を反映する。平等は同じ資源を与え、公平は必要と障壁に応じ配分して健康達成の公正な機会を作る。

社会的勾配とは健康が最貧困層だけでなく社会経済階層の各段階で改善する傾向である。物質資源は栄養、住居、交通、曝露、治療接近へ影響し、相対的位置も自律、安全、地位、慢性ストレスを形作る。経路は重なる。社会経済条件を個人生活習慣の誤りへ還元すると機序を誤り、周囲環境が高価または危険にする行動を要求し得る。

教育は識字、雇用、所得、問題解決、社会網、制度利用へ影響する。健康も小児疾患、障害、栄養、出席、家族負担を通じ教育へ影響し双方向性を作る。就学年数は場所や世代間で質を同じに測らない。教育達成が健康を予測しても、知識、資格による機会、早期優位、複数経路を表し、一つの直接治療効果とは限らない。

雇用は所得、同一性、社会接触、生活構造を与え得るが、不安定、危険、低裁量、搾取的労働は健康を害する。職業リスクには傷害、化学物質、粒子、感染、騒音、熱、反復負荷、暴力、交代勤務、心理社会的要求がある。失業は所得と目的を減らし得るが、危険労働から離れると改善する場合もある。職名だけでなく作業、時刻、裁量、防護、雇用状態、累積歴が重要である。

住宅は温度、湿気、黴、過密、傷害、害虫、睡眠、私生活、暴力・汚染曝露へ影響する。不安定住宅は薬物保存、追跡、栄養、学校、支援を乱す。ホームレス状態は路上、施設、車、過密、一時住居で異なる危険を持つ。居所を尋ねず休養、冷蔵、創傷衛生、隔離を助言すると医学的に正しくても不可能な計画になる。

地域は緑地、熱、大気汚染、騒音、食品小売、酒・煙草販売、交通、医療、警察、活動機会を配分する。居住分離は歴史的・現在政策で有利不利を集中させる。地域関連は文脈効果と住民特性を反映し、個人社会経済調整が理解したい経路の一部を除くこともある。場所は単なる郵便番号ラベルでなく曝露系である。

食料安全保障は十分で許容可能な食品へ物理的・経済的に安定して接近できることをいう。不安定では制限と入手可能期が交互になり、不安と不規則な摂取を作る。高エネルギー製品が安価、保存可能、入手可能な選択肢かもしれない。金、時間、冷蔵、調理設備、交通、文化的食材を仮定する栄養助言は摂取を変えず恥を増し得る。教育だけでなく所得支援、食料制度、学校供給、価格、地域接近が必要である。

交通は仕事、教育、食品、社会接触、医療への接近を決める。長距離、利用不能車両、費用、危険な徒歩路、不安定運行が受診欠席と治療遅延を作る。自動車中心環境は活動を減らし傷害・汚染を増し得る。交通改善は広い健康効果を生むが、利便性上昇で住宅費が上がり低所得住民を追い出す可能性がある。平均利益と分配結果をともに評価する。

社会的つながりは情動支援、実務援助、情報、同一性、集合的効力を与える。孤立は客観的接触不足、孤独は望む関係と実際の不一致で、重なるが異なる。過密世帯でも孤独になり、一人暮らしでも孤独とは限らない。疾患は孤立の原因にも結果にもなる。介入は移動、聴覚、スティグマ、悲嘆、安全、機会、関係質のどれが障壁かに合わせる。

差別は対人、制度、構造水準で働く。住宅、教育、雇用、富、安全、医療への接近を変え、反復脅威と警戒がストレス生理へ影響する。人種差別は人種化集団の生物学的性質でなく、不均等処遇と曝露を通じ生物学的結果を持つ。遺伝的祖先は一部生物学的問いに重要だが、広い人種分類を遺伝型、環境、生活経験の代わりにすると科学的誤りになる。

生物学的性、ジェンダー、性的指向、障害、移住状態、カースト、先住性、宗教なども機会と処遇を形作る。交差性は制度が独立不利を足すのでなく組み合わさる仕方を調べる。裕福な障害者と貧しい障害者は共通アクセス障壁と異なる物質制約を持つ。集団平均を個人の運命にしないが、集団パターンを測らなければ制度的害を隠す。

ライフコース法は曝露が蓄積・集積し感受性期に作用する仕方を調べる。出生前栄養、小児逆境、教育、仕事、妊娠、疾患、加齢が発達と相互作用する。累積不利は予備能を減らし後の選択を制約する。リスク連鎖は一曝露を次へ結び、保護経験は中断できる。早期曝露が重要でも成人介入は価値があり、発達歴は確率を変えるが必然にはしない。

商業的決定要因は企業製品、実践、政治活動が健康を形作ることから生じる。製剤、価格、配置、広告、ロビー、訴訟、労働、研究支援が煙草、酒、食品、賭博、医薬品、化石燃料などへ影響する。個人選択は設計された環境内で起こる。規制は規定値と曝露を大規模に変え得るが、代替、違法市場、逆進的費用、業界適応を予測する。

医療アクセスには利用可能性、地理、費用、受容性、適応性、品質がある。保険や形式的権利だけで適時有能な診療を保証しない。行政複雑性、言語、障害接近、差別、開業時間、デジタル排除、当局への恐怖が実効障壁となる。継続性や品質なしに量だけ増しても転帰は改善しない。未充足需要には待機名簿へ数えられる地点まで到達しない人も含む。

逆ケア法則は特に市場力が強いと、必要が最大の所ほど良質医療が少ない傾向をいう。高需要地域は臨床家が少なく、診察が短く、離職と断片化が多いことがある。複雑性が違えば同じ診察時間は不公正になり得る。比例的普遍主義は全員へサービスを与えつつ不利に比例して規模と強度を高め、貧困者だけの残余制度と必要を無視する配分を避ける。

集団介入はリスク分布全体を移動するか、高リスク者を対象にする。高リスク戦略は少数へ大きな個人利益を与えるが、発見と継続関与へ依存する。集団戦略は多数へ小利益を与え発生原因へ作用できるが、有利な人が先に利用すると格差を広げ得る。普遍的環境変化と対象支援の組合せが平均と分布をともに改善しやすい。

不公正データには注意深い分母と分類が必要である。絶対差は事象率の隔たり、相対差は比例格差を示し、全体率変化で逆方向へ動き得る。分類は共同体と解析需要を反映し、小集団を再同定へ曝さない。民族、所得、障害、地域の欠測は無作為でないことが多い。平均だけのダッシュボードは少数群の悪化を隠し成功に見せ得る。

社会的決定要因は因果候補であり治療的悲観の言い訳ではない。臨床家は即時障壁を同定し、治療を適応し、同意の上で社会的必要を記録し、サービスへつなぎ、安全制度を求められる。公共政策は所得、住宅、教育、労働、環境、差別へ上流介入できる。両水準は置換不能である。良い集団医学は生物学的診療を、誰が曝露し、利益を得て、負担し、どの予防可能制度がパターンを作るかの説明へ結ぶ。

## TTSモジュール2：医療制度、財政、経済、品質、資源配分

医療制度は健康改善・維持を主目的とする人、組織、資源、規則、関係である。公衆衛生、一次・専門診療、薬剤、検査、リハビリ、長期ケア、人材、情報、財政、規制、共同体活動を含む。提供量だけで性能を判断できない。健康を改善し、人へ応答し、経済的困窮から守り、利益を公正に配分し、需要変化へ回復力を持つべきである。

一次医療は最初の接触、広い範囲、継続性、調整、一疾患でなく人への注意を提供する。強い一次医療は一般的問題を解決し、リスクを早期発見し、多疾患を管理し、専門資源を適切に導く。ゲートキーピングは調整と不要専門利用を改善し得るが、接近が遅い、または紹介閾値が患者より予算に奉仕すれば有害になる。紹介品質は明瞭な問い、情報移転、返答、移行中責任に依存する。

二次・三次サービスは稀または複雑な病態へ専門性、技術、設備を集中する。診療量と専門チームが重要なら集中化は転帰を改善できるが、移動と地域支援からの分離が負担となる。ネットワークは地域評価・追跡と広域介入を組み合わせる。最適規模は病態、緊急性、人材、地理で異なる。全サービスを全地へ重複するのは非効率だが、過度集中は名目的利用可能性を実質不能にする。

ユニバーサル・ヘルス・カバレッジは必要な質のサービスを経済的困窮なしに受けることをいう。誰を、どのサービスまで、どの費用割合で守るかの次元がある。形式的権利があっても非公式費用、薬剤不足、待機、低品質が共存し得る。拡大には給付範囲と提供能力の選択が必要で、人材や供給なしの約束は有効保障でなく待機と私的逃避による不公正を作る。

医療財政は収入を集め、リスクをプールし、サービスを購入する。財源は一般税、社会保険料、民間保険、自己負担、国外援助などである。プールは健康者と病者、富者と貧者、異なる人生段階で不確かな費用を共有する。小さく分断したプールは再分配を弱め低リスク者選択を促す。発病時自己負担は世帯を破局的支出へ曝し、高価値診療を抑制する。

保険は不確実性を扱うが情報問題を作る。逆選択では高費用を予期する人ほど加入し、自発的プールを不安定にし得る。リスク調整は高リスク加入への補償だがデータに依存し操作され得る。モラルハザードは受診時価格低下で利用が増えることをいい、以前断念した有益利用と低価値利用を含む。自己負担は両方を減らし、貧困者と病者を不均衡に抑制し得る。

提供者支払は行動を変える。出来高は活動ごとに報酬し接近や強度を増すが量と断片化を促す。給与は費用を予測可能にしチームを支え得るが、説明責任が弱ければ追加努力誘因が下がる。人頭払いは登録者ごとで予防と費用管理を促す一方、リスク選択や過少提供を生み得る。症例払いは一診療単位の効率を促すが、符号操作、早期退院、分割を誘発し得る。混合は均衡できるが複雑になる。

全目的を整合する支払方式はない。品質報酬は測定過程へ注意を集中し、未測定診療を無視し、複雑患者を避け、記録を操作させ得る。指標が臨床的に重要で慎重に調整され、操作に強く、害を監視するとき目標は有効である。内発的専門職動機と組織文化は金銭誘因と相互作用し、行動への支払が取引的だと示して他動機を置換することもある。

経済評価は代替の費用と結果を比較する。費用効果分析は追加健康結果当たり追加費用、費用効用分析は生存と健康関連品質を選好重みで結ぶ質調整生存年などを用い、費用便益分析は入力と結果を金銭評価する。各枠組みは誰の費用、どの結果、どの時間範囲、将来価値の割引について仮定を持つ。

増分費用効果比は選択肢間の費用差を効果差で割る。孤立した平均生涯費用と平均利益でなく、効率フロンティア上の関連代替を比較する。より安く有効なら他を支配する。差が小さいと比は不安定で、異なる閾値で費用効果的となる確率分布で不確実性を示す方がよい。閾値は機会費用と社会価値を反映し生命の普遍価格ではない。

機会費用は資源を一用途へ使うことで次善代替から失う健康や価値で、金銭移動がなくても存在する。新技術が受療者を助けても、他のより有効な診療を押し出せば総健康を減らし得る。予算影響は支払者が大規模導入可能かを問い費用効果と異なる。費用効果的でも短期予算影響が支払不能で、安価でも低価値な介入がある。

公平性評価では誰が利益を得て支払い、誰の健康が置換されるかを調べる。同じ健康増分も基礎的不利が違えば社会的優先が異なり得る。分配的費用効果分析は一部交換条件を明示するが、重みは技術的事実でなく倫理政治的選択である。高価値一次医療の障壁低減のように効率と公平をともに改善できる。交換があればモデル内に隠さず公開熟議する。

優先順位設定は国、組織、診療現場で起こる。正当な過程は関連理由、公開透明性、修正と異議申立て、合意規則の執行を持つ。重症度、緊急性、利益可能性、証拠、費用、介護役割、年齢、過去不利を考慮し得るが正当化が必要である。社会的価値、富、名声、主張能力が密かに接近を決めてはならない。待機名簿は配分制度として統治する。

待機時間は明示価格なしに診療を配給し得る。緊急性を優先し普遍権利を保ち得るが、長期化は疾患、不安、就労喪失を悪化させ、富裕者が速い診療を買えると不公正になる。待機データは紹介、評価、判断、治療の区間を分ける。一報告区間を別へ移して短縮しても改善でない。需要管理は低価値利用、未充足需要、能力不足を区別する。

品質には安全、有効性、患者中心性、適時性、効率、公平がある。構造は資源と組織、過程は提供診療、転帰は結果健康を示す。過程指標は行動可能だが転帰と結び付く場合に重要である。転帰にはリスク調整が必要だが、過剰調整は不利集団の低品質を正当化し得る。患者経験は関係品質と接近を測るが、臨床転帰や全判断への満足と同一ではない。

安全科学は有害事象が相互作用する制度条件から生じると認識する。報告制度は危険を示すが未報告と報告バイアスがある。トリガーツール、記録審査、監視、苦情、職員観察が証拠を加える。根本原因分析は最後の人為誤りだけでなく、仕事量、設計、通信、装置、政策、組織優先を調べる。注意喚起より制度再設計が強い是正となる。

人材計画は人数、技能、分布、監督、定着、健康、チーム構成を考える。教育に時間がかかり魅力的地域へ集中するため、養成人数増加は即時不足を解決しない。タスクシェアリングは役割、訓練、支援、紹介、規制が十分なら接近を広げるが、安価な労働者へ責任を移すだけではない。燃え尽きと離職は継続性、安全、費用へ影響する制度転帰である。

医療情報制度は個人診療、監視、支払、品質、研究を支える。相互運用性は患者と情報を移動させるが、データ量は有用知識を保証しない。記録負担は診療を置換し、コピーは誤りを伝播し、性能指標は符号を歪め得る。データ統治は利用可能性、私生活、安全、同意、公共利益を均衡する。デジタル排除と非アクセシブル設計は効率改善を新障壁にする。

回復力は本質機能を保ちながら衝撃へ準備、吸収、適応、学習する能力である。重複、予備在庫、交差訓練職員、信頼通信、柔軟財政、地域知識、強い供給網は平時に非効率に見えても、感染流行、災害、サイバー攻撃、紛争で不可欠となる。通常最大利用だけの効率は急増余裕を除く。危機中も慢性、母子、精神、予防診療を守る必要がある。

医療制度は提供機械であると同時に倫理制度である。財政は誰がリスクを負うか、支払は誘因、給付範囲は権利、待機は時間、品質制度は誰の害が見えるかを決める。健全な政策は転帰と費用を公正、実行可能性、説明責任へ結ぶ。成功単位は請求行為や占床でなく、回避可能な害や困窮なしに得られ、公的に正当化可能な形で分配された健康である。

## TTSモジュール3：疾病負担、実装、グローバルヘルス、プラネタリーヘルス

集団負担はどれだけの疾病、障害、早期死亡が誰に、どこで、いつ起こるかを表す。件数はサービス需要を示すが人口規模に依存する。割合と率は比較を許すが、明瞭な分子、分母、時間を要する。罹患率はリスク集団の新規事象、有病率は一時点・期間の既存疾患を測る。有病率は発生と持続で増えるため、生存改善が治療成功を表しながら有病率を上げ得る。

死亡は粗死亡率、年齢別率、死因別率、致命割合、生存確率で表せる。致命割合は診断例中死亡で、発見、症例定義、追跡、診療に依存する。集団死亡率は発生率にも依存し、致命割合低下と安定死亡率が発生増加と共存し得る。死因証明は因果系列を要するが、競合疾患、検査不足、符号慣行、社会条件が不確実性を導入する。

年齢構造が違う集団の粗率比較は誤解を招く。直接標準化は各集団の年齢別率を共通標準分布へ適用する。間接標準化は観察事象を参照率から期待される事象と比較し標準化比を作る。標準選択は要約数値へ影響するが基礎年齢別率を変えない。標準化は比較を改善しても差の理由を同定しない。

平均寿命は現在の年齢別死亡率へ曝露される仮想コホートの期待生存年を要約し、一新生児の実寿命予測ではない。健康寿命は非致死健康状態で年を調整する。損失生存年は参照年齢に対する早期死亡、障害生存年は有病率と障害重みを結び、合計が障害調整生存年となる。広い比較を許すが、データ品質と参照寿命・健康重みの価値選択に依存する。

質調整生存年は時間を選好に基づく健康関連品質で重み付けし、経済評価に多い。障害調整生存年は集団損失定量に多く、正確な鏡像ではない。選好尺度は特定文化や障害に重要な次元を逃し、適応が構造障壁を残したまま報告品質を変え得る。要約尺度は判断を助けるが、人の価値が健康重みと同じと示唆してはならない。

帰属負担は反実仮想曝露分布で回避される疾病量を推定する。人口寄与割合は曝露頻度、相対危険、因果性、実行可能な代替に依存する。危険因子は重なり相互作用するため、別解析の割合合計は百パーセントを越え得る。モデル帰属は一意に原因となった症例の直接計数ではない。曝露データ、効果、潜伏、媒介、交絡の不確実性を伝播する。

サーベイランスは行動のため継続的にデータを収集、解析、解釈、伝達する。受動制度は通常報告へ依存し安価だが不完全で、能動制度は症例を探索し費用とともに把握を上げる。定点施設は選択地点を深く監視するが全体を代表しない場合がある。症候群監視は迅速に症状パターンを捉えるが特異性を失う。検査、定義、報告誘因、アクセス変化が真の発生変化なしに見かけ傾向を作る。

世界比較は不完全な人口動態登録、診断差、紛争、移住、疎な調査に直面する。統計モデルは欠落を埋め整合推定を作るが、モデル確実性を観察データと混同しない。情報が弱い場所では広い不確実性が適切で、地域知識は非現実仮定と未記録事象を示す。住民登録、検査室、調査、相互運用情報への投資は測定経費でなく健康改善の一部である。

実装科学は根拠ある介入が現実場で日常実践になる方法を研究する。有効性は通常条件で転帰を改善するか、実装は受容、採用、維持、妥当な忠実度で適応されるかを問う。受容性、採用、適切性、実行可能性、忠実度、費用、浸透、持続性が主要実装転帰である。臨床的に有効でも接近不能または組織が維持不能なら集団利益はない。

忠実度は全表面詳細を複製するのでなく中核因果機能を保つことである。言語、工程、人材、資源、文化へ適応が必要となり得る。機能を保つ適応と活性成分除去を区別する。ロジックモデルは投入、活動、機序、出力、転帰を結び、仮定を検証可能にし、一文脈で成功し別で失敗した理由を説明する。

プログラム評価は過程、転帰、影響を調べる。可能なら集団・段階実装を含む無作為設計が強い比較を与えるが、展開都合だけで段階楔型が不偏にはならない。中断時系列は実装前後の水準と傾向を評価し十分な観察と同時事象への注意を要する。差の差法は平行傾向仮定下で曝露群と比較群の変化を比べ、回帰不連続は閾値近傍の割付を利用する。

到達と利用を集団別に調べる。参加者の転帰を改善しても、不利な人が登録・継続しにくければ集団格差を広げ得る。到達と有効性の積が各単独より重要な場合がある。拡大は提供条件、監督、供給網、集団構成を変えるため、成功した予備試験を単純に倍加できない。適応、負担、他サービスの意図しない置換を監視する。

グローバルヘルスは低所得国の疾患だけでなく、国境を越える決定要因、制度、不公正を扱う。植民地史、貿易、債務、知的財産、移住、紛争、権力が研究優先と資源流を形作る。短期外部事業は地域制度を重複し職員を奪い資金終了時に消え得る。公正な協働は課題設定、予算、データ統治、著者、訓練、説明責任を共有し、参加者への接近を越えて地域専門性を評価する。

開発援助は必須サービスと革新を支えるが、変動し、提供者主導で、疾患別に断片化し得る。垂直事業は一疾患へ集中し迅速で測定可能な成果を出し、水平投資は広い制度を強化し、対角法は焦点課題で共有能力を築く。最適均衡は緊急性と地域制度に依存する。並行供給・情報制度は短期出力を出しながら長期主権と統合を弱め得る。

人道危機は暴力・災害と避難、設備破壊、過密、食水不足、慢性診療中断、保護脅威を組み合わせる。トリアージと最低サービスは外傷、感染、母子、栄養、精神、非感染性疾患、障害、安全保護を扱う。被影響者への説明責任は妥当性を高め虐待を検出する。危機下のデータ・画像収集にも必要性、保護、敬意が必要で、脆弱性は同意を消さない。

健康安全保障は国境を越える脅威の予防、発見、対応を目指す。監視、検査室、人材、通信、備蓄、信頼される公共制度は共有財である。富裕国への脅威阻止だけに絞ると地域の日常健康需要を無視し協力を損なう。流行時の透明な不確実性、対策の公正配分、隔離支援、医療者保護は倫理と有効性をともに改善する。

プラネタリーヘルスは地球自然系内の人間健康を調べる。気候変動は熱、極端気象、食水、大気、感染生態、避難、紛争危険、精神健康へ影響する。危険は地理、職業、年齢、疾患、住宅、適応資源で異なる。一事象の帰属が不確かでも多数事象の確率変化は確立し得る。緩和は将来危険を、適応は既に起こる変化の害を減らす。

医療制度はエネルギー、交通、建物、麻酔ガス、薬剤、食品、調達、廃棄で排出へ寄与する。脱炭素は清浄空気、能動交通、効率建物、低廃棄診療で健康と整合し得る。しかし安全な代替なしに有用な単回用品や移動を除けば危険を移す。ライフサイクル評価は目に見える廃棄だけでなく生産、使用、処分を考える。低炭素診療は安全と公平を保つか改善すべきである。

生物多様性喪失と土地利用変化は食料、水調節、生計、野生動物、家畜、媒介動物、人の接触を変える。ワンヘルスは特に人獣共通感染と薬剤耐性で人、動物、環境健康を結ぶが、全飛び火を野生動物監視だけで予測・予防できるとは意味しない。農業、生息地破壊、貿易、職業防護、獣医制度、医療準備が連結予防網を作る。

大気、水、土壌、騒音、プラスチック、化学汚染の負担は不均等に配分される。曝露が広く遅延害が不可逆なら、全個別因果経路の証明前に規制が必要となり得る。予防原則は証拠なき禁止でなく、妥当な危険、曝露、代替、不確実性、結果を統合する。汚染者と利益享受者が政治力の最も弱い共同体へ費用を外部化してはならない。

負担測定と実装は説明責任で出会う。指標は複雑な人生を一順位へ還元せず、必要を示し、行動を導き、誰が利益を得るかを示す。事業は発表や予備成功でなく、到達、品質、転帰、費用、公平、持続性で評価する。グローバル・プラネタリーヘルスは臨床責任を国境と世代を越えて広げ、現在の配分と生産が誰の疾患を可視化し、誰の診療を可能にし、どの未来危険を継承させるかを問う。

# 第104章：運動、適応、体温調節、高地、極限環境

## TTSモジュール1：運動エネルギーと統合生理反応

運動は骨格筋が化学エネルギーを力、運動、熱へ変える制御された恒常性撹乱である。能力は筋だけでなく、換気、心拍出、血流、酸素輸送、基質供給、体温、神経駆動、内分泌、知覚の協調変化に依存する。制限過程は強度、持続、環境、訓練、健康、動機で異なる。最大酸素摂取量は重要な能力を要約するが全種類の能力を説明しない。

アデノシン三リン酸は架橋回転、カルシウムポンプ、イオン勾配を直接駆動するが、筋内貯蔵は最大収縮を数秒しか支えない。ホスホクレアチンはクレアチンキナーゼを介しアデノシン二リン酸へリン酸を迅速供与し急需要を緩衝する。嫌気的解糖はグルコース・グリコーゲンから速くATPを作り、ピルビン酸を乳酸へ還元して酸化型ニコチンアミド補因子を再生できる。酸化的リン酸化は遅いが糖質、脂肪、少量のアミノ酸からはるかに大容量のATPを作る。

エネルギー系は順番に置換せず同時に働く。相対寄与は出力、持続、線維動員、酸素供給、基質、訓練で変わる。短距離全力ではホスファゲンと解糖流束が高く、酸化代謝も速く上がる。長時間中等度ではミトコンドリア依存が大きいが解糖も続く。乳酸産生は無酸素を意味せず解糖流束と酸化還元均衡を反映し、筋と心で酸化され、肝糖新生にも使われる。

酸素摂取量は心拍出量と動静脈酸素較差の積で、心拍出量は心拍数と一回拍出量の積である。動的運動では交感活性と迷走神経離脱が心拍と収縮性を上げる。筋・呼吸ポンプ、静脈収縮、再分配が静脈還流を増す。一回拍出量は充満と収縮性で増え、しばしば高強度前に頭打ちになるが、持久訓練者では高強度まで増え続け得る。

活動筋の局所代謝性血管拡張、非活動床の交感性収縮、心拍出増加により血流を再配分する。活動筋のアデノシン、カリウム、二酸化炭素、水素イオン、一酸化窒素関連信号などが局所で交感収縮へ対抗し、機能的交感神経遮断と呼ばれる。後に皮膚血流が熱放散のため増え、冠血流は心筋需要とともに増す。心拍出増加が全身抵抗低下を上回るため平均動脈圧は通常中程度上がる。

静的・高負荷抵抗運動は異なる血行動態を作る。収縮筋が血管を圧迫し抵抗が上がり、特に息こらえとバルサルバ法で血圧が一過性に非常に高くなる。いきみによる胸腔内圧は各相で静脈還流、動脈圧、圧受容反射を変える。呼吸、技術、負荷、臨床文脈が危険を変える。急性昇圧は抵抗運動が必然的に慢性高血圧を起こすことを意味しない。

換気は中枢指令と感覚フィードバックで直ちに増し、次に代謝性二酸化炭素産生と酸塩基需要へ従う。健康者の中等度定常運動ではガス交換が大幅増加しても動脈酸素・二酸化炭素分圧はほぼ正常に保たれる。初めに一回換気量が増え、高強度で呼吸数寄与が増す。換気閾値を越えると、水素イオンの重炭酸緩衝で追加二酸化炭素が生じ神経駆動も増すため換気が不均衡に上がる。

運動中は肺毛細血管の動員・拡張により拡散能と肺灌流が増す。健康肺には通常予備があるが、優れた持久能力、高地、肺・心疾患で限界が露出する。赤血球通過短縮、換気血流不均衡、拡散制限で運動性動脈不飽和が起こり得る。息切れは一酸素値でなく、呼吸駆動、力学、ガス交換、感情、経験を反映する。

動脈酸素含量は主にヘモグロビン濃度と飽和度で決まり、血漿溶解酸素は少ない。貧血は飽和正常でも含量を減らし、同じ酸素供給に高い心拍出を要する。一酸化炭素は運搬を減らし一部飽和測定を歪める。運動時の温度、二酸化炭素、酸性化はヘモグロビン親和性を下げ活動組織への放出を促し、肺条件は再結合を支える。

毛細血管灌流、拡散勾配、ミオグロビン移送、ミトコンドリア利用が増し、筋酸素抽出が上がる。持久訓練は毛細血管とミトコンドリア能力を増す。しかし供給と利用は相互依存し、重い血流制限をミトコンドリア増加だけで補えず、筋ミトコンドリア不全なら高血流も酸化ATPを作れない。最大酸素摂取量は特定試験様式での供給・抽出統合最大を表す。

骨格筋は力と制御需要に応じ運動単位を動員する。一般に低閾値で疲労耐性の単位から始め、力増加で大きく速い単位を加える。線維表現型は収縮蛋白、酸化酵素、ミトコンドリア、毛細血管、解糖能、疲労が異なるが連続体で適応する。急速弾道課題、電気刺激、傷害、特殊運動で順序は変わり得る。一線維ラベルから全筋機能を推定できない。

糖質は脂肪より高い速度で、酸素当たり効率よくATPを供給する。筋グリコーゲンは局所グルコースを迅速に与え、肝グリコーゲンと糖新生は血糖を支える。脂肪酸は脂肪組織と筋内貯蔵から来て、低相対強度・長時間で優位になる。強度上昇では迅速ATP需要と線維動員が解糖を好み、糖質利用が増える。訓練、食事、性ホルモン、温度、先行運動が移行点を変える。

ホルモンは基質と循環を維持する。カテコールアミンは心機能、グリコーゲン分解、脂肪分解を増す。インスリン濃度は低下しやすいが、収縮依存輸送体移動で筋糖取り込みは増える。グルカゴンとカテコールアミンが肝糖出力を支える。長時間・高ストレス運動ではコルチゾールと成長ホルモンも寄与する。反応は相対強度と訓練で変わり、適応後は同じ絶対負荷へのストレス反応が小さい。

圧、浸透圧、代謝、発汗変化で血管、間質、細胞内区画間を水分が移動する。長時間運動で血漿量が減ると一回拍出量が下がり、同じ拍出を保つため心拍が上がる心血管ドリフトが生じる。飲水需要は持続、環境、発汗率、利用可能性、開始状態で違う。過度脱水も低張液過飲も危険である。体重変化は実用的な事後推定だが基質と代謝水も含む。

機械効率は外的仕事を代謝エネルギー消費で割った値で、多くは仕事でなく熱になる。効率は運動、速度、筋活動、技能、生体力学で変わる。エコノミーは一定最大下速度・出力の酸素・エネルギー費用で、技術と弾性エネルギー利用により最大酸素摂取量を変えずに改善し得る。走行、自転車、水泳、上肢運動は筋量と技能が違い、試験結果は様式特異的である。

自覚的運動強度は神経随伴信号、呼吸・筋感覚、温度、代謝物、感情、期待、動機を統合する。強度と相関するが心拍や乳酸の別名ではない。疼痛と不快は損傷努力から守り得るが、ペーシングは残距離と能力についての学習予測も反映する。時間や距離の誤情報で出力が変わることは、能力が生理状態と情報の両方で調節されることを示す。

一運動中の疲労は必要な力・出力を作る能力の可逆的低下である。末梢機序には代謝物、興奮収縮共役、イオン移動、基質枯渇、筋傷害がある。中枢疲労は有効神経駆動低下で、温度、神経伝達、求心フィードバック、動機、脅威に影響される。相互作用する安全・遂行過程であり、疲労が全て筋または全て精神という証拠ではない。

運動負荷試験は標準プロトコルで負荷を症状、心電図、圧、換気、ガス交換、能力へ結ぶ。解釈には様式、校正、努力、薬物、環境、中止理由が必要で、症状やプロトコルにより生理最大前に頂点となり得る。特に心、肺、血管、筋、動機の制約を位置付けるには、一最大値より最大下閾値と反応パターンが有用な場合がある。

統合反応は圧と脳機能を保ちながらATP需要へ酸素、基質、熱除去を合わせることと要約できる。訓練は全連鎖を変えるが、疾患はボトルネックを移す。運動生理学は予備能の負荷試験であり、安静時に隠れる相互作用と、同じ負荷が一人には容易、別人には最大、第三者には危険となる理由を示す。

## TTSモジュール2：訓練適応、疲労、回復、能力

訓練は慣れた需要を超える刺激と十分な回復を反復し、持続適応を作る。適応は訓練した筋、運動、力、速度、持続、エネルギー系、環境に特異的だが、課題が制限過程を共有すれば転移する。漸進性過負荷は能力増加に伴い刺激を増す。変化は同じ組織の連続消耗を防ぎ、可逆性により刺激除去後は適応が低下する。適応は信号と回復可能費用の均衡に依存し、仕事量が多いほど自動的に良いわけではない。

一回運動はカルシウム、エネルギー状態、酸化還元、機械張力、代謝物、ホルモン、温度、局所炎症を変える。これらはキナーゼ、転写因子、遺伝子発現、蛋白合成、ミトコンドリア回転、毛細血管、結合組織、神経制御を変える。初期分子反応だけで有用な長期適応を証明せず、反復運動が構造・機能変化へ累積する必要がある。訓練状態で反応は異なり、初心者を強く乱す負荷が熟練者には維持刺激となる。

持久訓練はミトコンドリア量と酵素能、毛細血管、脂肪酸化、乳酸輸送利用、血漿量、自律効率を増す。充満増加、心腔適応、収縮機能により一回拍出量が増し、一定最大下出力で心拍が低下しやすい。最大酸素摂取量は中枢供給と末梢抽出で増え、エコノミー、閾値、グリコーゲン温存、疲労耐性でも能力は上がる。最大酸素摂取が少ししか変わらなくても他適応は改善し得る。

高強度間欠訓練は厳しい代謝・心肺需要近くの反復と回復を組み合わせ、少ない総時間で酸化・能力適応を刺激できるが、生理・知覚負担は大きい。仕事時間、回復、回数、様式、強度で異なるセッションになるため、間欠訓練という名だけでは処方・比較できない。低強度量も管理可能な疲労で仕事を蓄積し、組織耐性と技能を育てる価値がある。

抵抗訓練は神経・筋適応で筋力を上げる。初期増加は運動単位動員、発火、協調、技能改善を反映しやすい。反復合成が分解を上回ると収縮・支持蛋白が蓄積し肥大する。機械張力が主要信号で、高重量または疲労近くまでの低重量でも高い力を作れるが、関節負荷、不快、パワー、効率は異なる。筋量は筋力の多くを説明するが、構築、てこ、腱、神経制御も重要である。

パワーは力と速度の積で、最大筋力より早く加齢低下しやすい。パワー訓練は有用速度と安全制御を許す負荷を速く動かす意図を要する。伸張性収縮は低い代謝費用で高力を出すが、未経験では筋傷害が大きい。反復曝露は保護的反復効果を作る。等尺、短縮、伸張、開放・閉鎖運動連鎖課題の転移は関節角度、速度、範囲、協調に依存する。

骨は動的歪みの大きさ、速度、方向、新奇性へ適応する。多方向の短い衝撃と高筋力は骨形成性になり得るが、持続する低歪みは反応を飽和させる。適応は遅く部位特異的である。腱は反復高張力で基質回転と剛性を変えるが筋より遅れ得るため、急速筋力増加が結合組織準備を越え得る。軟骨は能力内の周期負荷から利益を得るが、不動と過剰傷害負荷は有害である。

柔軟性は利用可能可動域で、関節構造、筋腱特性、神経性耐性、温度、測定に依存する。ストレッチはしばしば構造だけでなく耐性増加を通じ範囲を増す。最大パワー直前の長い強い静的ストレッチは一時的出力低下を起こし得る一方、動的準備は温度を上げ動作を練習する。柔軟性が高いほど普遍的に保護的ではなく、必要範囲と制御は活動ごとに違う。

運動学習は課題練習とフィードバックで効率、時間、精度を改善する。運動結果への外的焦点は自動制御を支え、過剰な内的指示は熟練遂行を乱し得る。変動練習は即時成功を下げても転移を改善する。疲労は技術と誤りを変えるため新鮮時だけの練習は現実需要へ備えないが、著しく疲労した状態の複雑高リスク技能は危険な型を強化し得る。

持久と抵抗の併用は両能力を改善できるが、高量で順序・回復が悪いと一部筋力・肥大適応を弱め得る。干渉は絶対的分子禁止でなく、総負荷、様式、栄養、訓練状態、セッション近接に影響される。健康と多くの競技に併用は必須である。優先能力を疲労が少ない時に置き、その適応へ十分な回復を配分する。

訓練負荷には外的・内的成分がある。外的負荷は距離、出力、反復、力など実施仕事、内的負荷は心拍、酸素摂取、乳酸、自覚強度など生理・知覚反応である。同じ外的負荷も熱、疾患、睡眠不足、高地、体力改善で異なる内部ストレスを作る。一方だけの監視は能力低下を努力増加、体力改善を訓練不足と誤認し得る。

十分な訓練後の急性疲労は予想され回復で消える。機能的オーバーリーチは短い計画的能力低下後に回復すると改善するが、非機能的型は利益なしに長く障害する。オーバートレーニング症候群は別疾患で説明不能な持続能力低下と疲労・諸障害で診断が難しい。感染、鉄欠乏、低エネルギー利用可能性、睡眠、内分泌、精神疾患、薬物、生活ストレスを考える。

遅発性筋痛は不慣れな負荷、特に伸張性運動後に発達し、運動中でなく後に最大となる。残留乳酸でなく構造撹乱と炎症性感作を反映する。痛みは適応品質と弱くしか相関せず訓練目標ではない。重い疼痛、著しい腫脹、筋力低下、暗色尿、全身疾患、限局機能障害を通常痛として正常化しない。

回復は基質補充、蛋白回転、水分均衡、自律安定、組織修復、睡眠、心理的解放により遂行を戻し適応を許す。各系の時間は異なり、心拍正常化時にグリコーゲンが低く、力回復後も痛みが残り得る。完全休息が常に優れず、低強度運動は全修復を速めなくても快適性と循環を支える。回復法は一過性感覚やマーカーでなく意味ある転帰で判断する。

睡眠は注意、運動学習、内分泌、免疫、食欲、組織回復を支える。遅い訓練が全員の睡眠を損なうわけではないが、就寝直前の高覚醒は一部へ影響する。必要量は個人差があり一理想数へ還元できない。移動、交代勤務、疼痛、不安、呼吸障害、刺激薬が機会・質を損なう。機会延長と時刻安定は特殊回復機器より根拠が強いことが多い。

栄養はエネルギー、糖質、蛋白、脂肪、微量栄養、水分を供給する。食事間の蛋白配分は反復合成を支えるが、一日総量と訓練刺激が中心である。糖質利用可能性は需要へ合わせる。意図的低利用性は信号を変え得るが質低下とストレス増加を招く。低エネルギー利用可能性は性別・体格や正式摂食障害の有無にかかわらず、生殖、骨、免疫、代謝、心血管、心理機能を損なう。

水分計画は個人発汗率、気候、持続、摂取機会から始める。長時間大量発汗ではナトリウム補充が重要だが濃度と必要量は異なる。運動前の過飲は有用な貯水を作らず低ナトリウム血症を増す。補助食品は機序、証拠、用量、汚染、相互作用、基本制限が既に扱われたかで評価する。競技では小効果も重要だが危険な計画を健全にはしない。

傷害リスクは組織能力と負荷、技術、環境、回復、既往、偶然の相互作用から生じる。急変は適応を越え得るが、一つの急性慢性比で全傷害を確実に予測できない。疼痛は組織損傷と完全対応せず、画像異常も無症状で起こる。重篤病変を除外後、耐えられる機能を漸進的に戻す。完全休息は能力を下げ、悪化機能を無視した強制訓練は傷害を増し得る。

ピリオダイゼーションは量、強度、特異性、競技準備を変え、訓練ストレスと回復を時間で組織化するが、普遍的に優れたテンプレートはない。生物学へ暦を強制せず、測定反応へ計画を適応する。目標を定め、制限能力を同定し、最小有効な漸進刺激を与え、機能と健康を監視し、疲労が持続害になる前に修正する。

## TTSモジュール3：暑熱、寒冷、高地、潜水、微小重力

人体生理は周囲との熱、気体、水分、機械負荷の交換により変化環境でも内部機能を保つ。環境ストレスは強さ、持続、変化速度、衣服・装備、活動、順化、疾患、薬剤、年齢、避難場所に依存する。安静で耐えられる条件も、代謝熱と酸素需要が上がる運動中には危険になり得る。適応は作動範囲を広げるが物理的限界を消さない。

深部体温は代謝熱産生と放射、対流、伝導、蒸発による熱交換の均衡を反映する。周囲が皮膚より低温なら放射と対流は熱を除き、高温なら加える。高温空気でも汗が皮膚へ届き蒸気圧が許せば蒸発冷却できる。高湿度、非透過衣服、低気流、蒸発せず滴る汗は効率を下げる。一温度計だけでは総熱負担を表さない。

皮膚と深部の温度受容器が視床下部・脳幹網へ伝える。暑熱は皮膚血管拡張と発汗を起こし、行動は日陰、仕事低下、脱衣、飲水を選ぶ。皮膚血流は活動筋と中心血液量を競う。発汗で血漿量が減ると心拍が上がり一回拍出量が下がり得る。脱水は循環・熱負担を増すが、損失を越える強制飲水は希釈性低ナトリウム血症を招く。

暑熱順化は反復曝露で発達し、特に深部・皮膚温と発汗が十分刺激されると強い。血漿量が増え、発汗開始が早く全身へ広がり、アルドステロン性ナトリウム温存で汗が薄くなり、一定負荷の循環負担が下がる。数日で始まり約一から二週で発達し、曝露なしに減衰する。体力は部分的交差適応を与えるが暑熱特異的準備を置換しない。

熱疲労は大量発汗、脱力、めまい、頭痛、悪心、頻脈、虚脱を伴う運動継続不能で、一般に熱傷害による重篤中枢神経障害はない。熱射病は危険な高体温と中枢神経障害を持つ救急で、肝、腎、筋、凝固、循環傷害を伴い得る。見た目が正常な皮膚や持続発汗で除外できない。完全な体温測定を待たず即時急速冷却と救急支持を行う。

労作性熱射病は活動者へ急速に起こりやすく、古典型は環境熱中で冷却、移動、支援が限られる脆弱者に多い。発汗障害、循環変化、熱産生増加、判断変化を起こす薬剤が危険を高める。冷却法は搬送・蘇生を遅らせず熱移動を最大化する。熱射病では発熱のように視床下部設定温度が上がっていないため解熱薬は修正しない。

寒冷では皮膚血管収縮と行動が熱を保存し、震えと非震え熱産生が生産を増す。衣服は断熱空気を捕えるが、風、水、圧迫、湿気が保護を減らす。水は静止空気よりはるかに速く熱を奪う。運動は熱を作るが対流損失と発汗、その後の冷却を増し得る。アルコールは皮膚血管拡張で暖かく感じさせながら熱損失を加速し判断を損なう。

低体温は代謝、神経、換気、心伝導を遅くする。初期の震えと混乱から協調喪失、意識低下、不整脈、心停止へ進み得る。末梢収縮は循環量低下を隠し、重症冷却者の心筋は刺激されやすいため移動に注意する。重症度と循環に応じ受動、能動的外部、内部加温を行う。深い低温では見かけの死亡を慎重に解釈するが、蘇生判断は文脈と傷害に依存する。

凍傷は氷形成、浸透圧ストレス、内皮傷害、血栓、炎症、再灌流を含む組織凍結傷害である。無感覚で白い蝋様組織は後に水疱と壊死を生じ得る。融解後再凍結は著しく悪化するため、再凍結を防げる場合だけ解凍する。非凍結性寒冷傷害は氷点以上の湿冷へ長く曝露し神経と微小血管を傷める。凍結組織を擦ると機械傷害を加える。

高地では酸素分率はほぼ同じまま気圧が下がり、吸気・肺胞酸素分圧が低下して動脈酸素化が下がる。即時低酸素換気反応は二酸化炭素を下げ呼吸性アルカローシスを起こし、初めは追加換気を抑える。数日で腎が重炭酸を排泄し持続過換気を許す。心拍と拍出は初期に上がり、酸素供給制限で最大有酸素能力が下がる。

低酸素は数週でエリスロポエチンと赤血球産生を増すが、血漿量収縮は真の細胞量増加前にヘモグロビン濃度を上げる。毛細血管、ミトコンドリア、輸送、代謝の組織適応は期間と集団で異なる。赤血球増加は酸素含量を上げるが過剰粘度は流れを妨げ得る。高地長期居住集団は異なる遺伝適応を持ち、生涯内順化と進化適応が別であることを示す。

急性高山病は登高後の頭痛と悪心、疲労、めまい、睡眠障害などを起こす。危険は体力より登高速、到達睡眠高度、既往反応、個人感受性に強く依存し、症状中の続行は危険を増す。高地脳浮腫は運動失調、精神変化、進行神経障害を、高地肺水腫は息切れ、運動低下、咳、低酸素、肺高血圧関連漏出を起こす。下降と酸素が緊急対応の中心である。

低酸素性肺血管収縮は海面で低換気肺から血流を逸らすが、高地では広範となり肺動脈圧を上げる。不均一収縮と高流量が浮腫へ寄与する。アセタゾラミドは重炭酸喪失を促し換気を支え、適切に順化を助ける。糖質コルチコイドは脳症状を減らし得るが正常順化を作らない。予防薬は段階登高を無視する理由でなく補助である。

潜水では海水約十メートルごとに周囲圧が約一気圧上がる。Boyle則により気体容積は下降で縮み上昇で膨張する。圧平衡不能は耳、洞、マスク空間、肺を傷める。圧縮気体呼吸後の上昇で息を止めると肺気体が膨張し、圧外傷と動脈ガス塞栓を起こす。気体が逃げられなければ浅い上昇も危険である。

Henry則は分圧が高いほど組織へ気体が多く溶けることを示す。窒素は深度と時間で蓄積し上昇時に出る。周囲圧が急低下すると過飽和から気泡ができ、関節、皮膚、神経、肺、他臓器の減圧症を起こす。制御上昇と減圧停止が排出を許す。重症減圧障害や動脈ガス塞栓には高濃度酸素、支持、緊急専門再圧評価が必要である。

気体分圧には別の危険もある。窒素酔いは深所で認知と運動を損なう。過剰酸素は高圧で痙攣を伴う中枢毒性、長期曝露で肺毒性を生む。二酸化炭素蓄積は労作、装置死腔、高密度気体作業、不十分換気から起こり、酔いと酸素毒性危険を増す。呼吸混合気と曝露限界は深度と作業へ合わせる。

浸水自体が静水圧で血液を中心へ移し心充満と利尿を増す。冷水は血管収縮と呼吸反応を加え、突然の浸水は低体温前にあえぎと過換気を起こし得る。息止め潜水は低酸素、二酸化炭素上昇、圧、強い自律反射を組み合わせる。事前過換気は二酸化炭素を下げ呼吸欲求を遅らせるが酸素をほとんど増さず、水中意識消失リスクを上げる。

微小重力は通常荷重を除き体液を胸と頭へ再配分する。初期中心血液量増加は利尿を促し血漿量を減らす。時間とともに循環脱調節、圧受容耐性低下、骨喪失、筋萎縮、感覚運動変化、視覚・免疫変化が起こる。重力へ戻ると低容量と血管制御低下が起立不耐へ寄与する。抵抗・有酸素運動、栄養などは適応を減らすが消さない。

微小重力の骨喪失は機械荷重低下と再構築変化を反映し、荷重骨格の部位特異的喪失と尿中カルシウム増加による結石危険を生む。抗重力筋は大きさと力を失う。前庭系は重力手掛かり不在を再解釈し、動揺病と帰還後再適応を起こす。地球防護外の放射線は線量、任務期間、遮蔽、太陽事象に伴う確率的・組織危険を加える。

極限環境医学は応用統合生理学である。暑熱は循環と蒸発、寒冷は断熱と代謝、高地は酸素圧、潜水は圧と溶解気体、微小重力は荷重除去と体液再配分を試す。予防は支配する物理曝露を同定し、仕事と装備を人の予備能へ合わせ、段階適応を許し、代償が不可逆傷害になる前に早期破綻を認識することから始まる。

# 第105章：定量化学と酸塩基の基礎

## TTSモジュール1：物質量、濃度、化学量論、実験収率

化学の問題では、物質がどれだけ存在するか、その溶液がどれだけの体積を占めるか、どれだけが反応するか、という三つの量を分けると考えやすい。物質量が変わらなくても濃度は下がる。大きな質量の試料でも、別の化合物の小さな質量の試料より分子数が少ないことがある。反応式の係数は可能な変換量を制約するが、反応の速さや完全な回収を保証しない。本モジュールでは、生化学的な濃度や検査結果を解釈する前提となる量の整理を学ぶ。数値例は理想化した学習問題であり、医薬品の調製手順ではない。

### 質量から物質量へ

モルは、原子、分子、イオン、式単位など、指定した要素粒子を数える単位である。1モルには正確に6.02214076かける10の23乗個の要素粒子が含まれる。何を数えるかを必ず明示する。塩化カルシウムの式単位1モルには、カルシウム原子1モルと塩素原子2モルが含まれる。完全に溶解して解離すれば、カルシウムイオン1モルと塩化物イオン2モルになる。塩化カルシウムが3モル生じるのではない。化学式を使うことで、化合物自体の物質量と、その構成要素の物質量を区別できる。

モル質量によってグラムをモルへ換算する。単位を確認しながら、質量をモル質量で割る。仮想の化合物のモル質量が1モル当たり120グラムなら、3.60グラムは0.0300モル、すなわち30.0ミリモルに相当する。分子からなる物質であれば、さらにアボガドロ定数を掛けると、分子数は約1.81かける10の22乗個となる。1ミリモルは1モルの1000分の1であり、1000個の分子ではない。モル質量が異なる化合物では、質量が等しくても要素粒子数は一般に異なる。

組成式は原子数の最も簡単な整数比を示し、分子式は一つの分子の実際の組成を示す。組成式が炭素1、水素2、酸素1の比で、その式量に対応するモル質量が約30グラムの物質を考える。測定したモル質量が約180グラムなら、分子式は炭素6、水素12、酸素6となり得る。倍率は6である。組成比だけでは、同じ組成式を持つ別の化合物と区別できない。

### 濃度と希釈

モル濃度は、最終的な溶液1リットル当たりの溶質のモル数であり、加えた溶媒1リットル当たりではない。先ほどの3.60グラムを溶かし、最終体積を150ミリリットルにすると、濃度は1リットル当たり0.200モルになる。その溶液から15.0ミリリットルを取り、最終体積100ミリリットルまで希釈すると、移した物質量は3.00ミリモル、新しい濃度は1リットル当たり0.0300モルである。フラスコ内の最終体積が100ミリリットルなのであり、分取液に100ミリリットルを加える操作とは異なる。

希釈前の濃度と体積の積が希釈後の濃度と体積の積に等しいという式は、対象とする溶質の保存を表している。溶質が失われず、生成も消費もされないことが前提である。混合した溶液同士が反応するなら、先に反応量を計算する。同じ溶質の反応しない二つの溶液を混ぜる場合は、物質量を足して最終体積で割る。濃度の単純平均が使えるのは、体積に関する前提が成り立ち、両者の体積が等しい場合である。10倍希釈を続けて2回行うと、希釈倍率は掛け合わせるため100倍になる。

濃度の単位が異なれば、表す量も異なる。質量百分率は溶質の質量を溶液全体の質量と比較する。質量体積百分率と明示された場合は、通常、100ミリリットル当たりのグラム数を意味する。2パーセントの質量体積濃度なら100ミリリットルに2グラム、つまり1リットルに20グラム、1ミリリットルに20ミリグラムである。一方、質量モル濃度は溶媒1キログラム当たりのモル数を数える。溶媒の質量を無断で溶液の体積に置き換えてはいけない。両者を結び付けるには密度と組成の情報が必要になる。

密度は質量を体積で割った量である。溶質の質量百分率が10.0パーセント、密度が1ミリリットル当たり1.20グラムの溶液を考える。100ミリリットルの試料は120グラムであり、含まれる溶質は10.0グラムではなく12.0グラムである。したがって質量体積濃度は100ミリリットル当たり12.0グラムとなる。溶質のモル質量が1モル当たり60.0グラムなら、試料には0.200モルが含まれ、モル濃度は1リットル当たり2.00モルとなる。この換算には密度とモル質量の両方が必要である。どちらかを省けば、根拠のある換算を、物質についての明示されていない仮定に置き換えることになる。

### 計算の前に反応式を整える

化学反応式では各元素の原子数を、イオン反応式では電荷の総和も保存する。式を整えるときに変えるのは係数であり、化学式内部の添字ではない。添字は物質の種類を、係数は参加する量を指定する。エタノールの理想的な完全燃焼では、エタノール1モルと酸素3モルから、二酸化炭素2モルと水3モルが生じる。両辺で炭素原子2個、水素原子6個、酸素原子7個を数えられる。係数が示すのはモル比であり、グラムの比ではない。

理想的な系に、初めにエタノール0.080モルと酸素0.180モルがあるとする。エタノールからは反応を0.080モル分進められるが、酸素からは0.180を3で割った0.060モル分までしか進められない。したがって限界反応物は酸素である。二酸化炭素の予測生成量は0.060の2倍、すなわち0.120モルとなる。水は0.180モル生じ、エタノールは0.020モル残る。消費比が1対1ではないため、初めのモル数を直接比べると限界反応物を誤る。

学習用に丸めたモル質量として、エタノール、酸素、二酸化炭素、水を、それぞれ1モル当たり46、32、44、18グラムとする。初めの質量は3.68と5.76を足した9.44グラムである。予測される生成物は5.28と3.24グラムで、残ったエタノールは0.92グラムである。合計すると同じ9.44グラムになる。この独立した質量の確認によって、過剰反応物の計上漏れを発見できる。開放容器では気体が逃げて容器内の測定質量が減ることがあるが、物質の保存に反するわけではない。

### 予測変換量と実際の回収量

理論収量は、指定した反応と限界となる投入量から計算される生成物量である。実際に分離して得られる量には、変換の程度、競合反応、回収損失、測定の質も影響する。理想例で二酸化炭素4.22グラムを回収したなら、見かけの百分率収率は4.22を5.28で割って100を掛けた約79.9パーセントである。それだけでは、どの過程が不足の原因だったかは確定しない。気体を取り逃がす回収法でも、基質の変換が不完全な反応でも、同じ収率が報告され得る。

測定した生成物の質量が計算上の最大値を超えた場合は、前提や測定を点検する必要がある。生成物に残った水分、不純物、初期濃度の誤り、生成物の同定の誤りによって、見かけの収率が高くなることがある。原子が新しく作られた証拠ではない。同様に、限界反応物の量が一定なら、既に過剰な反応物を増やしても化学量論的な上限は増えない。ただし実際の系では、反応速度や平衡の位置に影響する可能性がある。それらは、ここで扱う理想的な量の計算とは別の問いである。

精密さと正確さも異なる。測定を繰り返した値がよく一致していても、校正がずれた天秤によって全体が偏っている場合がある。反復測定はばらつきを特徴付けるが、共通する系統誤差を取り除くものではない。収率の計算では、測定した分子の値にも予測した分母の値にも不確かさが入り得るため、最終的な百分率だけでなく入力値も確認する。

### 化学種、粒子数、報告の精度

分析濃度は、溶液体積当たりに導入した化合物の量を表す。個々の化学種の濃度は、解離や反応によって決まる。理想的に完全解離した塩化カルシウムの濃度が1リットル当たり0.050モルなら、カルシウムイオンは1リットル当たり0.050モル、塩化物イオンは0.100モル存在する。溶存粒子数の理想的な合計は1リットル当たり0.150オスモルとなる。実在溶液は理想的な粒子挙動から外れるため、これは近似であり、実測した浸透圧モル濃度ではない。電荷当量も別の数え方であり、カルシウムイオンは2価なので1モル当たり2当量となる。

精度はデータに見合ったものにする。正確な化学量論係数は有効数字を制限しないが、測定した質量や体積は制限する。途中の計算では余分な桁を残し、最終結果で丸める。答えを採用する前に、単位が求める量を示すか、希釈で変わったのは物質量か濃度か、すべての反応物を数えたか、その数値は理論上限か観察値かを確認する。こうした区別によって、計算の得意さを化学的な過信に変えずに済む。

## TTSモジュール2：酸塩基平衡、緩衝液、滴定の考え方

酸塩基の考え方は、分子間のプロトン移動と溶液の測定値を結び付ける。まず、何がプロトンを与え、何が受け取り、どの量が保存されるかを特定する。次に、ほぼ完結する反応と可逆的な平衡のどちらが問題を支配するかを判断する。この二段階の混同は、緩衝液の計算を誤る原因になりやすい。ここでは理想的な希薄水溶液を、原則として摂氏25度で扱う。臨床治療ではなく化学的な推論を学ぶ例であり、実際の体液には温度、活量、生理機能について追加の考慮が必要である。

### 定義と対数による測定

ブレンステッド・ローリーの酸はプロトンを与え、塩基は受け取る。酸がプロトンを一つ失うと共役塩基になり、両者はそのプロトンと電荷1単位だけ異なる。水はどちらの役割にもなれる。一方、ルイス酸は電子対を受け取り、ルイス塩基は電子対を与える。プロトン移動もこの広い説明に含まれるが、ルイス酸塩基相互作用が必ずプロトン移動を伴うとは限らない。問題がどちらの定義を用いているかを明確にする。

ピーエイチ、すなわちpHは、水素イオン活量の常用対数に負号を付けた量である。初歩的な希薄溶液の問題では、標準濃度に対する濃度の比で活量を近似する。水素イオン濃度が1リットル当たり10のマイナス3乗モルなら、近似的なpHは3である。pHが1上がると、水素イオン活量は10分の1になる。pHが2違うことは活量の比が100倍であることを意味し、2倍ではない。pHは対数なので、二つのpHの算術平均は一般に混合後のpHを表さない。

水のイオン積は水素イオンと水酸化物イオンを結び付ける。摂氏25度で濃度を使って近似した値は10のマイナス14乗であり、pHとピーオーエイチ、すなわちpOHの和は約14になる。中性とは水素イオンと水酸化物イオンの活量が等しいことであって、どの温度でもpHが7という意味ではない。イオン積が変われば中性のpHも変わる。また、よく使う0から14という範囲も絶対的な物理的限界ではない。十分に濃い溶液では範囲外になり得るが、その場合には理想的な濃度近似に特に注意が必要になる。

### 強さと濃度は別の量

一価の弱酸をエイチエーと呼ぶと、その解離によって水素イオンと共役塩基であるエーマイナスが生じる。酸解離定数ケーエーは、生成した両者の活量の積を酸の活量と比較する。同じ温度と溶媒条件では、ケーエーが大きいほど解離する傾向が強く、その負の常用対数であるピーケーエーが小さいほど強い酸である。一方、濃度は単位体積当たりにどれだけ酸を加えたかを表す。したがって、希薄な強酸と濃い弱酸のpHを、「強い」「弱い」という言葉だけで順位付けすることはできない。

分析濃度が1リットル当たり0.040モル、ケーエーが10のマイナス5乗の仮想の弱酸を考える。水からの寄与を無視でき、初めに共役塩基を加えていないとする。解離した濃度をエックスと置くと、ケーエーはエックスの2乗を、0.040からエックスを引いた値で割ったものになる。分母を0.040で近似すると、エックスは1リットル当たり約0.000632モル、pHは約3.20となる。解離率は約1.58パーセントにすぎず、この小変化近似を支持する。二次方程式の正の解を使うと約0.000627となり、pHもほぼ同じになる。

慣れた近似だからという理由だけで選ばず、計算後に前提を確認する。解離した量が初期酸量の無視できない割合なら、減少した酸濃度を式に残す。極端に希薄な強酸では、水の寄与も自動的には無視できない。理想的な強酸を1リットル当たり10のマイナス8乗モル加えても、pHが8になるわけではない。水が追加の水素イオンを供給し、水酸化物イオンも変化する。物質収支、電荷収支、水の平衡を合わせると、pHは7よりわずかに低くなる。

### 緩衝液は有限の化学的な蓄え

緩衝液には、弱酸と共役塩基、または対応する弱塩基と共役酸が、無視できない量ずつ存在する。酸を加えると塩基性成分が消費され、塩基を加えると酸性成分が消費される。pHは変化するが、ほかの条件が同等の緩衝作用を持たない溶液より変化が小さい。ヘンダーソン・ハッセルバルヒの式は酸平衡を整理したもので、pHはピーケーエーに、共役塩基を酸で割った比の常用対数を足した値に等しい。適切な条件では濃度で活量を近似できる。この比のどちらの成分もゼロとして扱ってはいけない。

100ミリリットル中にエイチエー10.0ミリモルとエーマイナス10.0ミリモルがあり、ピーケーエーが5だとする。比が等しいのでpHは5になる。強酸2.00ミリモルを加えると、その量のエーマイナスがエイチエーに変わる。ほぼ完結するこの反応の後では、それぞれ8.00ミリモルと12.0ミリモルになる。共役塩基と酸の比は3分の2なので、新しい近似pHは4.82である。必ず反応後の量を使う。初めの比を緩衝式に代入すると、変化しないという誤った予測になる。

次に、同じpHでも各成分が1.00ミリモルずつしかない緩衝液と比べる。同じ量の酸を加えると、共役塩基1.00ミリモルは使い尽くされ、強酸が余る。もはや先ほどの二成分の緩衝液としての問題ではない。したがって緩衝能はpHだけでなく、利用できる量に依存する。理想的な希釈では成分比が保たれ、pHもほぼ維持されるが、希釈後の一定体積に含まれる緩衝能は低下する。極端な希釈では、水や活量の影響のため、この単純な説明が成り立たなくなることがある。

### 滴定は異なる問題が連続する過程

滴定では、測定した量の試薬を意図的に加え、未知の物質量を推定する。化学量論的な量が反応した当量点と、指示薬や装置が選んだ変化を示す終点を区別する。適切な方法では両者が近くなるべきだが、定義上同じ出来事ではない。弱酸を強塩基で滴定する場合、当量点前には酸と共役塩基の両方が存在し得る。半当量点では両者の量がほぼ等しくなり、通常の緩衝液の前提が成り立てば、pHはピーケーエーに近似する。

1リットル当たり0.0800モルの一価の弱酸25.0ミリリットルを、1リットル当たり0.100モルの強塩基で滴定する例を考える。初めの酸は2.00ミリモルである。当量点には滴定液20.0ミリリットル、半当量点には10.0ミリリットルが必要になる。当量点では共役塩基が残って水と反応する。したがって、この摂氏25度の理想条件ではpHは7より高く、自動的に7にはならない。強酸と強塩基の当量点が対応する理想条件で中性なのは、残ったどちらのイオンも無視できない加水分解をしないからである。

当量点を越えると、通常は過剰な強塩基が支配的になる。同じ例で25.0ミリリットルを加えると、塩基は2.50ミリモル供給され、溶液全体50.0ミリリットル中に0.50ミリモルが余る。近似的な水酸化物イオン濃度は1リットル当たり0.0100モルとなり、pOHは2、pHは12になる。この計算では、弱酸と共役塩基の寄与は過剰な強塩基に比べて無視できると仮定している。当量点の前、当量点そのもの、その後では必要なモデルが異なる。暗記した一つの式だけで、条件を確認せずに全領域を説明することはできない。

共役塩基の平衡を使えば、当量点を定量的に扱える。一貫した定義を用いると、水中の共役対ではケーエーとケービーの積が水のイオン積に等しい。この滴定の酸のケーエーを10のマイナス5乗とすると、摂氏25度で共役塩基のケービーは10のマイナス9乗である。当量点では2.00ミリモルが45.0ミリリットルに含まれ、塩基の濃度は1リットル当たり約0.0444モルとなる。小変化近似による水酸化物イオン濃度は、ケービーとその濃度の積の平方根で、1リットル当たり約0.00000667モルである。したがってpOHは約5.18、pHは約8.82となる。反応した割合は小さい。

単純な混合でも保存量を確認する価値がある。pHが2と4の理想的な緩衝作用を持たない強酸溶液を等体積ずつ混ぜると、水素イオン濃度は1リットル当たり約0.00505モルとなり、pHは3ではなく約2.30になる。濃い方の溶液が水素イオンの大部分を供給する。この例は体積の加成性と水の寄与が無視できることを仮定しており、緩衝液や体液を混ぜる際の一般則ではない。

### プロトン化を生物学的な推論につなげる

単純な酸性基では、pHがピーケーエーより1高いと、プロトン化した基1個に対して脱プロトン化した基が約10個になる。1低いと逆の比になる。タンパク質には相互作用する複数の基があるため、孤立した一つの基の計算だけでは、タンパク質全体の電荷や機能は決まらない。多価酸も、それぞれ異なる定数を持つ段階を経てプロトンを失う。酸塩基の問題では、関与する化学種を特定し、支配的な化学量論反応を処理してから平衡モデルを選び、電荷収支と変化の方向に照らして答えを確かめる。この習慣は、素早い数値代入より重要である。
