...
\noindent\emph{I wrote this as the companion to the interactive edition at
...
allowed to influence the rate. That structural fact, rather than the raw frequency, is what I think
...
voltage stays nearly flat until it collapses, which I take to be why a quartz watch keeps perfect time
...
relaxation in the mount and mass transfer on the tines. The ageing term is in the equation but
not in any plot here: I could not find a clean way to put a decade of drift on the same axes as
a temperature curve.
