...
(()=>{
  ...
  function ready(){
    if(!document.querySelector('script[data-isegoria-analytics]')&&location.hostname==='theisegoria.github.io'&&window.self===window.top&&!navigator.globalPrivacyControl&&navigator.doNotTrack!=='1'&&window.doNotTrack!=='1'){
