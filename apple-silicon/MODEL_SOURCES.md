...
- English/Japanese pages share interaction logic and source data; selections, experiment settings and the fragment survive language switches. Japanese text is AI-translated and checked for consistency.
